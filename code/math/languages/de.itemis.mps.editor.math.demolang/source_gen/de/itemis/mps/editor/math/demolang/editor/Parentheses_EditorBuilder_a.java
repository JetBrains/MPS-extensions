...
/*package*/ class Parentheses_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createMathBase_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("MathBase_vziv2x_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new bodySingleRoleHandler_vziv2x_a0a(myNode, LINKS.body$r7Si, getEditorContext());
    return provider.createCell();
  }
  private static class bodySingleRoleHandler_vziv2x_a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public bodySingleRoleHandler_vziv2x_a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.body$r7Si, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.body$r7Si, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.body$r7Si);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.body$r7Si));
      try {
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink body$r7Si = MetaAdapterFactory.getContainmentLink(0x76a53b21d4a7409fL, 0x93a2e70951b4b3f9L, 0x782866856b233069L, 0x782866856b246df5L, "body");
  }
}
