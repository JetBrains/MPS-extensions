...
public class InternalVariableReferences implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    InternalVariableReferencesSpecific customizer = new InternalVariableReferencesSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class InternalVariableReferencesSpecific implements EditorMenuItemCustomizer {
