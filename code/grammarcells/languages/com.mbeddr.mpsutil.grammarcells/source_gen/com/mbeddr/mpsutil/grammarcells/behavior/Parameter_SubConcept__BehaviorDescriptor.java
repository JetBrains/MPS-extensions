...
public final class Parameter_SubConcept__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9d69e71978c84286L, 0x90dbfb19c107d049L, 0x27b90b5c56f564e3L, "com.mbeddr.mpsutil.grammarcells.structure.Parameter_SubConcept");
  ...
  /*package*/ static SNode getType_id27DJnJtIQ9C(@NotNull SNode __thisNode__) {
    return _quotation_createNode_aac22h_a0a0(AbstractComponent__BehaviorDescriptor.getConceptDeclaration_id67EYkym$wx3.invoke(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.AbstractComponent$YR, false, false)));
  }

  /*package*/ Parameter_SubConcept__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_aac22h_a0a0(Object parameter_1) {
