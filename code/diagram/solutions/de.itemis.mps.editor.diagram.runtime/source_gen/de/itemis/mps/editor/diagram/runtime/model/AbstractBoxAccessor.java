...
public abstract class AbstractBoxAccessor extends BoxBaseAccessor implements IBoxAccessor {
  ...
  protected void writeLayout(SNode data, Box box) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(data, LINKS.portLayouts$aLr5)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        MapSequence.fromMap(portLayouts).put(SPropertyOperations.getString(it, PROPS.portName$4zIg), it);
      }
    });
