...
public class ErrorLog {
  ...
  public Iterable<Tuples._2<String, Iterable<LogEntry>>> getEntriesPerThread() {
    ...
    return SetSequence.fromSet(set).select(new ISelector<Map.Entry<String, Collection<LogEntry>>, Tuples._2<String, Iterable<LogEntry>>>() {
      public Tuples._2<String, Iterable<LogEntry>> select(Map.Entry<String, Collection<LogEntry>> it) {
