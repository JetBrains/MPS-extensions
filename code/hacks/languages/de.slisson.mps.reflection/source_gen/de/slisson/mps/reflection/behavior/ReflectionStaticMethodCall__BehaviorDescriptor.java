...
public final class ReflectionStaticMethodCall__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Iterable<SNode> getAvailableMethodDeclarations_id50EF2fWdwEN(@NotNull SNode __thisNode__, final String methodName) {
    return Sequence.fromIterable(Members.visibleStaticMethods(SLinkOperations.getTarget(__thisNode__, LINKS.classConcept$HYbK), __thisNode__)).where(new IWhereFilter<SNode>() {
