...
public final class TableStyleItemQuery__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addSequence(ListSequence.fromList(IStylable__BehaviorDescriptor.getAdditionalStyleQueryParameters_id4UkcdCuFJHc.invoke(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.IStylable$Ai, false, false))).select(new ISelector<SNode, SConcept>() {
