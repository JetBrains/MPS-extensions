...
public final class Parameter_Dimension__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x766348f76a674b85L, 0x9323384840132299L, 0x7e92b88d18154d17L, "de.itemis.mps.editor.math.structure.Parameter_Dimension");
  ...
  /*package*/ static SNode getType_id27DJnJtIQ9C(@NotNull SNode __thisNode__) {
    return _quotation_createNode_waby00_a0a0();
  }

  /*package*/ Parameter_Dimension__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_waby00_a0a0() {
    ...
    nb.setReference(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), "r:34f40b74-cb38-46ba-8e5b-13b443c803c4(de.itemis.mps.editor.math.runtime)/9120555111512410198");
    return quotedNode_1;
  }
}
