...
public class ExportDiagramAsSVGButton extends ContextButton {

  public ExportDiagramAsSVGButton(double sizeX, double sizeY, mxCellState state) {
  ...
  protected void execute() {
    ...
    ImageExportUtil.exportAsSVG(rootECell, repository);
  }
