...
public final class CellBasedRule__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SNode> getSymbolCells_id5ewxJLJn0WX(@NotNull final SNode __thisNode__) {
    ...
    return ListSequence.fromList(symbols).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return ((boolean) CellBasedRule__BehaviorDescriptor.cellAllowedAsSymbol_id1gQHfgGXkQq.invoke(__thisNode__.getConcept(), it));
      }
    }).toListSequence();
  }
  /*package*/ static String getSymbolsText_id5ewxJLJn4ka(@NotNull final SNode __thisNode__) {
    return IterableUtils.join(ListSequence.fromList(CellBasedRule__BehaviorDescriptor.getSymbolCells_id5ewxJLJn0WX.invoke(__thisNode__)).select(new ISelector<SNode, String>() {
      public String select(SNode it) {
        return ((String) CellBasedRule__BehaviorDescriptor.cellToText_id5ewxJLJnVSy.invokeSpecial(__thisNode__, it));
      }
    }), "  ");
  }
