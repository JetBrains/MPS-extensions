...
public final class FilterParameter_element__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x7e450f4e1ac341efL, 0xa8514598161bdb94L, 0x4b289add0ddf87c6L, "de.slisson.mps.tables.structure.FilterParameter_element");
  ...
  /*package*/ static SNode getType_id27DJnJtIQ9C(@NotNull SNode __thisNode__) {
    return _quotation_createNode_tfny7l_a0a0(SLinkOperations.getTarget(SLinkOperations.getTarget(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.ChildCollection$n8, false, false), LINKS.linkDeclaration$JIBU), LINKS.target$m40F));
  }

  /*package*/ FilterParameter_element__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_tfny7l_a0a0(Object parameter_1) {
