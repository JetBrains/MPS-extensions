...
public class SubPolicyContainerCS implements EditorMenuItemCustomizer {
  ...
  private static class SubPolicyContainerCSSpecific implements EditorMenuItemCustomizer {
    ...
    private void customize_(SNode contextNode, EditorMenuItemStyle style, CompletionItemInformation itemInformation) {
      List<SEnumerationLiteral> alreadyDefined = ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(contextNode, CONCEPTS.MultiChildPolicy$zA, true, false), LINKS.subPolicy$$EhP)).select(new ISelector<SNode, SEnumerationLiteral>() {
        public SEnumerationLiteral select(SNode it) {
          return SPropertyOperations.getEnum(it, PROPS.subPolicy$jBml);
        }
      }).where(new IWhereFilter<SEnumerationLiteral>() {
