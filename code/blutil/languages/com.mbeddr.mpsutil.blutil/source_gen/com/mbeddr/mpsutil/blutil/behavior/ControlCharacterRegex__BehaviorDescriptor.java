...
public final class ControlCharacterRegex__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x63e0e5665131447eL, 0x90e312ea330e1a00L, 0x520a3149d9611e8dL, "com.mbeddr.mpsutil.blutil.structure.ControlCharacterRegex");
  ...
  /*package*/ static String getString_idhMuDF1A(@NotNull SNode __thisNode__, List<SNode> vars) {
    return "\\c" + SPropertyOperations.getString(__thisNode__, PROPS.value$lYwY);
  }

  /*package*/ ControlCharacterRegex__BehaviorDescriptor() {
  }
