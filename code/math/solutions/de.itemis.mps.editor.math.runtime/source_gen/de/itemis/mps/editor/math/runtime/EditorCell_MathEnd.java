...
public class EditorCell_MathEnd extends EditorCell_Constant {
  ...
  protected boolean doProcessKeyTyped(final KeyEvent keyEvent, final boolean allowErrors) {
    ...
    if (UIUtil.isReallyTypedEvent(keyEvent)) {
      ...
      getEditorComponent().getEditorContext().getRepository().getModelAccess().runReadAction(() -> pattern.value = ((String) ReflectionUtil_copy.callMethod(EditorCell_Label.class, ((EditorCell_Label) EditorCell_MathEnd.this), "getUpdatedText", new Class[]{String.class}, new Object[]{String.valueOf(keyEvent.getKeyChar())})));
