...
public class BoxDCell extends BoxBaseDCell implements ISelfPaintingCell, IMPSCellContainer, IDiagramDCell {
  ...
  protected double getRequiredHeightForPorts() {
    ...
    return Sequence.fromIterable(MapSequence.fromMap(portsHeights).values()).foldLeft(0.0, new ILeftCombinator<Double, Double>() {
      public Double combine(Double s, Double it) {
