...
public abstract class GrammarCellsSubstituteMenuPart implements MenuPart<SubstituteMenuItem, SubstituteMenuContext> {
  ...
  public List<SubstituteMenuItem> createItems(final SubstituteMenuContext context) {
    ...
    return ListSequence.fromList(descriptors).translate(new ITranslator2<IGrammarActionsDescriptor, SubstituteMenuItem>() {
      public Iterable<SubstituteMenuItem> translate(IGrammarActionsDescriptor it) {
        return it.getActions(context, expectedOutputConcept);
      }
    }).toListSequence();
  }
}
