...
public class Repository extends PFModule {
  ...
  private Repository() {
                              ...
                              public void invoke(final IBuilderContext context) {
                                ...
                                if (true) {
                                  context.forChildRole("models").run(new _FunctionTypes._void_P1_E0<IBuilderContext>() {
                                    public void invoke(final IBuilderContext context) {
                                      int i_a1a0a0d = 0;
                                      for (SNode e_a1a0a0d : Sequence.fromIterable(SLinkOperations.collectMany(SLinkOperations.getChildren(SM_ParameterConversion.toMPS(((INode) context.getContextValue())), LINKS.modules$jBPn), LINKS.models$h3QT)).where(new IWhereFilter<SNode>() {
                                        public boolean accept(SNode it) {
                                          return Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(it, LINKS.rootNodes$jxXY), CONCEPTS.Statemachine$ba)).isNotEmpty();
                                        }
                                      })) {
    ...
    myImplementations.put("de.q60.mps.shadowmodels.examples.statemachine.transformations.Repository.outputModel", new IFunctionImplementation() {
