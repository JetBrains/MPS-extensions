...
public class TreeCell extends EditorCell_Collection {
  ...
  public void loadFoldingState() {
    ...
    Boolean collapsed = check_bzqhpc_a0c0z(ListSequence.fromList(collapseStates).findFirst(new IWhereFilter<Pair<EditorCell, Boolean>>() {
      public boolean accept(Pair<EditorCell, Boolean> it) {
        return Objects.equals(it.o1, TreeCell.this);
      }
    }), this);
  ...
  public void setInsertHandlers(List<IInsertHandler> insertHandlers) {
    ListSequence.fromList(myInsertButtons).visitAll(new IVisitor<Button>() {
    ...
    if (ListSequence.fromList(insertHandlers).isNotEmpty()) {
      List<EditorCell> treeChildren = Sequence.fromIterable(getTreeChildren()).toListSequence();
  ...
  protected void drawOutgoingShape(Graphics2D _g, List<Line2D> lines) {
    ...
    try {
      lines = ListSequence.fromList(lines).select(new ISelector<Line2D, Line2D>() {
        public Line2D select(Line2D it) {
  ...
  public Iterable<EditorCell> getNonButtonCells() {
    ...
    return Sequence.fromIterable(allCells).where(new IWhereFilter<EditorCell>() {
  ...
  protected Iterable<EditorCell> getTreeChildren_(jetbrains.mps.openapi.editor.cells.EditorCell_Collection treeChildrenCollection) {
    ...
    return Sequence.fromIterable(children).translate(new ITranslator2<EditorCell, EditorCell>() {
  ...
  protected void initDeleteButtons() {
    checkNotFolded();
    ListSequence.fromList(myDeleteButtons).visitAll(new IVisitor<Button>() {
      public void visit(Button it) {
        removeCell(it);
      }
    });
  ...
  public Iterable<jetbrains.mps.openapi.editor.cells.EditorCell_Collection> getIntermediateCells() {
    ...
    return Sequence.fromIterable(getTreeChildren()).translate(new ITranslator2<EditorCell, jetbrains.mps.openapi.editor.cells.EditorCell_Collection>() {
      public Iterable<jetbrains.mps.openapi.editor.cells.EditorCell_Collection> translate(EditorCell it) {
        return getIntermediateCells__(it);
      }
    }).distinct();
  ...
  protected Iterable<jetbrains.mps.openapi.editor.cells.EditorCell_Collection> getIntermediateCells_(jetbrains.mps.openapi.editor.cells.EditorCell_Collection parent) {
    ...
    Sequence.fromIterable(result).concat(Sequence.fromIterable(children).translate(new ITranslator2<EditorCell, jetbrains.mps.openapi.editor.cells.EditorCell_Collection>() {
      public Iterable<jetbrains.mps.openapi.editor.cells.EditorCell_Collection> translate(final EditorCell it) {
        return new Iterable<jetbrains.mps.openapi.editor.cells.EditorCell_Collection>() {
          public Iterator<jetbrains.mps.openapi.editor.cells.EditorCell_Collection> iterator() {
