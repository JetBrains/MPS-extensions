...
/*package*/ class CollapsibleWithCallbackCollapsed_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public CollapsibleWithCallbackCollapsed_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollapsible_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("Collapsible_2fp8px_a");
