...
<model ref="r:9b8146a8-b586-47e9-9789-161c96ce45bd(test.de.itemis.model.merge.annotation.tests@tests)">
  ...
  <imports>
    ...
    <import index="1xlh" ref="r:83d91843-991e-414a-ada7-28ed0de69bb1(test.de.itemis.model.merge.annotation.plugin)" />
  </imports>
  <registry>
    ...
    <node concept="1qefOq" id="4LLXBGbToeV" role="1SKRRt">
      <node concept="poArf" id="4LLXBGbToeW" role="1qenE9">
        ...
        <node concept="1Xw6AR" id="4LLXBGbTof0" role="ppbcs">
          <node concept="1dCxOl" id="9mKl49LZp9" role="1XwpL7">
            <property role="1XweGQ" value="r:2fba684e-e94e-434a-8dc5-34578fcfb7c9" />
            <node concept="1j_P7g" id="9mKl49LZpa" role="1j$8Uc">
              <property role="1j_P7h" value="de.itemis.model.merge.test.integration.rightAnnotation" />
            </node>
          </node>
        </node>
