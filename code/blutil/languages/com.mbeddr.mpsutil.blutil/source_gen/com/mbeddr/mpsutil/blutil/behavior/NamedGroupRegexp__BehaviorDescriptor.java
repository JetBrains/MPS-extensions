...
public final class NamedGroupRegexp__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x63e0e5665131447eL, 0x90e312ea330e1a00L, 0x41b7435eb26eb9abL, "com.mbeddr.mpsutil.blutil.structure.NamedGroupRegexp");
  ...
  /*package*/ static String getString_idhMuDF1A(@NotNull SNode __thisNode__, List<SNode> vars) {
    return "(?<" + SPropertyOperations.getString(__thisNode__, PROPS.name$MnvL) + ">" + Regexp__BehaviorDescriptor.getString_idhMuDF1A.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$EXG0), vars) + ")";
  }

  /*package*/ NamedGroupRegexp__BehaviorDescriptor() {
  }
