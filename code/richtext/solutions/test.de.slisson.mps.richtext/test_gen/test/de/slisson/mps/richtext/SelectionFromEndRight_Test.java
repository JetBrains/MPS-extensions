...
public class SelectionFromEndRight_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(SelectionFromEndRight_Test.class, "${extensions.home}/code", "r:37aa730c-08fa-4437-823c-0f0557294fae(test.de.slisson.mps.richtext@tests)", false);
