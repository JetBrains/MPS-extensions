...
public abstract class EditorCell_MathBase extends EditorCell_Collection {
  ...
  public List<MathLayoutableCell> getLayoutableChilds(boolean useTranslation) {
    ...
    return Sequence.fromIterable(Sequence.fromArray(getCells())).where(new IWhereFilter<jetbrains.mps.nodeEditor.cells.EditorCell>() {
      public boolean accept(jetbrains.mps.nodeEditor.cells.EditorCell it) {
        return !(it instanceof EditorCell_MathEnd || it instanceof EditorCell_STHint);
      }
    }).select(new ISelector<jetbrains.mps.nodeEditor.cells.EditorCell, MathLayoutableCell>() {
      public MathLayoutableCell select(jetbrains.mps.nodeEditor.cells.EditorCell it) {
        return (MathLayoutableCell) new MathLayoutableCellAdapter(it, translateX, translateY);
      }
    }).toListSequence();
  }
  ...
  public EditorCell_MathEnd getLeftEndCell() {
    ...
    return (EditorCell_MathEnd) Sequence.fromIterable(Sequence.fromArray(getCells())).findFirst(new IWhereFilter<jetbrains.mps.nodeEditor.cells.EditorCell>() {
      public boolean accept(jetbrains.mps.nodeEditor.cells.EditorCell it) {
        return it instanceof EditorCell_MathEnd;
      }
    });
  }
  ...
  public EditorCell_MathEnd getRightEndCell() {
    ...
    return (EditorCell_MathEnd) Sequence.fromIterable(Sequence.fromArray(getCells())).findLast(new IWhereFilter<jetbrains.mps.nodeEditor.cells.EditorCell>() {
      public boolean accept(jetbrains.mps.nodeEditor.cells.EditorCell it) {
        return it instanceof EditorCell_MathEnd;
      }
    });
