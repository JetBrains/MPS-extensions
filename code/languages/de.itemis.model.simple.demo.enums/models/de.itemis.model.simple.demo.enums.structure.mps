...
<model ref="r:5e14b5a3-3989-4ab3-a15a-50ea008667da(de.itemis.model.simple.demo.enums.structure)">
  ...
  <node concept="1TIwiD" id="38FdiWsmguW">
    ...
    <node concept="1TJgyi" id="2qUFAXp8osx" role="1TKVEl">
      <property role="IQ2nx" value="2790734712369415969" />
      <property role="TrG5h" value="name" />
      <ref role="AX2Wp" to="tpck:fKAOsGN" resolve="string" />
    </node>
    <node concept="1TJgyi" id="2qUFAXqtDXH" role="1TKVEl">
      <property role="IQ2nx" value="2790734712391769965" />
      <property role="TrG5h" value="anotherProperty" />
      <ref role="AX2Wp" to="tpck:fKAOsGN" resolve="string" />
    </node>
  </node>
</model>
