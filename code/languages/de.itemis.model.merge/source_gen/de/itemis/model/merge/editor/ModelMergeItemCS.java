...
public class ModelMergeItemCS implements EditorMenuItemCustomizer {
  ...
  private static class ModelMergeItemCSSpecific implements EditorMenuItemCustomizer {
    ...
    public boolean matches(EditorMenuItemCustomizationContext context) {
      return new EditorMenuItemCreatingConceptContextMatcher(CONCEPTS.ModelMergeItem$U2).matchesContext(context) && getCompletionItemInformation(context) != null;
    }
    ...
    private void customize_(SNode parentNode, SNode currentChild, SContainmentLink containmentLink, EditorMenuItemStyle style, CompletionItemInformation itemInformation) {
      List<SNode> alreadyDefined = Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(parentNode, CONCEPTS.ModelMerge$MA, true, false), LINKS.items$z8dk), CONCEPTS.MergePolicy$RB)).select(new ISelector<SNode, SNode>() {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SInterfaceConcept ModelMergeItem$U2 = MetaAdapterFactory.getInterfaceConcept(0x539e893908ef497cL, 0xa5fd25dd10137a55L, 0x1a8b8d3e42de4bfaL, "de.itemis.model.merge.structure.ModelMergeItem");
