...
/*package*/ class Component_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      style.set(StyleAttributes.getInstance().<Color>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-color"), StyleRegistry.getInstance().getSimpleColor(MPSColors.yellow));
  ...
  private EditorCell createCompartment_2(EditorContext editorContext, SNode node) {
    ...
    style.set(StyleAttributes.getInstance().<Color>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-color"), StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_3k4y3b_a1c0c0a()));
    editorCell.getStyle().putAll(style);
    return editorCell;
  }
