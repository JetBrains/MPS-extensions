...
/*package*/ class Diagram_asDiagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Diagram_asDiagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
      ...
      DiagramCreationContext.createDiagram(() -> {
        DiagramContext.withContext(node, () -> editorCell.value, () -> {
          ContextVariables.withValue("thisNode", node, () -> {
            ...
            DiagramModel model = DiagramModel.getModel(editorContext, node, "2387875361826631513");
            ...
            editorCell.value.setCellId("Diagram_w1gfcb_a");
