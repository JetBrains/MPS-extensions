...
public class BracketsInsert {
  ...
  public boolean containsBracket(SNode node, final boolean left) {
    return ListSequence.fromList(SNodeOperations.getNodeDescendants(node, SNodeOperations.asSConcept(SNodeOperations.getConcept(node)), false, new SAbstractConcept[]{})).any(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return ListSequence.fromList(new IAttributeDescriptor.NodeAttribute(CONCEPTS.ArbitraryTextAnnotation$hv).list(it)).any(new IWhereFilter<SNode>() {
          public boolean accept(SNode it) {
