...
public class SelectDown_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCache(SelectDown_Test.class, "${extensions.home}/code", "r:37aa730c-08fa-4437-823c-0f0557294fae(test.de.slisson.mps.richtext@tests)", false));
