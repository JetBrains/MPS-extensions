...
/*package*/ class BaseDiagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BaseDiagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ylroit_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_ylroit_a0");
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createProperty_0());
    return editorCell;
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "base diagram");
    editorCell.setCellId("Constant_ylroit_a0a");
        ...
        DiagramContext.withContext(node, () -> editorCell.value, () -> {
          ContextVariables.withValue("thisNode", node, () -> {
            ...
            IDiagramAccessor accessor = new AbstractDiagramAccessor(node) {
              ...
              private boolean nodeCondition_ylroit_a1a() {
                return true;
              }

              @Override
              public boolean saveDiagramLayout() {
                return nodeCondition_ylroit_a1a();
              }
            ...
            editorCell.value.setCellId("Diagram_ylroit_b0");
            Style style = new StyleImpl();
            style.set(StyleAttributes.getInstance().<Direction>getAttribute("de.itemis.mps.editor.diagram", "diagram-layout-direction"), _StyleParameter_QueryFunction_ylroit_a0b0());
  ...
  private Direction _StyleParameter_QueryFunction_ylroit_a0b0() {
