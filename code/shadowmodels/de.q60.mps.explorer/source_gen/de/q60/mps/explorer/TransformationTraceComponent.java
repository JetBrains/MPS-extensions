...
public class TransformationTraceComponent extends SimpleToolWindowPanel {
  ...
  protected void initComponents() {
    ...
    myMasterTree.addTreeSelectionListener((TreeSelectionEvent event) -> {
      final Object detailViewRoot = Sequence.fromIterable(Sequence.fromArray(event.getNewLeadSelectionPath().getPath())).ofType(TNode.class).select(new ISelector<TNode, Object>() {
        public Object select(TNode it) {
          return it.getDetailViewRoot();
        }
      }).last();
