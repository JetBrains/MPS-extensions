...
public class TableTraversalUtil {
  private static Logger LOG = Logger.getLogger(TableTraversalUtil.class);
  ...
  public static EditorCell getSibling(EditorCell cell, boolean forward) {
    EditorCell_GridCell gridCell = as_bnvmg9_a0a0a41(cell, EditorCell_GridCell.class);
    if (gridCell != null) {
      ...
      while (pos != null) {
        EditorCell sibling = check_bnvmg9_a0a0e0b0o(as_bnvmg9_a0a0a0e0b0o(grid.getElement(pos), EditorCellGridLeaf.class));
        if (sibling != null) {
          return sibling;
        }
        pos = (forward ? grid.next(pos) : grid.previous(pos));
    ...
    cellIterator = ListSequence.fromList(asList(cellIterator)).where(new IWhereFilter<EditorCell>() {
      public boolean accept(EditorCell it) {
        return !(it instanceof PartialTableEditor);
      }
    }).iterator();
  ...
  public static EditorCell getUpperInColumn(EditorCell cell, Condition<EditorCell> condition, int caretX) {
    ...
    if (gridCell != null) {
      ...
      if (grid.isValidPosition(aboveGridPos)) {
        EditorCell_GridCell aboveGridCell = (EditorCell_GridCell) check_bnvmg9_a0a0a4a2a34(as_bnvmg9_a0a0a0a4a2a34(grid.getElement(aboveGridPos), EditorCellGridLeaf.class));
  ...
  public static EditorCell getLowerInColumn(EditorCell cell, final Condition<EditorCell> condition, int caretX) {
    ...
    if (gridCell != null) {
      ...
      GridPosition aboveGridPos = currentGridPos.deriveY(currentGridPos.getY() + 1);
      if (grid.isValidPosition(aboveGridPos)) {
        EditorCell_GridCell belowGridCell = (EditorCell_GridCell) check_bnvmg9_a0a0a4a2a54(as_bnvmg9_a0a0a0a4a2a54(grid.getElement(aboveGridPos), EditorCellGridLeaf.class));
  ...
  public static void getDescendants(EditorCell cell, @NotNull Condition<EditorCell> condition, List<EditorCell> accumulator) {
    ...
    EditorCell_Collection collection = as_bnvmg9_a0a2a17(cell, EditorCell_Collection.class);
    if (collection != null) {
  ...
  private static EditorCell check_bnvmg9_a0a0e0b0o(EditorCellGridLeaf checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorCell();
    }
    return null;
  }
  private static EditorCell check_bnvmg9_a0a0a4a2a34(EditorCellGridLeaf checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorCell();
    }
    return null;
  }
  private static EditorCell check_bnvmg9_a0a0a4a2a54(EditorCellGridLeaf checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorCell();
    }
    return null;
  }
  private static <T> T as_bnvmg9_a0a0a41(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_bnvmg9_a0a0a0e0b0o(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_bnvmg9_a0a0a0a4a2a34(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_bnvmg9_a0a0a0a4a2a54(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_bnvmg9_a0a2a17(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
}
