...
public class ProjectViewUtil {
  ...
  static {
    ...
    MapSequence.fromMap(ProjectViewUtil.actionGroupsIds).put(Project.class, ProjectActions_ActionGroup.ID);
  }
  ...
  public static Iterable<String> getFolders(SModule module, Project project) {
    ...
    String path = check_xwzga8_a0c0l(as_xwzga8_a0a0c0l(project, MPSProject.class), module);
    if (path == null) {
      return Sequence.fromIterable(Collections.<String>emptyList());
    }
  ...
  private static String check_xwzga8_a0c0l(MPSProject checkedDotOperand, SModule module) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getVirtualFolder(module);
    }
    return null;
  }
