...
/*package*/ class ParenthesesExpression_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ParenthesesExpression_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ilef1_a");
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          ...
          SNode inner = SLinkOperations.getTarget(node, LINKS.inner$6h_o);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ilef1_a0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new innerSingleRoleHandler_ilef1_b0(myNode, LINKS.inner$6h_o, getEditorContext());
    return provider.createCell();
  }
  private static class innerSingleRoleHandler_ilef1_b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public innerSingleRoleHandler_ilef1_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_ilef1_a2a");
    editorCell.setDefaultText("");
    return editorCell;
  }
