...
public class RootDiagramECell extends BaseDiagramECell implements EditorCell_WithComponent, ITooltipProvider {
  private static final Logger LOG = Logger.getLogger(RootDiagramECell.class);
  ...
  private SelectionListener mySelectionListener = new SelectionListener() {
    public void selectionChanged(EditorComponent component, Selection oldSelection, Selection newSelection) {
      ...
      if (check_l91fln_a0g0a0a0p(as_l91fln_a0a0g0a0a0p(oldSelection, GraphSelection.class)) == RootDiagramECell.this) {
        newFocus = (jetbrains.mps.nodeEditor.EditorComponent) getEditorComponent();
      }
      if (check_l91fln_a0h0a0a0p(as_l91fln_a0a0h0a0a0p(oldSelection, EditorCellSelection.class)) == RootDiagramECell.this) {
        newFocus = (jetbrains.mps.nodeEditor.EditorComponent) getEditorComponent();
      }
      if (check_l91fln_a0i0a0a0p(as_l91fln_a0a0i0a0a0p(newSelection, GraphSelection.class)) == RootDiagramECell.this) {
  ...
  public void runAutoLayouterOnInit(SNode node, boolean runLayouter) {
    if ((new IAttributeDescriptor.NodeAttribute(CONCEPTS.LayoutMap$4m).get(node) == null) && runLayouter) {
  ...
  public RootDiagramECell(final EditorContext context, SNode node, final DiagramModel model) {
    ...
    setAction(CellActionType.LEFT, new PanAction(-MyGraphComponent.PAN_AMOUNT, 0));
    setAction(CellActionType.RIGHT, new PanAction(MyGraphComponent.PAN_AMOUNT, 0));
    setAction(CellActionType.UP, new PanAction(0, -MyGraphComponent.PAN_AMOUNT));
    setAction(CellActionType.DOWN, new PanAction(0, MyGraphComponent.PAN_AMOUNT));

    setAction(CellActionType.SELECT_LEFT, new PanAction(-MyGraphComponent.PAN_AMOUNT_SLOW, 0));
    setAction(CellActionType.SELECT_RIGHT, new PanAction(MyGraphComponent.PAN_AMOUNT_SLOW, 0));
    setAction(CellActionType.SELECT_PREVIOUS, new PanAction(0, -MyGraphComponent.PAN_AMOUNT_SLOW));
    setAction(CellActionType.SELECT_NEXT, new PanAction(0, MyGraphComponent.PAN_AMOUNT_SLOW));
  }
  ...
  public void focusTimer() {
    ...
    SelectionManager selectionManager = check_l91fln_a0h0jb(getEditorComponent(), this);
  ...
  public Project getIdeaProject() {
    return ProjectHelper.toIdeaProject(ProjectHelper.getProject(getContext().getRepository()));
  }

  public Palette getPalette() {
    Project ideaProject = getIdeaProject();
    return ideaProject.getComponent(ProjectPluginManager.class).getTool(Diagram_Palette_Tool.class).getPaletteComponent();
  }
  ...
  public void relayoutImpl() {
    LayoutDependencies.getInstance(this).layoutAndRecordDependencies(new LayoutDependencies.EditorCellLayoutable(this) {
      ...
      public void layout() {
        ...
        Sequence.fromIterable(descendantCells).ofType(EditorCell_Label.class).where(new IWhereFilter<EditorCell_Label>() {
          public boolean accept(EditorCell_Label it) {
            return it.wasRelayoutRequested() || isNotEmptyString(it.getText()) && (it.getHeight() == 0 || it.getRenderedTextLine().getHeight() == 0);
          }
        }).visitAll(new IVisitor<EditorCell_Label>() {
          public void visit(EditorCell_Label it) {
            it.relayout();
          }
        });
        Sequence.fromIterable(descendantCells).ofType(EditorCell_Basic.class).visitAll(new IVisitor<EditorCell_Basic>() {
          public void visit(EditorCell_Basic it) {
            it.unrequestLayout();
          }
        });
      }
  ...
  public void onAdd() {
    ...
    try {
      Project ideaProject = getIdeaProject();
      if (ideaProject != null) {
        if (ideaProject.getComponent(ProjectPluginManager.class).getTool(Diagram_Palette_Tool.class) != null) {
          ideaProject.getComponent(ProjectPluginManager.class).getTool(Diagram_Palette_Tool.class).makeAvailableLater();
        } else {
          LOG.debug("Diagram palette not found in the project");
        }
      }
    } catch (Exception ex) {
      LOG.warn("Cannot open palette", ex);
    }
    ...
    if (!(wasRelayoutRequested())) {
      for (Object cell : myGraph.getView().getStates().keySet()) {
        if (cell instanceof IMPSCellContainer) {
          EditorCell_Basic editorCell = as_l91fln_a0a0a0a0a0a87(((IMPSCellContainer) cell).getBigCell(), EditorCell_Basic.class);
          if (editorCell != null) {
  ...
  public ITooltip getTooltipAt(final int x, final int y) {
    ...
    if (editorCell == null) {
      editorCell = check_l91fln_a0a0f0cd(getGraph().getGraphComponent().findMPSCell(x, y), this);
    }
    if (editorCell == null) {
      if (dcell instanceof BoxBaseDCell) {
        editorCell = check_l91fln_a0a0a0g0cd(ListSequence.fromList(((BoxBaseDCell) dcell).getMPSCells()).first());
      }
    }
    if (editorCell != null) {
    ...
    MyVertexHandler vertexHandler = as_l91fln_a0a8a08(getGraph().getGraphComponent().getSelectionCellsHandler().getHandler(dcell), MyVertexHandler.class);
    MyEdgeHandler edgeHandler = as_l91fln_a0a9a08(getGraph().getGraphComponent().getSelectionCellsHandler().getHandler(dcell), MyEdgeHandler.class);
  ...
  private static RootDiagramECell check_l91fln_a0g0a0a0p(GraphSelection checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getDiagramCell();
    }
    return null;
  }
  private static EditorCell check_l91fln_a0h0a0a0p(EditorCellSelection checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorCell();
    }
    return null;
  }
  private static RootDiagramECell check_l91fln_a0i0a0a0p(GraphSelection checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getDiagramCell();
    }
    return null;
  }
  private static SelectionManager check_l91fln_a0h0jb(EditorComponent checkedDotOperand, RootDiagramECell checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getSelectionManager();
    }
    return null;
  }
  private static EditorCell check_l91fln_a0a0f0cd(MPSCell checkedDotOperand, RootDiagramECell checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorCell();
    }
    return null;
  }
  private static EditorCell check_l91fln_a0a0a0g0cd(MPSCell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorCell();
    }
    return null;
  ...
  private static <T> T as_l91fln_a0a0a0a0a0a87(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_l91fln_a0a8a08(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_l91fln_a0a9a08(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
