...
public abstract class AlignButton extends ContextButton {
  ...
  protected void execute() {
    ...
    List<BaseDCell> otherCells = Sequence.fromIterable(Sequence.fromArray(graph.getSelectionCells())).ofType(BaseDCell.class).subtract(Sequence.fromIterable(Sequence.<BaseDCell>singleton(cell))).toListSequence();
