package de.slisson.mps.richtext.customcell.generator.template.main;
...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static boolean rule_Condition_0_0(final BaseMappingRuleContext _context) {
    if (ListSequence.fromList(SNodeOperations.getChildren(_context.getNode(), LINKS.childCellModel$XMHB)).count() > 1) {
  ...
  public static Object referenceMacro_GetReferent_1_0(final ReferenceMacroContext _context) {
    return _context.getOutputNodeByInputNodeAndMappingLabel(SLinkOperations.getTarget(_context.getNode(), LINKS.childCellModel$XMHB), "cellFactory.factoryMethod");
  }
  public static boolean ifMacro_Condition_1_0(final IfMacroContext _context) {
    return (SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.childCellModel$XMHB), LINKS.renderingCondition$O1b5) != null);
  }
  public static SNode sourceNodeQuery_1_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.factoryMethod$vAXl), LINKS.body$e68K);
  }
  public static SNode sourceNodeQuery_1_1(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.childCellModel$XMHB);
  }
  public static Iterable<SNode> sourceNodesQuery_1_0(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.childCellModel$XMHB), LINKS.renderingCondition$O1b5), LINKS.body$e68K), LINKS.statement$53DE);
  }
  ...
  private final Map<String, PropertyValueQuery> pvqMethods = new HashMap<String, PropertyValueQuery>();
  {
    ...
    pvqMethods.put("4156077588703572866", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "_cell_factory_method_"));
  }
  @NotNull
  @Override
