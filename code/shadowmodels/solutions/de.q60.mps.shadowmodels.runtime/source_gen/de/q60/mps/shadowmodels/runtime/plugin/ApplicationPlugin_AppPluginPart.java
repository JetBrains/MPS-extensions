...
public class ApplicationPlugin_AppPluginPart extends ApplicationPluginPart {
  ...
  public void init() {
    ...
    ApplicationPlugin_AppPluginPart.this.changeTranslator.start(MPSModuleRepository.getInstance());
    PersistenceRegistry.getInstance().addFindUsagesParticipant(ShadowModelFindUsagesParticipant.INSTANCE);
    ApplicationPlugin_AppPluginPart.this.mirror = new RepositoryMirror(MPSModuleRepository.getInstance());
  ...
  public void dispose() {
    ...
    PersistenceRegistry.getInstance().removeFindUsagesParticipant(ShadowModelFindUsagesParticipant.INSTANCE);
