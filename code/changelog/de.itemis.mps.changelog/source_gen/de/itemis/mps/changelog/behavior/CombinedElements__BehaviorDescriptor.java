...
public final class CombinedElements__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getTextualRepresentation_idfB3l81it7u(@NotNull SNode __thisNode__) {
    return IterableUtils.join(Sequence.fromIterable(Line__BehaviorDescriptor.getTextElements_idWJz9iATjyN.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.line$6dQe))).select(new ISelector<SNode, String>() {
