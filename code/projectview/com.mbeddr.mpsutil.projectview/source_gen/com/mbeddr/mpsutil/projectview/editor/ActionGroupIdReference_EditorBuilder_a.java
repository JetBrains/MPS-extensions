...
/*package*/ class ActionGroupIdReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ActionGroupIdReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_nln0tu_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.actionGroup$JMkQ;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.actionGroup$JMkQ);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.actionGroup$JMkQ);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_nln0tu_b0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_nln0tu_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
