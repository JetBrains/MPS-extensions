...
<model ref="r:e14e3f70-e9b9-421a-9060-c8ac30089d4b(de.itemis.mps.compare.pattern.editor)">
  ...
  <imports>
    ...
    <import index="iqxq" ref="r:5a244481-ee36-4984-a70c-5d4ba8e7e090(de.itemis.mps.compare.pattern.structure)" implicit="true" />
              ...
              <node concept="3cpWs6" id="53_zXRVeYE" role="3cqZAp">
                <node concept="3K4zz7" id="53_zXRVeYF" role="3cqZAk">
                  ...
                  <node concept="2OqwBi" id="53_zXRVeYM" role="3K4E3e">
                    ...
                    <node concept="3zqWPK" id="WEZADybpBm" role="2OqNvi">
  ...
  <node concept="24kQdi" id="4oNjwzxoYg_">
    ...
    <node concept="3EZMnI" id="76efOMRCHWT" role="2wV5jI">
      ...
      <node concept="3F0A7n" id="4oNjwzxoYRi" role="3EZMnx">
        <ref role="1NtTu8" to="iqxq:17qUVvSZm7A" resolve="kind" />
  ...
  <node concept="22mcaB" id="2cvVnUuAor8">
    <ref role="aqKnT" to="iqxq:$WtIWn_nVz" resolve="MemberAnnotation" />
    <node concept="22hDWj" id="27yO7ubpHxZ" role="22hAXT" />
  </node>
</model>
