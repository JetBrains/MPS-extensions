...
/*package*/ class MultiChildPolicy_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public MultiChildPolicy_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_pupcu3_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_pupcu3_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new subPolicyListHandler_pupcu3_c0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_subPolicy");
  ...
  private static class subPolicyListHandler_pupcu3_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public subPolicyListHandler_pupcu3_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(subPolicyListHandler_pupcu3_c0.this.getNode(), LINKS.subPolicy$$EhP));
      try {
