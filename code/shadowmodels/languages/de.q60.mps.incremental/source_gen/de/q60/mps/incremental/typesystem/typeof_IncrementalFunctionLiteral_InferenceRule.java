...
public class typeof_IncrementalFunctionLiteral_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode n, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    // FIXME revisit, check if property/association/aggregation matchers correspond to the intention of this code. 
    //      Values I placed are based on legacy MatchingUtil.matchNodes logic and not necessarily reflect intentions of this code.
    final SNodeMatcher nodeCompare = new SNodeMatcher(new SNodeMatcher.EqualPersistentValues(), new SNodeMatcher.IdenticalTargetNode(), new SNodeMatcher.SameOrderChildMatch());
with_allThrows:
    for (SNode another : allThrows) {
      if (SNodeOperations.isInstanceOf(another, CONCEPTS.ClassifierType$bL)) {
        for (SNode one : realThrows) {
          ...
          if (nodeCompare.match(one, another)) {
            continue with_allThrows;
          }
        }
        for (SNode caught : allCatches) {
          ...
          if (nodeCompare.match(caught, another)) {
            continue with_allThrows;
          }
        }
      }
      ...
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(rs, CONCEPTS.ReturnStatement$lt), LINKS.expression$eJ92), CONCEPTS.NullLiteral$QQ)) {
        {
          ...
          typeCheckingContext.createGreaterThanInequality((SNode) typeCheckingContext.getRepresentative(RLCS_typevar_1221579075692), (SNode) _quotation_createNode_bkc94g_a1a0c0a0a0t0b(), false, true, _info_12389875345);
        }
      } else {
        ...
        if (retExpression == null) {
          {
            ...
            typeCheckingContext.createGreaterThanInequality((SNode) typeCheckingContext.getRepresentative(RLCS_typevar_1221579075692), (SNode) _quotation_createNode_bkc94g_a1a0c0a0b0a0a91a1(), false, true, _info_12389875345);
          }
          isVoid = true;
        } else {
          {
      ...
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(ys, CONCEPTS.YieldStatement$yx), LINKS.expression$BvDE), CONCEPTS.NullLiteral$QQ)) {
        {
          ...
          typeCheckingContext.createGreaterThanInequality((SNode) typeCheckingContext.getRepresentative(YLCS_typevar_1221579075693), (SNode) _quotation_createNode_bkc94g_a1a0c0a0a0v0b(), false, true, _info_12389875345);
        }
      } else {
        {
      ...
      case 1:
        if (ListSequence.fromList(allYldAlls).getElement(0) == lastStmt && !(yieldsValue)) {
          returnsValue = true;
          {
            ...
            typeCheckingContext.createGreaterThanInequality((SNode) typeCheckingContext.getRepresentative(RLCS_typevar_1221579075692), (SNode) _quotation_createNode_bkc94g_a1a0c0b0a0b92a1(typeCheckingContext.getRepresentative(YALCS_typevar_1229000934873)), false, true, _info_12389875345);
          }
          break;
        }
        //  fall through
    ...
    if (returnsFromLast && !(yieldsValue)) {
      if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SNodeOperations.cast(lastStmt, CONCEPTS.ExpressionStatement$O8), LINKS.expression$5L7M), CONCEPTS.NullLiteral$QQ)) {
        {
          ...
          typeCheckingContext.createEquation((SNode) typeCheckingContext.getRepresentative(TERMINATE_typevar_1232105622932), (SNode) _quotation_createNode_bkc94g_a1a0c0a0a0ib0b(), _info_12389875345);
        }
      } else {
        {
    ...
    } else {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.getRepresentative(TERMINATE_typevar_1232105622932), (SNode) _quotation_createNode_bkc94g_a1a0c0a0a43a1(), _info_12389875345);
      }
      {
        SNode _nodeToCheck_1029348928467 = n;
    ...
    if (yieldsValue) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:822ea074-1a4a-4757-a8d8-b7d292b9c468(de.q60.mps.incremental.typesystem)", "1229718251100", true), (SNode) IncrementalFunctionLiteral__BehaviorDescriptor.getType_idhTgUC0Q.invoke(n, paramTypes, _quotation_createNode_bkc94g_b0a1a0c0a0a0jb0b(typeCheckingContext.getRepresentative(YLCS_typevar_1221579075693)), null, null, realThrows), _info_12389875345);
      }
    } else {
      {
        SNode _nodeToCheck_1029348928467 = n;
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:822ea074-1a4a-4757-a8d8-b7d292b9c468(de.q60.mps.incremental.typesystem)", "1229718277155", true), (SNode) IncrementalFunctionLiteral__BehaviorDescriptor.getType_idhTgUC0Q.invoke(n, paramTypes, _quotation_createNode_bkc94g_b0a1a0c0a0a0a53a1(), _quotation_createNode_bkc94g_c0a1a0c0a0a0a53a1(), _quotation_createNode_bkc94g_d0a1a0c0a0a0a53a1(), realThrows), _info_12389875345);
      }
    }
  ...
  private static SNode _quotation_createNode_bkc94g_a1a0c0a0a0t0b() {
  ...
  private static SNode _quotation_createNode_bkc94g_a1a0c0a0b0a0a91a1() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_bkc94g_a1a0c0a0a0v0b() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x1185ff468caL, "NullType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_bkc94g_a0a0c0b0x0b(Object parameter_1, Object parameter_2) {
  ...
  private static SNode _quotation_createNode_bkc94g_a1a0c0b0a0b92a1(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_bkc94g_a1a0c0a0a0ib0b() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x1185ff468caL, "NullType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_bkc94g_a1a0c0a0a43a1() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8cc6bf96dL, "VoidType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_bkc94g_b0a1a0c0a0a0jb0b(Object parameter_1) {
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, "jetbrains.mps.baseLanguage.collections"), 0x10c260e9444L, "SequenceType"));
    quotedNode_2 = nb.getResult();
  ...
  private static SNode _quotation_createNode_bkc94g_b0a1a0c0a0a0a53a1() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8cc6bf96dL, "VoidType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_bkc94g_c0a1a0c0a0a0a53a1() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8cc6bf96dL, "VoidType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_bkc94g_d0a1a0c0a0a0a53a1() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8cc6bf96dL, "VoidType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
