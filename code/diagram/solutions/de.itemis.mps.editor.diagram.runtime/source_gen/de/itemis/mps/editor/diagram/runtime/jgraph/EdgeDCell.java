...
public class EdgeDCell extends BaseDCell implements ISelfPaintingCell, IMPSCellContainer, IDiagramDCell {
  ...
  public List<LabelDCell> getAllLabelCells() {
    return Sequence.fromIterable(MapSequence.fromMap(myLabelCells).values()).toListSequence();
  }
  ...
  public String getTooltipText() {
    ...
    List<EditorMessageWithTarget> list = ((List<EditorMessageWithTarget>) ReflectionUtil_copy.callMethod(EditorComponent.class, editorComponent, "getEditorMessagesFor", new Class[]{EditorCell.class}, new Object[]{ecell}));
    String messages = IterableUtils.join(ListSequence.fromList(list).select(new ISelector<EditorMessageWithTarget, String>() {
      public String select(EditorMessageWithTarget it) {
