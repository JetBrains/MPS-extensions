...
/*package*/ class SplittableCell_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SplittableCell_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_kjy5d7_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    Style style = new StyleImpl();
    new rootCellModelStyleStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_kjy5d7_a0a()));
  ...
  private Color _StyleParameter_QueryFunction_kjy5d7_a0a() {
  ...
  private EditorCell createRefCell_0() {
    ...
    style.set(StyleAttributes.TEXT_BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_kjy5d7_a0b0()));
    style.set(StyleAttributes.BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_kjy5d7_a1b0()));
    style.set(StyleAttributes.TEXT_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_kjy5d7_a2b0()));
    style.set(StyleAttributes.FONT_STYLE, _StyleParameter_QueryFunction_kjy5d7_a3b0());
    style.set(StyleAttributes.UNDERLINED, _StyleParameter_QueryFunction_kjy5d7_a4b0());
    style.set(StyleAttributes.STRIKE_OUT, _StyleParameter_QueryFunction_kjy5d7_a5b0());
    editorCell.getStyle().putAll(style);
