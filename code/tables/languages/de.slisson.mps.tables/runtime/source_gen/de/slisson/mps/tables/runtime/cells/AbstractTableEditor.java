...
public abstract class AbstractTableEditor extends EditorCell_Collection {
  ...
  public void sortChildren() {
    List<jetbrains.mps.nodeEditor.cells.EditorCell> unsorted = Sequence.fromIterable(Sequence.fromArray(getCells())).toListSequence();
    List<jetbrains.mps.nodeEditor.cells.EditorCell> sorted = ListSequence.fromList(unsorted).sort(new ISelector<jetbrains.mps.nodeEditor.cells.EditorCell, Integer>() {
      public Integer select(jetbrains.mps.nodeEditor.cells.EditorCell it) {
        return getRow(it);
      }
    }, true).toListSequence();
    if (!(Objects.equals(unsorted, sorted))) {
      ListSequence.fromList(unsorted).visitAll(new IVisitor<jetbrains.mps.nodeEditor.cells.EditorCell>() {
        public void visit(jetbrains.mps.nodeEditor.cells.EditorCell it) {
          removeCell(it);
        }
      });
      ListSequence.fromList(sorted).visitAll(new IVisitor<jetbrains.mps.nodeEditor.cells.EditorCell>() {
        public void visit(jetbrains.mps.nodeEditor.cells.EditorCell it) {
          addEditorCell(it);
        }
      });
