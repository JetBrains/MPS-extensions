...
public class SavedCaretPosition {
  ...
  public void save() {
    ...
    myCellsBefore = ListSequence.fromList(getLeafs(selectedCell, false)).select(new ISelector<EditorCell, SavedCell>() {
      public SavedCell select(EditorCell it) {
        return getCellInfo(it);
      }
    }).toListSequence();
    myCellsAfter = ListSequence.fromList(getLeafs(selectedCell, true)).select(new ISelector<EditorCell, SavedCell>() {
      public SavedCell select(EditorCell it) {
        return getCellInfo(it);
      }
    }).toListSequence();
  ...
  protected void selectBestCandidate(boolean preferLeft) {
    List<EditorCell> oldCellsBefore = ListSequence.fromList(myCellsBefore).select(new ISelector<SavedCell, EditorCell>() {
      public EditorCell select(SavedCell it) {
        return it.findCell();
      }
    }).toListSequence();
    List<EditorCell> oldCellsAfter = ListSequence.fromList(myCellsAfter).select(new ISelector<SavedCell, EditorCell>() {
      public EditorCell select(SavedCell it) {
        return it.findCell();
      }
    }).toListSequence();
    final Set<EditorCell> allFoundCells = SetSequence.fromSet(new HashSet<EditorCell>());
    SetSequence.fromSet(allFoundCells).addSequence(ListSequence.fromList(oldCellsBefore).where(new IWhereFilter<EditorCell>() {
      public boolean accept(EditorCell it) {
        return it != null;
      }
    }));
    SetSequence.fromSet(allFoundCells).addSequence(ListSequence.fromList(oldCellsAfter).where(new IWhereFilter<EditorCell>() {
      public boolean accept(EditorCell it) {
        return it != null;
      }
    }));
    ...
    for (int i = 0; i < ListSequence.fromList(oldCellsBefore).count(); i++) {
      ...
      EditorCell cellLeft = ListSequence.fromList(oldCellsBefore).headListSequence(i).findLast(new IWhereFilter<EditorCell>() {
        public boolean accept(EditorCell it) {
          return it != null;
        }
      });
      EditorCell cellRight = ListSequence.fromList(oldCellsBefore).tailListSequence(i + 1).findFirst(new IWhereFilter<EditorCell>() {
        public boolean accept(EditorCell it) {
          return it != null;
        }
      });
      ...
      EditorCell foundCell = ListSequence.fromList(candidates).findFirst(new IWhereFilter<EditorCell>() {
        public boolean accept(EditorCell it) {
          return it != null && !(SetSequence.fromSet(allFoundCells).contains(it)) && Objects.equals(check_c79w0i_a0a0a0a0a01a01a71(as_c79w0i_a0a0a0a0a0a0a0k0k0r(it, EditorCell_Label.class)), cellText);
        }
      });
      if (foundCell != null) {
    ...
    for (int i = 0; i < ListSequence.fromList(oldCellsAfter).count(); i++) {
      ...
      EditorCell cellLeft = ListSequence.fromList(oldCellsAfter).headListSequence(i).findLast(new IWhereFilter<EditorCell>() {
        public boolean accept(EditorCell it) {
          return it != null;
        }
      });
      EditorCell cellRight = ListSequence.fromList(oldCellsAfter).tailListSequence(i + 1).findFirst(new IWhereFilter<EditorCell>() {
        public boolean accept(EditorCell it) {
          return it != null;
        }
      });
      ...
      EditorCell foundCell = ListSequence.fromList(candidates).findLast(new IWhereFilter<EditorCell>() {
        public boolean accept(EditorCell it) {
          return it != null && !(SetSequence.fromSet(allFoundCells).contains(it)) && Objects.equals(check_c79w0i_a0a0a0a0a01a11a71(as_c79w0i_a0a0a0a0a0a0a0k0l0r(it, EditorCell_Label.class)), cellText);
        }
      });
      if (foundCell != null) {
    ...
    oldCellsBefore = ListSequence.fromList(oldCellsBefore).where(new IWhereFilter<EditorCell>() {
      public boolean accept(EditorCell it) {
        return it != null;
      }
    }).toListSequence();
    oldCellsAfter = ListSequence.fromList(oldCellsAfter).where(new IWhereFilter<EditorCell>() {
      public boolean accept(EditorCell it) {
        return it != null;
      }
    }).toListSequence();
    ...
    if (mySelectedCell.getTextWithoutSpaces().length() >= 2) {
      ...
      String newCellsText = IterableUtils.join(ListSequence.fromList(newCells).select(new ISelector<EditorCell, String>() {
        public String select(EditorCell it) {
          String text = check_c79w0i_a0a0a0a0a0d0t0r(as_c79w0i_a0a0a0a0a0a0a0a3a91a71(it, EditorCell_Label.class));
    ...
    EditorCell candidate = getLeaf(ListSequence.fromList(oldCellsBefore).last(), true, EditorCell_Label.class);
    ...
    if (preferLeft && ListSequence.fromList(oldCellsBefore).ofType(EditorCell_Label.class).isNotEmpty()) {
      selectCell(ListSequence.fromList(oldCellsBefore).ofType(EditorCell_Label.class).last(), true);
      return;
    } else {
      selectCell(ListSequence.fromList(oldCellsAfter).ofType(EditorCell_Label.class).first(), false);
      return;
    }
  }
  ...
  @Nullable
  protected EditorCell getLeaf(@Nullable EditorCell cell, boolean next, Class<? extends EditorCell> type) {
    EditorCell leaf = getLeaf(cell, next);
    while (leaf != null && !(type.isInstance(leaf))) {
      leaf = getLeaf(leaf, next);
    }
    return leaf;
  }
  ...
  protected String getText(EditorCell cell) {
    ...
    String text = check_c79w0i_a0b0kb(as_c79w0i_a0a0b0kb(cell, EditorCell_Label.class));
    if (text == null) {
      return "";
    }
    return text;
  ...
  protected class SavedCell {
    ...
    public SavedCell(EditorCell cell) {
      ...
      myText = check_c79w0i_a0b0d83(as_c79w0i_a0a0b0d83(cell, EditorCell_Label.class));
    }
  ...
  private static String check_c79w0i_a0b0kb(EditorCell_Label checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getText();
    }
    return null;
  }
  private static String check_c79w0i_a0b0d83(EditorCell_Label checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getText();
    }
    return null;
  }
  private static <T> T as_c79w0i_a0a0a0a0a0a0a0k0k0r(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_c79w0i_a0a0a0a0a0a0a0k0l0r(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_c79w0i_a0a0a0a0a0a0a0a3a91a71(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_c79w0i_a0a0b0kb(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_c79w0i_a0a0b0d83(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
}
