...
public class ProjectAsNode extends TreeElementAsNode<MPSProject> {
  ...
  private static TreeElementAsNode.IChildAccessor<MPSProject> projectModulesAccessor = new TreeElementAsNode.IChildAccessor<MPSProject>() {
    public Iterable<INode> get(final MPSProject project) {
      ...
      return Sequence.fromIterable(modules).select((it) -> new ProjectModuleAsNode(project, it));
    }
  };
  ...
  public INode getParent() {
    return new SRepositoryAsNode(MPSCoreComponents.getInstance().getPlatform().findComponent(MPSModuleRepository.class));
  }
  @NotNull
  @Override
  ...
  public static class NodeReference implements INodeReference {
    ...
    public ProjectAsNode resolveNode(@Nullable IArea area) {
      ...
      MPSProject project = ListSequence.fromList(projects).ofType(MPSProject.class).findFirst((it) -> Objects.equals(it.getName(), projectName) && Objects.equals(it.getProject().getPresentableUrl(), path));
