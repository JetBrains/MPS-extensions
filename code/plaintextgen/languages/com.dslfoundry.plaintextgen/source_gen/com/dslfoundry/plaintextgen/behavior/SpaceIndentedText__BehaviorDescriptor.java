...
public final class SpaceIndentedText__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> surroundWith_id3xkJrZKaXl3 = new SMethodBuilder<>(Void.TYPE).name("surroundWith").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4059077796233467203L).languageId(0xbfe90ca3c9c6247aL, 0x990507d335274c54L).build2(SMethodBuilder.createJavaParameter(SNode.class, "element"));
