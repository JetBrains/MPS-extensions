...
public class Palette extends JPanel {
  ...
  public static Palette getInstance(Project project) {
    ...
    if (ProjectPluginManager.getInstance(ProjectHelper.toIdeaProject(project)).getTool(Diagram_Palette_Tool.class) == null) {
      return null;
    }
    return ProjectPluginManager.getInstance(ProjectHelper.toIdeaProject(project)).getTool(Diagram_Palette_Tool.class).getPaletteComponent();
  }
