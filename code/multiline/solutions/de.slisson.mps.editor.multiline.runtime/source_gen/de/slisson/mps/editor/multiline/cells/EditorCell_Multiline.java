...
public class EditorCell_Multiline extends EditorCell_Collection {
  private static final Logger LOG = Logger.wrap(LogManager.getLogger(EditorCell_Multiline.class));
  ...
  public String toString() {
    ...
    if (check_v798xa_a0b0v(shortText) > 30) {
  ...
  public void setCaretPosition(int pos, boolean enforceSelection) {
    ...
    check_v798xa_a3a82(((EditorCell_Multiline) getCellInfo().findCell(getEditor())), pos, enforceSelection, this);
  }
  ...
  public int getAbsoluteTextPosition(EditorCell_Word wordCell, int relativePos) {
    return check_v798xa_a0a33(getTextBefore(wordCell, relativePos), this);
  }
  ...
  public void setText(String newText) {
    newText = check_v798xa_a0a0nb(newText);
  ...
  public int getTextLength() {
    return check_v798xa_a0a64(getText(), this);
  }
  ...
  public ParentSettings fillBackground(Graphics g, ParentSettings parentSettings) {
    ...
    for (SimpleEditorMessage message : messages) {
      ...
      if (check_v798xa_a7a3a15(as_v798xa_a0a7a3a15(message, EditorMessage.class))) {
    ...
    if (getCellsCount() > 300) {
      return new Iterator<EditorCell>() {
        ...
        public boolean hasNext() {
          if (check_v798xa_a0a1a0a0a1a86(as_v798xa_a0a0a1a0a0a1a86(last, EditorCell_Word.class))) {
        ...
        public EditorCell next() {
          ...
          check_v798xa_a1a2a0a0a1a86(as_v798xa_a0a1a2a0a0a1a86(next, EditorCell_Word.class));
          last = next;
          return next;
        }
        public void remove() {
  ...
  private static int check_v798xa_a0b0v(String checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.length();
    }
    return 0;
  }
  private static void check_v798xa_a3a82(EditorCell_Multiline checkedDotOperand, Integer pos, Boolean enforceSelection, EditorCell_Multiline checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      checkedDotOperand.setCaretPosition_(pos, enforceSelection);
    }

  }
  private static int check_v798xa_a0a33(String checkedDotOperand, EditorCell_Multiline checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.length();
    }
    return 0;
  }
  private static String check_v798xa_a0a0nb(String checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.replace("\\n", "\n");
    }
    return null;
  }
  private static int check_v798xa_a0a64(String checkedDotOperand, EditorCell_Multiline checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.length();
    }
    return 0;
  }
  private static boolean check_v798xa_a7a3a15(EditorMessage checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.isBackground();
    }
    return false;
  }
  private static boolean check_v798xa_a0a1a0a0a1a86(EditorCell_Word checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.wasModelAccessorRequested();
    }
    return false;
  }
  private static boolean check_v798xa_a1a2a0a0a1a86(EditorCell_Word checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.wasModelAccessorRequested();
    }
    return false;
