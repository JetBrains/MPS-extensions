...
/*package*/ class Port_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_nejer9_0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_nejer9_0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new styleItemListHandler_nejer9_b0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_styleItem");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class styleItemListHandler_nejer9_b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public styleItemListHandler_nejer9_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(styleItemListHandler_nejer9_b0.this.getNode(), LINKS.styleItem$FgZD));
      try {
