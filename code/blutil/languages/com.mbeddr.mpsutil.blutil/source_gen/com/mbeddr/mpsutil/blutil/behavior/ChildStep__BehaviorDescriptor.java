...
public final class ChildStep__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> linearizedList_id5ub8ctrIpHj = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("linearizedList").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6308171743671982931L).languageId(0x90e312ea330e1a00L, 0x63e0e5665131447eL).build2(SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), ""));
