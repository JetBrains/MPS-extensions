...
public final class ReflectionStaticMethodCall__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> convertToLocal_id2RbFUmZlhob = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("convertToLocal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3299924278393509387L).languageId(0x936d188890a746ceL, 0x654422bfe75f44dcL).build2();
