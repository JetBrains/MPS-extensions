...
public final class Parameter_child__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x309e000449764416L, 0xb947ec02ae4ecef2L, 0x50bfac9a432a6e0eL, "com.mbeddr.mpsutil.modellisteners.structure.Parameter_child");
  ...
  /*package*/ static SNode getType_id27DJnJtIQ9C(@NotNull SNode __thisNode__) {
    return _quotation_createNode_sqqj9_a0a0(SLinkOperations.getTarget(SLinkOperations.getTarget(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.AbstractChildListener$C$, false, false), LINKS.role$6qTy), LINKS.target$m40F));
  }

  /*package*/ Parameter_child__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_sqqj9_a0a0(Object parameter_1) {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept AbstractChildListener$C$ = MetaAdapterFactory.getConcept(0x309e000449764416L, 0xb947ec02ae4ecef2L, 0x50bfac9a432a4b57L, "com.mbeddr.mpsutil.modellisteners.structure.AbstractChildListener");
  }
