...
/*package*/ class Box_asDiagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Box_asDiagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      editorCell.value.setCellId("DiagramNode_qt1033_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new contentSingleRoleHandler_qt1033_a0(myNode, LINKS.content$WdN3, getEditorContext());
    return provider.createCell();
  }
  private static class contentSingleRoleHandler_qt1033_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public contentSingleRoleHandler_qt1033_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
