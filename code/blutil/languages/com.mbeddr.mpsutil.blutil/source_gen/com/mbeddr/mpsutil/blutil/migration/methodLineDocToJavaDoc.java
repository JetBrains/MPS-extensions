...
public class methodLineDocToJavaDoc extends MigrationScriptBase {
  ...
  public void doExecute(final SModule m) {
    ...
    for (SModel model : models) {
      ListSequence.fromList(SModelOperations.nodes(model, CONCEPTS.MethodLineDoc$Jr)).where(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
          return !(TestCaseDetection.isInMigrationTestCase(it));
        }
