...
public class LoadNodeInShadowExplorer_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    comp.runRead(new _Adapters._return_P0_E0_to_Runnable_adapter(new _FunctionTypes._return_P0_E0<TreeNode>() {
      public TreeNode invoke() {
        final Set<IOutputNodeReference> ancestors = SetSequence.fromSetWithValues(new HashSet<IOutputNodeReference>(), ListSequence.fromList(SNodeOperations.getNodeAncestors(selectedSNode, null, false)).select(new ISelector<SNode, IOutputNodeReference>() {
          public IOutputNodeReference select(SNode it) {
            return SM_TransformationTrace.getOutputNodeReference(it);
          }
        }).where(new NotNullWhereFilter<IOutputNodeReference>()));
        return found.value = tree.find(new ITreeNodeFinder() {
          @Override
          public boolean matches(TreeNode tnode) {
            Object owner = check_rpql9i_a0a0a0a0a0a1a0a0h0a(as_3urqok_a0a0a0a0a0a0a1a0a0a0a0a7a5(check_rpql9i_a0a0a0a0a0a0a1a0a0h0a(as_3urqok_a0a0a0a0a0a0a0a0b0a0a0a0a0h0f(tnode, TNode.class)), ExplorerElement.class));
          ...
          public IOutputNodeReference getONR(TreeNode tnode) {
            Object owner = check_rpql9i_a0a0d0a0a0a1a0a0h0a(as_3urqok_a0a0a0d0a0a0a1a0a0a0a0a7a5(check_rpql9i_a0a0a0d0a0a0a1a0a0h0a(as_3urqok_a0a0a0a0a3a0a0a0b0a0a0a0a0h0f(tnode, TNode.class)), ExplorerElement.class));
            if (owner instanceof INode) {
  ...
  private static <T> T as_3urqok_a0a0a0a0a0a0a1a0a0a0a0a7a5(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_3urqok_a0a0a0a0a0a0a0a0b0a0a0a0a0h0f(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_3urqok_a0a0a0d0a0a0a1a0a0a0a0a7a5(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_3urqok_a0a0a0a0a3a0a0a0b0a0a0a0a0h0f(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
}
