...
public class TraceBuilders_ErrorLog extends PFModule {
  ...
  public static final TraceBuilders_ErrorLog INSTANCE = new _FunctionTypes._return_P0_E0<TraceBuilders_ErrorLog>() {
    public TraceBuilders_ErrorLog invoke() {
      try {
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.buildTrace", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        ...
        if (ListSequence.fromList(((ErrorLog) _PFparameters.get(0)).entries).isNotEmpty()) {
          long t0 = ListSequence.fromList(((ErrorLog) _PFparameters.get(0)).entries).select(new ISelector<LogEntry, Long>() {
            public Long select(LogEntry it) {
              return it.getTime();
            }
          }).reduceLeft(new ILeftCombinator<Long, Long>() {
