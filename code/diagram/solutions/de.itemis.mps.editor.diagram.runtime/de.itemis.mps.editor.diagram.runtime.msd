...
<solution name="de.itemis.mps.editor.diagram.runtime" uuid="1144260c-e9a5-49a2-9add-39a1a1a7077e" moduleVersion="0" pluginKind="PLUGIN_EDITOR" compileInMPS="true">
  <models>
    ...
    <modelRoot contentPath="${module}" type="java_classes">
      ...
      <sourceRoot location="lib/org.eclipse.elk.alg.common-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.alg.disco-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.alg.force-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.alg.graphviz.dot-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.alg.graphviz.layouter-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.alg.layered-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.alg.mrtree-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.alg.radial-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.alg.spore-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.core-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.core.meta-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.graph-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.graph.json-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.graph.text-0.6.0.jar" />
      <sourceRoot location="lib/org.eclipse.elk.graph.text.ide-0.6.0.jar" />
  ...
  <stubModelEntries>
    ...
    <stubModelEntry path="${module}/lib/org.eclipse.elk.alg.common-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.alg.disco-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.alg.force-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.alg.graphviz.dot-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.alg.graphviz.layouter-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.alg.layered-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.alg.mrtree-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.alg.radial-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.alg.spore-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.core-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.core.meta-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.graph-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.graph.json-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.graph.text-0.6.0.jar" />
    <stubModelEntry path="${module}/lib/org.eclipse.elk.graph.text.ide-0.6.0.jar" />
