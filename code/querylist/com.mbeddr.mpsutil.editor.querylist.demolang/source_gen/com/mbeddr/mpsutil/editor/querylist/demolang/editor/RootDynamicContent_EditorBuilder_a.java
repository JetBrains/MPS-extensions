...
/*package*/ class RootDynamicContent_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_li06js_b0(editorContext, node);
  ...
  private static class QueryListHandler_li06js_b0 extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_li06js_b0(EditorContext context, SNode ownerNode) {
  ...
  private EditorCell createQueryList_2(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_li06js_e0(editorContext, node);
      EditorCell_QueryList editorCell = handler.createCells(new CellLayout_Horizontal());
  ...
  private static class QueryListHandler_li06js_e0 extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_li06js_e0(EditorContext context, SNode ownerNode) {
