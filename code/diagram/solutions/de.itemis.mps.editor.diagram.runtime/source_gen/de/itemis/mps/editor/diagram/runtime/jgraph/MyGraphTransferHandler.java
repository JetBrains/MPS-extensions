...
public class MyGraphTransferHandler extends mxGraphTransferHandler {
  ...
  public boolean canImport(JComponent comp, DataFlavor[] flavors) {
    if (Sequence.fromIterable(Sequence.fromArray(flavors)).contains(GenericTransferable.FLAVOR)) {
      return true;
    }
  ...
  public boolean importData(TransferHandler.TransferSupport support) {
    if (support.getTransferable().isDataFlavorSupported(GenericTransferable.FLAVOR)) {
