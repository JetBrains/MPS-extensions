  ...
  public boolean isSame(ContentHolder otherStuff) {
    if (otherStuff instanceof SubPolicyContainerContentHolder) {
      ...
      for (final SNode spc : SetSequence.fromSet(this.spcs)) {
        ...
        SNode otherSpc = SetSequence.fromSet(other.spcs).findFirst(new IWhereFilter<SNode>() {
          public boolean accept(SNode it) {
            return Objects.equals(SPropertyOperations.getEnum(it, PROPS.subPolicy$jBml), SPropertyOperations.getEnum(spc, PROPS.subPolicy$jBml));
          }
        });
        if ((otherSpc == null)) {
          return false;
