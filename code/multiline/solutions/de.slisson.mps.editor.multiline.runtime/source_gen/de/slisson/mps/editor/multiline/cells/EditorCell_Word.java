...
public class EditorCell_Word extends EditorCell_Property {
  private static final Logger LOG = Logger.wrap(LogManager.getLogger(EditorCell_Word.class));
        ...
        if (isCursorAtMultilineStart()) {
          ...
          if (prevLeaf != null) {
            if (prevLeaf instanceof EditorCell_Label) {
              ...
              labelCell.setCaretPositionIfPossible(check_xru0dp_a0a1a0a1a0a0a0a42(labelCell.getText()));
  ...
  public boolean isCursorAtMultilineEnd() {
    ...
    int caretPos = mlCell.getCaretPosition();
    return caretPos == check_xru0dp_a0d0bb(mlCell.getText());
  }
  ...
  public String getCellId() {
    return check_xru0dp_a0a0a43(getParent(), this) + "_word" + myWordNum;
  }
  @Override
  ...
  public void synchronizeViewWithModel() {
    check_xru0dp_a0a93(getParent(), this);
  }
  @Override
  public boolean processMousePressed(MouseEvent event) {
    ...
    if (!(myShiftSelectionDisabled) && event.isShiftDown()) {
      ...
      LOG.info("mousePressed", new Exception());
    } else {
  ...
  private static int check_xru0dp_a0a1a0a1a0a0a0a42(String checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.length();
    }
    return 0;
  }
  private static int check_xru0dp_a0d0bb(String checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.length();
    }
    return 0;
  }
  private static String check_xru0dp_a0a0a43(EditorCell_Multiline checkedDotOperand, EditorCell_Word checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getCellId();
    }
    return null;
  }
  private static void check_xru0dp_a0a93(EditorCell_Multiline checkedDotOperand, EditorCell_Word checkedDotThisExpression) {
    if (null != checkedDotOperand) {
