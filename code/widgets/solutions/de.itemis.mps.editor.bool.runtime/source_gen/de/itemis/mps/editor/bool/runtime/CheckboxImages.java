...
public class CheckboxImages {
  ...
  public void setImageTrue(String path, SNode node) {
    myImageTrue = ImageLoading.loadImage(path, node);
    updateSize();
  }

  public void setImageFalse(String path, SNode node) {
    myImageFalse = ImageLoading.loadImage(path, node);
    updateSize();
  }
  ...
  public void paint(Graphics g, int x, int y, EditorComponent editorComponent) {
    ...
    if (image != null) {
      ...
      g = g.create();
      Graphics2D g2d = as_tospi5_a0a4a7a22(g, Graphics2D.class);
      if (g2d != null) {
  ...
  private static <T> T as_tospi5_a0a4a7a22(Object o, Class<T> type) {
