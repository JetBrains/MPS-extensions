...
public class DragSelectionMouseListener extends MouseAdapter {
  ...
  protected Iterable<IDragSelectionHandler> getSelectionHandlers() {
    return Sequence.fromIterable(new ExtensionPoint<IDragSelectionHandler>("de.itemis.mps.selection.runtime.DragSelectionHandlerEP").getObjects()).concat(ListSequence.fromList(myDefaultHandlers)).sort(new ISelector<IDragSelectionHandler, Integer>() {
      public Integer select(IDragSelectionHandler it) {
