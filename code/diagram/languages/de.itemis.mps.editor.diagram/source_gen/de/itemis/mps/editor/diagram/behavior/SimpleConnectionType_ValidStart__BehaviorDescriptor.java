...
public final class SimpleConnectionType_ValidStart__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfa13cc63c4764d46L, 0x9c96d53670abe7bcL, 0x41795f5a9eb1e0d7L, "de.itemis.mps.editor.diagram.structure.SimpleConnectionType_ValidStart");
  ...
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_8qyibv_a0a0();
  }
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    return ListSequence.fromListAndArray(new ArrayList<SConcept>(), CONCEPTS.Parameter_EndpointFrom$Vc);
  }

  /*package*/ SimpleConnectionType_ValidStart__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_8qyibv_a0a0() {
