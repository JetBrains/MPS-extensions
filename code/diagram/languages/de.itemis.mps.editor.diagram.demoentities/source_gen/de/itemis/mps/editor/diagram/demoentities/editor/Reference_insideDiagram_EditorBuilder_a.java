...
/*package*/ class Reference_insideDiagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Reference_insideDiagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramConnector_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      SNodeEdgeAccessor accessor = new SNodeEdgeAccessor(node) {
        ...
        private IConnectionEndpointReference endpointFrom = EndpointUtil.createEndpointReferenceForNodeSafe(new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            return SNodeOperations.getParent(((SNode) _variablesContext.getValue("thisNode")));
          }
        }.invoke());
        private IConnectionEndpointReference endpointTo = EndpointUtil.createEndpointReferenceForNodeSafe(new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            return SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.target$pIvZ);
          }
        }.invoke());

        {
          ...
          if (reverse) {
            ...
            {
              Tuples._2<IConnectionEndpointReference, IConnectionEndpointReference> _tmp_tkv1ai_b0b0i0a0a1a2a3a8 = MultiTuple.<IConnectionEndpointReference,IConnectionEndpointReference>from(endpointTo, endpointFrom);
              endpointFrom = _tmp_tkv1ai_b0b0i0a0a1a2a3a8._0();
              endpointTo = _tmp_tkv1ai_b0b0i0a0a1a2a3a8._1();
            }
            {
              Tuples._2<EditorCell, EditorCell> _tmp_tkv1ai_c0b0i0a0a1a2a3a8 = MultiTuple.<EditorCell,EditorCell>from(endRoleCell, startRoleCell);
              startRoleCell = _tmp_tkv1ai_c0b0i0a0a1a2a3a8._0();
              endRoleCell = _tmp_tkv1ai_c0b0i0a0a1a2a3a8._1();
            }
            {
              Tuples._2<IShape, IShape> _tmp_tkv1ai_d0b0i0a0a1a2a3a8 = MultiTuple.<IShape,IShape>from(endShape, startShape);
              startShape = _tmp_tkv1ai_d0b0i0a0a1a2a3a8._0();
              endShape = _tmp_tkv1ai_d0b0i0a0a1a2a3a8._1();
            }
          }
        }
        ...
        public void writeFrom(final SNode targetNode, Box targetDNode, final String port) {
          ...
          ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(targetNode, CONCEPTS.Entity$jv), LINKS.references$YW8_)).addElement(node);
        }
        @Override
        ...
        public void writeTo(final SNode targetNode, Box targetDNode, final String port) {
          ...
          SLinkOperations.setTarget(node, LINKS.target$pIvZ, SNodeOperations.cast(targetNode, CONCEPTS.Entity$jv));
        }
        @Override
      ...
      editorCell.setCellId("DiagramConnector_22z21g_a");
