...
public class PaginationSearchResultManager {
  ...
  public SNode getCurrentlySelectedNode(PagesUserObject userObj) {
    return ListSequence.fromList(userObj.getAllChildren()).findFirst(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return isCurrentlySelected(it);
      }
    });
  }
  ...
  public void clearResults(PagesUserObject userObj, EditorContext context) {
    ...
    ListSequence.fromList(userObj.getAllChildren()).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        includeNodeInResults(it, false);
      }
    });
