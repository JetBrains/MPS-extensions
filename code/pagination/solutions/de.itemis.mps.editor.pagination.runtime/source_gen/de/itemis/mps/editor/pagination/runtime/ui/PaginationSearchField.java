    ...
    myContext.getRepository().getModelAccess().runReadAction(() -> {
      ...
      ListSequence.fromList(allNodes).visitAll(new IVisitor<SNode>() {
        public void visit(SNode it) {
          PaginationSearchResultManager.getInstance().includeNodeInResults(it, false);
        }
      });
      ...
      ListSequence.fromList(foundNodes).visitAll(new IVisitor<SNode>() {
        public void visit(SNode it) {
          PaginationSearchResultManager.getInstance().includeNodeInResults(it, true);
        }
      });
