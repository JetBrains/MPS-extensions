...
public class CellLayoutUtil {
  ...
  public static void setFontFamily(EditorCell_Label cell, String fontFamily) {
    ...
    try {
      ...
      ReflectionUtil_copy.callVoidMethod(TextLine.class, ((TextLine) ReflectionUtil_copy.callMethod(EditorCell_Label.class, cell, "getTextLine", new Class[]{}, new Object[]{})), "updateStyle", new Class[]{Set.class}, new Object[]{null});
    } finally {
  ...
  public static void setLayout(EditorCell_Collection cell, ILayouter layout) {
    ReflectionUtil_copy.writeField(jetbrains.mps.nodeEditor.cells.EditorCell_Collection.class, ((jetbrains.mps.nodeEditor.cells.EditorCell_Collection) cell), "myCellLayout", new TopDownCellLayoutAdapter(layout));
  }
