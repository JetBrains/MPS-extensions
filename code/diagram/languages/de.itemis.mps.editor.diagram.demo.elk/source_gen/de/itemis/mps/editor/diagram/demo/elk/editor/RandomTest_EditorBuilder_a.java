...
import de.itemis.mps.editor.diagram.runtime.jgraph.RandomLayouter;
...
/*package*/ class RandomTest_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RandomTest_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_umc3uj_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_umc3uj_b0");
      ...
      DiagramCreationContext.createDiagram(() -> {
        DiagramContext.withContext(node, () -> editorCell.value, () -> {
          ContextVariables.withValue("thisNode", node, () -> {
            ...
            DiagramModel model = DiagramModel.getModel(editorContext, node, "8180566525132982057");
            final ElkLayouter layouter = new RandomLayouter();
            ...
            IDiagramAccessor accessor = new AbstractDiagramAccessor(node) {
              ...
              private boolean nodeCondition_umc3uj_a2a() {
                return true;
              }
              ...
              public boolean runAutoLayoutOnInit() {
                ...
                autoLayoutFlag = nodeCondition_umc3uj_a2a();
            ...
            editorCell.value.setCellId("Diagram_umc3uj_c0");
            Style style = new StyleImpl();
            style.set(StyleAttributes.getInstance().<Double>getAttribute("de.itemis.mps.editor.diagram", "diagram-layout-aspect-ratio"), _StyleParameter_QueryFunction_umc3uj_a0c0());
            style.set(StyleAttributes.getInstance().<Double>getAttribute("de.itemis.mps.editor.diagram", "diagram-layout-node-spacing"), _StyleParameter_QueryFunction_umc3uj_a1c0());
            style.set(StyleAttributes.getInstance().<ElkPadding>getAttribute("de.itemis.mps.editor.diagram", "diagram-layout-padding"), _StyleParameter_QueryFunction_umc3uj_a2c0());
            style.set(StyleAttributes.getInstance().<Integer>getAttribute("de.itemis.mps.editor.diagram", "diagram-layout-randomization-seed"), _StyleParameter_QueryFunction_umc3uj_a3c0());
  ...
  private Double _StyleParameter_QueryFunction_umc3uj_a0c0() {
    return Double.valueOf(SPropertyOperations.getString(SLinkOperations.getTarget(getNode(), LINKS.config$G6cD), PROPS.aspectRatio$NEGi));
  }
  private double _StyleParameter_QueryFunction_umc3uj_a1c0() {
    return Double.valueOf(SPropertyOperations.getString(SLinkOperations.getTarget(getNode(), LINKS.config$G6cD), PROPS.nodeSpacing$pBdN));
  }
  private ElkPadding _StyleParameter_QueryFunction_umc3uj_a2c0() {
    return (ElkPadding) Padding__BehaviorDescriptor.toElkPadding_id56jSwh$Gd44.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(getNode(), LINKS.config$G6cD), LINKS.padding$74fk));
  }
  private Integer _StyleParameter_QueryFunction_umc3uj_a3c0() {
    return SPropertyOperations.getInteger(SLinkOperations.getTarget(getNode(), LINKS.config$G6cD), PROPS.randomizationSeed$Ru8q);
  }
