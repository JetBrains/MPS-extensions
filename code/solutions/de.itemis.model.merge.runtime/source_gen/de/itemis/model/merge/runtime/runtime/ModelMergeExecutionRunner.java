...
public class ModelMergeExecutionRunner {
  ...
  public static void run(SModel resultModel, SNode modelMerge, SNode left, SNode right) {
    ...
    ModelMergeExecutionRunner.run(smodelL, smodelR, modelMerge, resultModel);
  }
  ...
  public static void runLeftMerge(SNode left, SNode right, SNode modelMerge) {
    ModelMergeExecutionRunner.runLeftMerge(resolveModel(modelMerge, left), resolveModel(modelMerge, right), modelMerge);
  }

  public static void runLeftMerge(SModel leftModel, SModel rightModel, SNode modelMerge) {
    SModel mergedModel = ModelMergeExecutionRunner.run(modelMerge, leftModel, rightModel);
  ...
  public static void run(SModel smodelL, SModel smodelR, SNode modelMerge, SModel resultModel) {
    ...
    List<MergedNode> mergedNodes = Sequence.fromIterable((Sequence.fromIterable(ModelMergerRunner.create(modelMerge).merge(leftRootNodes, rightRootNodes)).distinct())).toListSequence();
