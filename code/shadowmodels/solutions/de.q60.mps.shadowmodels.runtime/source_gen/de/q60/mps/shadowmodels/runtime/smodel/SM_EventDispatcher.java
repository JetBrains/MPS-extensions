...
public class SM_EventDispatcher {
  ...
  private IInvalidationListener invalidationListener = new IInvalidationListener() {
    ...
    public void invalidatedAll() {
      ...
      ListSequence.fromList(openapiSmodelListeners).visitAll(new IVisitor<org.jetbrains.mps.openapi.model.SModelListener>() {
        public void visit(org.jetbrains.mps.openapi.model.SModelListener it) {
          it.modelReplaced(model);
        }
      });
    }
  };
