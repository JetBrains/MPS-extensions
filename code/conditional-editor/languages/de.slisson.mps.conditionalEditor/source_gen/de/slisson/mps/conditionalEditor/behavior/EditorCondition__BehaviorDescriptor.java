...
public final class EditorCondition__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xb8bb702e43ed4090L, 0xa902d180d3e5f292L, 0x27efdd821098ff1bL, "de.slisson.mps.conditionalEditor.structure.EditorCondition");
  ...
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_1g5vwh_a0a0();
  }
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    final List<SConcept> parameters = ListSequence.fromList(new ArrayList<SConcept>());
    ListSequence.fromList(parameters).addElement(CONCEPTS.ConceptFunctionParameter_node$zM);
    ListSequence.fromList(parameters).addElement(CONCEPTS.ConceptFunctionParameter_editorContext$vJ);
    return parameters;
  }

  /*package*/ EditorCondition__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_1g5vwh_a0a0() {
