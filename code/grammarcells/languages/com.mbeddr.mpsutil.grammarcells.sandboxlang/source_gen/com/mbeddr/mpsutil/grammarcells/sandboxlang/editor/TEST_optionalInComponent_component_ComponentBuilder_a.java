...
/*package*/ class TEST_optionalInComponent_component_ComponentBuilder_a extends AbstractEditorBuilder {
          ...
          return new Object() {
            public Iterable<String> query(SNode node) {
              return new StringOrSequenceQuery() {
                public Object queryStringOrSequence() {
                  LogContext.with(TEST_optionalInComponent_component_ComponentBuilder_a.class, null, null).debug("Node:" + SNodeOperations.present(node));
                  LogContext.with(TEST_optionalInComponent_component_ComponentBuilder_a.class, null, null).debug("EditorContext:" + editorContext);
                  return "abc";
                }
              }.query();
            }
      ...
      if (isApplicable && Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(items).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            LogContext.with(TEST_optionalInComponent_component_ComponentBuilder_a.class, null, null).debug("Node:" + SNodeOperations.present(node));
            LogContext.with(TEST_optionalInComponent_component_ComponentBuilder_a.class, null, null).debug("Original text" + originalText);
            LogContext.with(TEST_optionalInComponent_component_ComponentBuilder_a.class, null, null).debug("EditorContext:" + editorContext);
  ...
  private EditorCell createCustomFactory_0(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = new _FunctionTypes._return_P0_E0<EditorCell>() {
      public EditorCell invoke() {
        EditorCell_Collection collection = as_yhp6gr_a0a0a0a0a0a4a31(cell, EditorCell_Collection.class);
        if (collection != null) {
            ...
            public Object queryStringOrSequence() {
              return new Object() {
                public Iterable<String> query(SNode node) {
                  return new StringOrSequenceQuery() {
                    public Object queryStringOrSequence() {
                      LogContext.with(TEST_optionalInComponent_component_ComponentBuilder_a.class, null, null).debug("Node:" + SNodeOperations.present(myNode));
                      LogContext.with(TEST_optionalInComponent_component_ComponentBuilder_a.class, null, null).debug("EditorContext:" + editorContext);
                      return "abc";
                    }
                  }.query();
  ...
  private static <T> T as_yhp6gr_a0a0a0a0a0a4a31(Object o, Class<T> type) {
