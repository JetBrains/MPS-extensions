        ...
        DiagramContext.withContext(node, () -> editorCell.value, () -> {
          ContextVariables.withValue("thisNode", node, () -> {
            ...
            IDiagramAccessor accessor = new AbstractDiagramAccessor(node) {
              ...
              private boolean nodeCondition_s7zaad_a3a0() {
                return false;
              }

              @Override
              public boolean saveDiagramLayout() {
                return nodeCondition_s7zaad_a3a0();
              }
            ...
            Style style = new StyleImpl();
            style.set(StyleAttributes.getInstance().<OrderWeighting>getAttribute("de.itemis.mps.editor.diagram", "diagram-layout-tree-weighting"), _StyleParameter_QueryFunction_s7zaad_a0d0a());
