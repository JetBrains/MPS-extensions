...
/*package*/ class Expression_conditonalEditorDemo_conditionalEditor_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Expression_conditonalEditorDemo_conditionalEditor_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createNextEditor_0() {
    {
      EditorCell editorCell = getCellFactory().createEditorCell(myNode, true, Expression_conditonalEditorDemo_conditionalEditor_Editor_shadedStrings.class);
      return editorCell;
    }
  }
