...
public class RootDCell extends BaseDiagramDCell {
  ...
  public void updateButtonVisibility(Style style, StyleAttribute<Boolean> attribute) {
    MapSequence.fromMap(buttonVisibility).put(attribute.hashCode(), style.get(attribute));
  }

  public void resetButtonVisibility(StyleAttribute<Boolean> attribute) {
    MapSequence.fromMap(buttonVisibility).put(attribute.hashCode(), DEFAULT_BOOL_VALUE);
  }

  public boolean getButtonVisibility(StyleAttribute<Boolean> attribute) {
    int key = attribute.hashCode();
    if (MapSequence.fromMap(buttonVisibility).containsKey(key)) {
      return MapSequence.fromMap(buttonVisibility).get(key);
    }
    return true;
  }

  public List<StyleAttribute> getButtonStyleAttributes() {
    return Sequence.fromIterable(Sequence.fromArray(new StyleAttribute[]{StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__move-to-diagram-viewer-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__move-to-diagram-viewer-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__maximize-diagram-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__reset-view-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__zoom-in-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__zoom-out-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__fit-size-all-diagram-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__show_ports_labels-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__translate-to-origin-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__export-png-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__export-svg-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__clear-layout-information-button")})).toListSequence();
  }

  @Override
  public void updateButtonConfig(final Style style) {
    super.updateButtonConfig(style);
    ListSequence.fromList(getButtonStyleAttributes()).visitAll(new IVisitor<StyleAttribute>() {
      public void visit(StyleAttribute it) {
        updateButtonVisibility(style, it);
      }
    });
    rootButtonsCreator = style.get(StyleAttributes.getInstance().getAttribute("de.itemis.mps.editor.diagram.styles", "__root-button-creator"));
    vertexButtonsCreator = style.get(StyleAttributes.getInstance().getAttribute("de.itemis.mps.editor.diagram.styles", "__vertex-button-creator"));
    edgeButtonsCreator = style.get(StyleAttributes.getInstance().getAttribute("de.itemis.mps.editor.diagram.styles", "__edge-button-creator"));
  }
  ...
  protected List<ContextButton> createButtons(final mxCellState mxCellState) {
    ...
    if (getButtonVisibility(StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__zoom-out-button")) && _getGraph().getView().getScale() > MyGraphComponent.MINIMUM_SCALE) {
    ...
    if (getButtonVisibility(StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__root-show-all-edges-button")) && Sequence.fromIterable(this.getDiagramModel().getBoxes()).any(new IWhereFilter<Box>() {
      public boolean accept(Box it) {
        return it.getModel().hasInvisibleEdges(it);
      }
    })) {
