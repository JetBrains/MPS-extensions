...
<model ref="00000000-0000-4000-5f02-5beb5f025beb/i:fff8cd7(checkpoints/de.q60.mps.polymorphicfunctions.dataFlow@descriptorclasses)">
        ...
        <node concept="1_3QMa" id="d" role="3cqZAp">
          ...
          <node concept="1pnPoh" id="g" role="1_3QMm">
                ...
                <node concept="2YIFZM" id="o" role="3cqZAk">
                  ...
                  <node concept="2ShNRf" id="p" role="37wK5m">
                    <node concept="HV5vD" id="r" role="2ShVmc">
                      <ref role="HV5vE" node="B" resolve="PolymorphicFunctionCall_DataFlow" />
                    </node>
                  </node>
            ...
            <node concept="3gn64h" id="m" role="1pnPq6">
              <ref role="3gnhBz" to="bx8c:3jJoUQ6VUCe" resolve="PolymorphicFunctionCall" />
            </node>
          </node>
  ...
  <node concept="39dXUE" id="u">
    <node concept="39e2AJ" id="v" role="39e2AI">
      ...
      <node concept="39e2AG" id="x" role="39e3Y0">
        <ref role="39e2AK" to="5oow:1sd2boLr6zZ" resolve="PolymorphicFunctionCall_DataFlow" />
        <node concept="385nmt" id="y" role="385vvn">
          <property role="385vuF" value="PolymorphicFunctionCall_DataFlow" />
          <node concept="3u3nmq" id="$" role="385v07">
            <property role="3u3nmv" value="1660993416175839487" />
          </node>
        </node>
        <node concept="39e2AT" id="z" role="39e2AY">
          <ref role="39e2AS" node="B" resolve="PolymorphicFunctionCall_DataFlow" />
        </node>
      </node>
    </node>
  ...
  <node concept="312cEu" id="B">
    ...
    <uo k="s:originTrace" v="n:1660993416175839487" />
    ...
    <node concept="3clFb_" id="E" role="jymVt">
      ...
      <node concept="3clFbS" id="I" role="3clF47">
        <uo k="s:originTrace" v="n:1660993416175839489" />
        <node concept="2Gpval" id="K" role="3cqZAp">
          <uo k="s:originTrace" v="n:1660993416175839508" />
          <node concept="2GrKxI" id="L" role="2Gsz3X">
            <property role="TrG5h" value="param" />
            <uo k="s:originTrace" v="n:1660993416175839509" />
          </node>
          <node concept="2OqwBi" id="M" role="2GsD0m">
            <uo k="s:originTrace" v="n:1660993416175840182" />
            <node concept="1DoJHT" id="O" role="2Oq$k0">
              <property role="1Dpdpm" value="getNode" />
              <uo k="s:originTrace" v="n:1660993416175839555" />
            ...
            <node concept="3Tsc0h" id="P" role="2OqNvi">
              ...
              <uo k="s:originTrace" v="n:1660993416175840959" />
            </node>
          </node>
          <node concept="3clFbS" id="N" role="2LFqv$">
            <uo k="s:originTrace" v="n:1660993416175839511" />
            <node concept="3clFbF" id="S" role="3cqZAp">
              <uo k="s:originTrace" v="n:1660993416175841126" />
              <node concept="2OqwBi" id="T" role="3clFbG">
                ...
                <node concept="liA8E" id="V" role="2OqNvi">
                  ...
                  <node concept="10QFUN" id="Y" role="37wK5m">
                    <node concept="2GrUjf" id="Z" role="10QFUP">
                      <ref role="2Gs0qQ" node="L" resolve="param" />
                      <uo k="s:originTrace" v="n:1660993416175841151" />
                    </node>
