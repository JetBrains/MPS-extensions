...
/*package*/ class SquareBrackets_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expressionSingleRoleHandler_dtorwi_a0a(myNode, LINKS.expression$TlhM, getEditorContext());
    return provider.createCell();
  }
  private static class expressionSingleRoleHandler_dtorwi_a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public expressionSingleRoleHandler_dtorwi_a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
