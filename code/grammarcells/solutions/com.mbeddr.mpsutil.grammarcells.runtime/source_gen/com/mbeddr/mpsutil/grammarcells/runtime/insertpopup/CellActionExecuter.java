...
public class CellActionExecuter {
  ...
  public String toString() {
    if (myAction instanceof CellAction_InsertIntoCollection) {
      String text = textForRole(((AbstractCellListHandler) ReflectionUtil_copy.readField(CellAction_InsertIntoCollection.class, ((CellAction_InsertIntoCollection) myAction), "myListHandler")).getElementSRole());
