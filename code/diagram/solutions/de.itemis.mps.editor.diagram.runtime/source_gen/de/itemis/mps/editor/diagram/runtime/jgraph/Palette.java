...
import de.itemis.mps.editor.diagram.runtime.model.IDragPaletteEntry;
...
public class Palette extends JPanel {
    ...
    myUpdateActiveDiagramTimer = new Timer(1000, new ActionListener() {
      public void actionPerformed(ActionEvent p0) {
        try {
          ...
          LOG.warn("Failed to update the palette", ex);
        }
      }
    });
  ...
  public MyGraph getGraph() {
    return check_75pxkd_a0a13(check_75pxkd_a0a0fb(myActiveDiagramCell));
  }
  ...
  public BaseDiagramECell findActiveDiagramCell(JComponent anyComponentInWindow) {
    ...
    List<JComponent> selectedTabs = ListSequence.fromList(tabs).select(new ISelector<JBTabs, JComponent>() {
      public JComponent select(JBTabs it) {
        return check_75pxkd_a0a0a0a0a5a33(it.getSelectedInfo());
      }
    ...
    final BaseDiagramECell lastClickedDiagram = check_75pxkd_a0r0hb(myLastClickedDiagram);
    if (lastClickedDiagram != null) {
      ...
      BaseDiagramECell updatedCell = ListSequence.fromList(allDiagramCells).findFirst(new IWhereFilter<BaseDiagramECell>() {
        public boolean accept(BaseDiagramECell it) {
          return Objects.equals(it.getCellInfo(), lastClickedDiagram.getCellInfo());
        }
      });
      if (updatedCell != null) {
        return updatedCell;
  ...
  public void changeActiveDiagramCell(BaseDiagramECell diagramCell) {
    BaseDiagramECell activeDiagramCell = check_75pxkd_a0a0lb(myActiveDiagramCell);
    if (diagramCell != activeDiagramCell) {
      ...
      DiagramModel model = check_75pxkd_a0d0b0lb(diagramCell);
      myModel = new WeakReference<DiagramModel>(model);
      myEntryProvider = new WeakReference<IPaletteEntryProvider>(check_75pxkd_a0a0f0b0lb(model));
      reloadItems();
    }
  }
  ...
  public BaseDiagramECell getActiveDiagram() {
    return check_75pxkd_a0a34(myActiveDiagramCell);
  }
  ...
  protected List<JComponent> createItems(@Nullable String pattern) {
    ...
    IPaletteEntryProvider entryProvider = check_75pxkd_a0c0vb(myEntryProvider);
    if (entryProvider != null && model != null) {
      ...
      Iterable<IPaletteEntry> additionalEntries = Sequence.fromIterable(additionalEntriesProviders).where(new IWhereFilter<IPaletteEntryExtensionProvider>() {
        public boolean accept(IPaletteEntryExtensionProvider it) {
          return it.appliesFor(SNodeOperations.getConcept(model.getSNode()));
        }
      }).translate(new ITranslator2<IPaletteEntryExtensionProvider, IPaletteEntry>() {
        public Iterable<IPaletteEntry> translate(IPaletteEntryExtensionProvider it) {
      ...
      for (IPaletteEntry action : Sequence.fromIterable(entryProvider.getEntries()).union(Sequence.fromIterable(additionalEntries))) {
        ...
        if ((myFilterString == null || myFilterString.length() == 0) || entryText.toLowerCase().contains(myFilterString.toLowerCase()) || check_75pxkd_a0c0c0d0vb(folderName, myFilterString)) {
    ...
    return ListSequence.fromList(folders).select(new ISelector<Folder, JComponent>() {
      public JComponent select(Folder it) {
  ...
  protected String getFolderName(IPaletteEntry action) {
    ...
    paletteFolder = check_75pxkd_a0d0zb(check_75pxkd_a0a3a15(myModel), action);
    if (paletteFolder != null) {
      return paletteFolder;
    }
  ...
  protected JComponent createItem(String pattern, IPaletteEntry action) {
    ...
    final Transferable transferable = createTransferable(action, check_75pxkd_b0a7a55(myActiveDiagramCell));
  ...
  protected Transferable createTransferable(final IPaletteEntry entry, final BaseDiagramECell diagramCell) {
    ...
    if (entry instanceof IDragPaletteEntry) {
      return new GenericTransferable(null) {
        private Object data;
        @Override
        public Object getTransferData(DataFlavor flavor) {
          if (data == null) {
            diagramCell.getContext().getRepository().getModelAccess().runReadAction(() -> data = ((IDragPaletteEntry) entry).getDragObject());
          }
          return data;
        }
      };
      ...
      cell.setVertex(true);
      return new mxGraphTransferable(new Object[]{cell}, (mxRectangle) cell.getGeometry().clone(), imageIcon);
    }
  }
  ...
  public static class Folder {
    ...
    public void setCollapsed(boolean collapsed) {
      ...
      check_75pxkd_a1a71tc(myTitleComponent, collapsed);
      if (collapsed) {
    ...
    private static void check_75pxkd_a1a71tc(JLabel checkedDotOperand, Boolean collapsed) {
  ...
  public static boolean isActive(BaseDiagramECell diagram) {
    return check_75pxkd_a0a0hd(getInstance(diagram.getContext().getOperationContext().getProject())) == diagram;
  }
  ...
  private static MyGraph check_75pxkd_a0a13(BaseDiagramECell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getContextGraph();
    }
    return null;
  }
  private static BaseDiagramECell check_75pxkd_a0a0fb(WeakReference<BaseDiagramECell> checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.get();
    }
    return null;
  }
  private static JComponent check_75pxkd_a0a0a0a0a5a33(TabInfo checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getComponent();
    }
    return null;
  }
  private static BaseDiagramECell check_75pxkd_a0r0hb(WeakReference<BaseDiagramECell> checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.get();
    }
    return null;
  }
  private static BaseDiagramECell check_75pxkd_a0a0lb(WeakReference<BaseDiagramECell> checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.get();
    }
    return null;
  }
  private static DiagramModel check_75pxkd_a0d0b0lb(BaseDiagramECell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getModel();
    }
    return null;
  }
  private static IPaletteEntryProvider check_75pxkd_a0a0f0b0lb(DiagramModel checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getPaletteEntryProvider();
    }
    return null;
  }
  private static BaseDiagramECell check_75pxkd_a0a34(WeakReference<BaseDiagramECell> checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.get();
    }
    return null;
  }
  private static IPaletteEntryProvider check_75pxkd_a0c0vb(WeakReference<IPaletteEntryProvider> checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.get();
    }
    return null;
  }
  private static boolean check_75pxkd_a0c0c0d0vb(String checkedDotOperand, String myFilterString) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.contains(myFilterString);
    }
    return false;
  }
  private static String check_75pxkd_a0d0zb(DiagramModel checkedDotOperand, IPaletteEntry action) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getPaletteFolder(action);
    }
    return null;
  }
  private static DiagramModel check_75pxkd_a0a3a15(WeakReference<DiagramModel> checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.get();
    }
    return null;
  }
  private static BaseDiagramECell check_75pxkd_b0a7a55(WeakReference<BaseDiagramECell> checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.get();
    }
    return null;
  }
  private static BaseDiagramECell check_75pxkd_a0a0hd(Palette checkedDotOperand) {
    if (null != checkedDotOperand) {
