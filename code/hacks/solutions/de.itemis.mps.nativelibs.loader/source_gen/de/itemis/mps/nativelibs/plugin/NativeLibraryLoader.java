...
public class NativeLibraryLoader implements BaseComponent {
  ...
  public NativeLibraryLoader(MPSCoreComponents mpsCore) {
    myMpsCore = mpsCore;
  }
  ...
  public File getModuleFolder(SModule module) {
    return new File(MacrosFactory.forModule((AbstractModule) module).expandPath("${module}"));
  }

  protected String resolveLibraryPath(SModule module, String relativeLibraryPath) {
    File moduleFolder = new File(MacrosFactory.forModule((AbstractModule) module).expandPath("${module}"));
