...
public class typeof_IIfMacro_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode n, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    // Workaround for the typesystem not returning the most specific common supertype for two SNodeTypes
    {
      ...
      typeCheckingContext.whenConcrete(thenType, new Runnable() {
        public void run() {
          {
            ...
            typeCheckingContext.whenConcrete(elseType, new Runnable() {
              public void run() {
                ...
                if (SetSequence.fromSet(thenConcepts).isNotEmpty() && SetSequence.fromSet(elseConcepts).isNotEmpty()) {
                  ...
                  for (final SNode commonConcept : SetSequence.fromSet(thenConcepts).intersect(SetSequence.fromSet(elseConcepts))) {
                    ...
                    if (!(SetSequence.fromSet(mostSpecificConcepts).any(new IWhereFilter<SNode>() {
                      public boolean accept(SNode it) {
                        return (boolean) AbstractConceptDeclaration__BehaviorDescriptor.isSubconceptOf_id73yVtVlWOga.invoke(it, commonConcept);
                      }
                    }))) {
                  ...
                  if (SetSequence.fromSet(mostSpecificConcepts).isEmpty()) {
                    {
                      ...
                      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:fd3ba2d5-05a9-4b3b-93ad-a566c0e12538(de.q60.mps.shadowmodels.transformation.typesystem)", "6159853882137340615", true), (SNode) createSNodeType_21flxx_a1a0c0a0c0h0a0a1a0b0a0a0a1a0b0c0b(), _info_12389875345);
                    }
                  } else if (SetSequence.fromSet(mostSpecificConcepts).count() == 1) {
                    {
                      ...
                      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:fd3ba2d5-05a9-4b3b-93ad-a566c0e12538(de.q60.mps.shadowmodels.transformation.typesystem)", "6159853882137366654", true), (SNode) createSNodeType_21flxx_a1a0c0a0a2a7a0a0b0a1a0a0a0b0a1a2a1(SetSequence.fromSet(mostSpecificConcepts).first()), _info_12389875345);
                    }
                  } else {
                    ...
                    ListSequence.fromList(SLinkOperations.getChildren(type, LINKS.argument$r2cT)).addSequence(SetSequence.fromSet(mostSpecificConcepts).select(new ISelector<SNode, SNode>() {
                      public SNode select(SNode it) {
                        return createSNodeType_21flxx_a0a0a0a0b0a2a7a0a0b0a1a0a0a0b0a1a2a1(it);
                      }
                    }));
                    {
                      SNode _nodeToCheck_1029348928467 = n;
  ...
  private static SNode createSNodeType_21flxx_a1a0c0a0c0h0a0a1a0b0a0a0a1a0b0c0b() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.SNodeType$hR);
    return n0.getResult();
  }
  private static SNode createSNodeType_21flxx_a1a0c0a0a2a7a0a0b0a1a0a0a0b0a1a2a1(SNode p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.SNodeType$hR);
    n0.setReferenceTarget(LINKS.concept$OMgE, p0);
    return n0.getResult();
  }
  private static SNode createSNodeType_21flxx_a0a0a0a0b0a2a7a0a0b0a1a0a0a0b0a1a2a1(SNode p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.SNodeType$hR);
    n0.setReferenceTarget(LINKS.concept$OMgE, p0);
    return n0.getResult();
  }
