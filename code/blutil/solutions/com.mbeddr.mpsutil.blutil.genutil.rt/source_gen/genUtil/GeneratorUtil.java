...
public class GeneratorUtil {
  ...
  public static boolean isInTest(SModel mdl) {
    return ListSequence.fromList(SModelOperations.nodes(mdl, null)).any(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.getConcept(it).getLanguage().getQualifiedName().startsWith("jetbrains.mps.lang.test");
      }
    });
  }
}
