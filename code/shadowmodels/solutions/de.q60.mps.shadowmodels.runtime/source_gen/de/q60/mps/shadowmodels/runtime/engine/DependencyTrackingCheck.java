...
public class DependencyTrackingCheck {
  ...
  static {
    ...
    DependencyTrackingCheck.registerChecker(MappingLabelCall.class, (MappingLabelCall o) -> {
      ListSequence.fromList(o.getInput()).visitAll(new IVisitor<Object>() {
        public void visit(Object it) {
          DependencyTrackingCheck.check(it);
        }
      });
    });
    DependencyTrackingCheck.registerChecker(IContainmentTarget.class, (IContainmentTarget o) -> {
      Sequence.fromIterable(o.getInputNodes()).visitAll(new IVisitor<INode>() {
        public void visit(INode it) {
          DependencyTrackingCheck.check(it);
        }
      });
    });
    DependencyTrackingCheck.registerChecker(IUniqueContainmentTarget.class, (IUniqueContainmentTarget o) -> DependencyTrackingCheck.check(o.getTarget()));
    DependencyTrackingCheck.registerChecker(ContainmentTargetRootNodes.class, (ContainmentTargetRootNodes o) -> {
    ...
    DependencyTrackingCheck.registerChecker(ISubgraphRef.class, (ISubgraphRef o) -> {
      Sequence.fromIterable(o.getInputNodes()).visitAll(new IVisitor<INode>() {
        public void visit(INode it) {
          DependencyTrackingCheck.check(it);
        }
    ...
    DependencyTrackingCheck.registerChecker(ParameterList.class, (ParameterList o) -> {
      Sequence.fromIterable(o.asSequence()).visitAll(new IVisitor<Object>() {
        public void visit(Object it) {
          DependencyTrackingCheck.check(it);
        }
      });
