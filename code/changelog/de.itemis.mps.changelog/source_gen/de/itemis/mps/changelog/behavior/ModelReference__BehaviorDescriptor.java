...
public final class ModelReference__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x638c9345261349dcL, 0xb2ae8ceadef24141L, 0xd5813f148c5f1cfL, "de.itemis.mps.changelog.structure.ModelReference");
  ...
  /*package*/ static String getTextualRepresentation_idfB3l81it7u(@NotNull SNode __thisNode__) {
    SModelReference modelReference = ModelIdentity__BehaviorDescriptor.toModelReference_id1Bs_61$mvvu.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.expression$uTUV), LINKS.modelRef$l8tE));
    return "*" + modelReference.getName().toString() + "*";
  }
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink expression$uTUV = MetaAdapterFactory.getContainmentLink(0x638c9345261349dcL, 0xb2ae8ceadef24141L, 0xd5813f148c5f1cfL, 0xd5813f148c5f1d0L, "expression");
