...
public class MultiChildPolicyCS implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    MultiChildPolicyCSSpecific customizer = new MultiChildPolicyCSSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class MultiChildPolicyCSSpecific implements EditorMenuItemCustomizer {
    public boolean matches(EditorMenuItemCustomizationContext context) {
      return new EditorMenuItemModifyingConceptContextMatcher(CONCEPTS.MultiChildPolicy$zA) {
