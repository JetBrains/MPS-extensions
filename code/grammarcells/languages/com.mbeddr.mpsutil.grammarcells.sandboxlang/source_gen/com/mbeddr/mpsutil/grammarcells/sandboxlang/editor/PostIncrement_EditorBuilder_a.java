...
/*package*/ class PostIncrement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    if (nodeCondition_llmizi_a0a()) {
      editorCell.addEditorCell(createCustomFactory_1());
    }
    editorCell.addEditorCell(createCustomFactory_5());
    return editorCell;
  }
  private boolean nodeCondition_llmizi_a0a() {
    LogContext.with(PostIncrement_EditorBuilder_a.class, null, null, null).debug("EditorContext" + getEditorContext());
    LogContext.with(PostIncrement_EditorBuilder_a.class, null, null, null).debug("Node:" + SNodeOperations.present(myNode));
    return true;
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new innerSingleRoleHandler_llmizi_a0a0(myNode, LINKS.inner$6h_o, getEditorContext());
    return provider.createCell();
  }
  private static class innerSingleRoleHandler_llmizi_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public innerSingleRoleHandler_llmizi_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
