...
public class ShadowModelChecker {
  ...
  protected void runChecks() {
    ...
    final MPSModuleRepository repository = MPSModuleRepository.getInstance();
    ...
    repository.getModelAccess().runReadAction(() -> {
      ...
      Iterable<SM_ShadowModel> shadowModels = Sequence.fromIterable(shadowModules).translate(new ITranslator2<SM_ShadowModule, SModel>() {
        public Iterable<SModel> translate(SM_ShadowModule it) {
          return it.getModels();
        }
      }).ofType(SM_ShadowModel.class);
      shadowRoots.value = Sequence.fromIterable(shadowModels).translate(new ITranslator2<SM_ShadowModel, SNode>() {
        public Iterable<SNode> translate(SM_ShadowModel it) {
  ...
  public void start() {
    ...
    modelListener.start(MPSModuleRepository.getInstance());
    timer.start();
  }
