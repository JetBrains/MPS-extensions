...
public class Incremental_ShrinkHorizontalLineWidth_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCache(Incremental_ShrinkHorizontalLineWidth_Test.class, "${extensions.home}/code", "r:ee6cf12e-fe83-4365-8111-77ef29f91ab7(test.de.itemis.mps.editor.celllayout.editor@tests)", false));
