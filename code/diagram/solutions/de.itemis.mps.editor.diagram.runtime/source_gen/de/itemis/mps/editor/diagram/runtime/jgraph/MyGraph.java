...
public class MyGraph extends mxGraph {
  ...
  public boolean isSplitTarget(final Object edgeCell, Object[] boxesToInsert) {
    ...
    getGraphComponent().getEditorComponent().getEditorContext().getRepository().getModelAccess().runReadAction(new _Adapters._return_P0_E0_to_Runnable_adapter(new _FunctionTypes._return_P0_E0<Boolean>() {
      public Boolean invoke() {
        ...
        return canSplit.value = check_q25rap_a0c0a6a14(edge, outputConcept);
      }
    }));
  ...
  public Iterable<ContextButtonContainer> getContextButtonContainers() {
    ...
    return Sequence.fromIterable(states).select(new ISelector<mxCellState, ContextButtonContainer>() {
      public ContextButtonContainer select(mxCellState it) {
        return check_q25rap_a0a0a0a1a66(as_q25rap_a0a0a0a0a0a0b0pc(it.getCell(), BaseDiagramDCell.class));
      }
  ...
  private static <T> T as_q25rap_a0a0a0a0a0a0b0pc(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
}
