...
public class SM_SimpleNode implements INode, INodeReference {
  ...
  public List<String> getPropertyRoles() {
    return SetSequence.fromSet(MapSequence.fromMap(properties).keySet()).toListSequence();
  }
  @NotNull
  @Override
  public List<String> getReferenceRoles() {
    return SetSequence.fromSet(MapSequence.fromMap(references).keySet()).toListSequence();
  }
  @Override
