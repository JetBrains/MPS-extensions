...
public class CustomTreeNodesUpdater {
  ...
  protected void updateChildrens(Iterable<CustomTreeNode> parentTreeNodes) {
    Sequence.fromIterable(parentTreeNodes).visitAll(new IVisitor<CustomTreeNode>() {
      public void visit(CustomTreeNode it) {
        updateChildren(it);
      }
    });
  }
  ...
  protected void updatePresentations(Iterable<CustomTreeNode> treeNodes) {
    Sequence.fromIterable(treeNodes).visitAll(new IVisitor<CustomTreeNode>() {
      public void visit(CustomTreeNode it) {
