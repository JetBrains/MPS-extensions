...
/*package*/ class TEST_FlagAndTooltip_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public TEST_FlagAndTooltip_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createTooltip_0() {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(getEditorContext(), myNode, "com.mbeddr.mpsutil.grammarcells.sandboxlang.editor.GeneratedHints.tooltipHint_mo9qib_a", true);
    EditorCell visibleCell = createSideTransformationHolderProcessor_0();

    TooltipWrapper editorCell = new TooltipWrapper(getEditorContext(), myNode, visibleCell, tooltip, TooltipTimingProperties.DEFAULT);
    editorCell.setCellId("Tooltip_mo9qib_a");
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_mo9qib_a0a");
    if (nodeCondition_mo9qib_a0a0a()) {
  ...
  private boolean nodeCondition_mo9qib_a0a0a() {
    LogContext.with(TEST_FlagAndTooltip_EditorBuilder_a.class, null, null, null).debug("EditorContext" + getEditorContext());
    LogContext.with(TEST_FlagAndTooltip_EditorBuilder_a.class, null, null, null).debug("Node:" + SNodeOperations.present(myNode));
    return true;
  }
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_mo9qib_a0a0a0();
  ...
  private boolean nodeCondition_mo9qib_a0a0a0() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.flagAndTooltip$zyk_);
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "flagAndTooltip");
    editorCell.setCellId("flag_flagAndTooltip");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "flag 'flagAndTooltip'") {
      @Override
    ...
    editorCell.setCellId("SideTransformationSectionCell_mo9qib_a0a0a0");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.TEST_FlagAndTooltip$93);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.flagAndTooltip$zyk_);
            access.write(node, true);
            SelectionUtil.selectLabelCellAnSetCaret(ctx.getEditorContext(), node, "flag_flagAndTooltip", -1);
            return null;
          }
          public SAbstractConcept getOutputConcept() {
            return CONCEPTS.TEST_FlagAndTooltip$93;
          }
        };
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exprSingleRoleHandler_mo9qib_b0a0(myNode, LINKS.expr$zyMB, getEditorContext());
    return provider.createCell();
  }
  private static class exprSingleRoleHandler_mo9qib_b0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public exprSingleRoleHandler_mo9qib_b0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.expr$zyMB, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.expr$zyMB, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.expr$zyMB);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.expr$zyMB));
      try {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_mo9qib_c0a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink expr$zyMB = MetaAdapterFactory.getContainmentLink(0xa257f68c93a347b0L, 0x838b6905dd9c20f6L, 0x6e6ad4c836d00507L, 0x6e6ad4c836d0050cL, "expr");
  }
}
