...
public class CopyAction extends LinearSelectionAction {
  ...
  public void execute(LinearSelection selection) {
    ...
    Iterable<SNode> selectedCopies = ListSequence.fromList(selectedNodes).select(new ISelector<SNode, SNode>() {
      public SNode select(SNode it) {
        return MapSequence.fromMap(copiedNodes).get(it);
      }
    });
  ...
  public SNode commonParent(List<SNode> childs) {
    ...
    boolean found;
    List<SNode> candidates = ListSequence.fromList(SNodeOperations.getNodeAncestors(ListSequence.fromList(childs).first(), null, false)).toListSequence();
