...
public class DependencyTrackingNode implements INode, INodeWrapper {
  ...
  public static ParameterList wrap(ParameterList parameters) {
    return new ParameterList(Sequence.fromIterable(parameters.asSequence()).select(new ISelector<Object, Object>() {
      public Object select(Object it) {
        return (it instanceof INode ? wrap(((INode) it)) : it);
      }
    }));
  }
  ...
  public Iterable<INode> getChildren(String role) {
    ...
    return Sequence.fromIterable(children).select(new ISelector<INode, DependencyTrackingNode>() {
  ...
  public Iterable<INode> getAllChildren() {
    ...
    return Sequence.fromIterable(allChildren).select(new ISelector<INode, DependencyTrackingNode>() {
      public DependencyTrackingNode select(INode it) {
        return wrap(it);
      }
    });
