...
public class JGraphModelSynchronizer {
  ...
  public static JGraphModelSynchronizer getSynchronizer(DiagramModel diagramModel) {
    ...
    if (synchronizer == null) {
      ...
      if (!(DiagramCreationContext.isSubdiagram())) {
        ...
        List<Object> existingListeners = ((List<Object>) ReflectionUtil_copy.readField(mxEventSource.class, graph.getModel(), "eventListeners"));
        boolean alreadyListening = ListSequence.fromList(existingListeners).findFirst(new IWhereFilter<Object>() {
          public boolean accept(Object it) {
            return it.getClass().getName().startsWith(JGraphModelSynchronizer.class.getName());
          }
        }) != null;
        if (alreadyListening) {
  ...
  private void graph2Model_(final mxCell rootCell, final DiagramModel dmodel, SyncContext syncContext) {
    List<Object> cells = Sequence.fromIterable(Sequence.fromArray(myGraph.getChildCells(rootCell))).toListSequence();
    // sync edges last
    cells = ListSequence.fromList(cells).sort(new ISelector<Object, Integer>() {
      public Integer select(Object it) {
        return (it instanceof EdgeDCell ? 1 : 0);
      }
    }, true).toListSequence();
    ...
    for (Object cell_ : cells) {
      ...
      if (cell instanceof BoxDCell || cell instanceof ISelfCreatingCell) {
        ...
        if (box == null) {
          ...
          box = dmodel.createNode(snodeCreator, check_k3jzmb_b0a0d0b0g0e0ob(check_k3jzmb_a1a0a3a1a6a4a04(as_k3jzmb_a0a1a0a3a1a6a4a04(cell, ISelfCreatingCell.class))));
      ...
      if (cell instanceof EdgeDCell) {
        ...
        if (edge == null) {
          ...
          String targetPort;
          {
            Tuples._2<Box, String> _tmp_k3jzmb_e0b0h0e0ob = getEdgeSourceTarget(cell, false, rootCell);
            sourceNode = _tmp_k3jzmb_e0b0h0e0ob._0();
            sourcePort = _tmp_k3jzmb_e0b0h0e0ob._1();
          }
          {
            Tuples._2<Box, String> _tmp_k3jzmb_f0b0h0e0ob = getEdgeSourceTarget(cell, true, rootCell);
            targetNode = _tmp_k3jzmb_f0b0h0e0ob._0();
            targetPort = _tmp_k3jzmb_f0b0h0e0ob._1();
          }
  ...
  public void model2Graph(final BaseDiagramDCell rootCell, final DiagramModel dmodel, final SyncContext syncContext) {
    ...
    try {
      ScalableEditorCell.withScalingDisabled(() -> {
        syncContext.executeWithModel(dmodel, () -> {
          ...
          if (ListSequence.fromList(cellsToDelete).isNotEmpty()) {
            ListSequence.fromList(cellsToDelete).visitAll(new IVisitor<Object>() {
              public void visit(Object cell) {
                ...
                for (final SubDiagramDCell sub : ListSequence.fromList(JGraphUtil.getDescendantsAndMe(((mxCell) cell), SubDiagramDCell.class))) {
                  IMapping<Tuples._2<Box, String>, SubDiagramDCell> m = MapSequence.fromMap(mySubdiagramCells).findFirst(new IWhereFilter<IMapping<Tuples._2<Box, String>, SubDiagramDCell>>() {
                    public boolean accept(IMapping<Tuples._2<Box, String>, SubDiagramDCell> entry) {
                      return entry.value() == sub;
                    }
                  });
                  if (m != null) {
  ...
  public void model2graphPorts(mxCell parentCell, Box box, final SyncContext syncContext) {
    ...
    PortLayouter.layoutPortCells(((BoxDCell) parentCell));
  }
  ...
  public void model2graphLabels(mxCell parentCell, Edge edge, EdgeDCell edgeCell, SyncContext syncContext) {
    for (EdgeLabelType type : EdgeLabelType.values()) {
      ...
      if (label.getCell() == null) {
        ...
        Point position = check_k3jzmb_a0d0a2a0a95(label.getPosition());
        labelJGraphCell.adjustAndSetBounds(check_k3jzmb_a0a4a0c0a0hc(position), check_k3jzmb_b0a4a0c0a0hc(position), 0, 0);
  ...
  public void readSyncAnnotations(IDiagramElement parentElement, mxCell parentDCell, SyncContext syncContext) {
    ...
    List<AnnotationDCell> existingDCells = ListSequence.fromList(JGraphUtil.getChildCells(parentDCell)).ofType(AnnotationDCell.class).toListSequence();
    for (final Annotation annotation : ListSequence.fromList(annotations)) {
      AnnotationDCell dCell = ListSequence.fromList(existingDCells).findFirst(new IWhereFilter<AnnotationDCell>() {
        public boolean accept(AnnotationDCell it) {
  ...
  public void writeSyncAnnotations(IDiagramElement parentElement, mxCell parentDCell, SyncContext syncContext) {
    List<AnnotationDCell> dcells = ListSequence.fromList(JGraphUtil.getChildCells(parentDCell)).ofType(AnnotationDCell.class).toListSequence();
  ...
  public void writeSyncBox(mxCell cell, Box box, SyncContext syncContext) {
    ...
    if (cell instanceof BoxDCell) {
      DiagramModel oldOwnerDiagram = check_k3jzmb_a0a0e0md(check_k3jzmb_a0a0a4a09(as_k3jzmb_a0a0a0a4a09(cell, IDiagramDCell.class)));
      DiagramModel newOwnerDiagram = check_k3jzmb_a0b0e0md(as_k3jzmb_a0a0b0e0md(cell.getParent(), BaseDiagramDCell.class));
  ...
  public EdgeDCell readSyncEdge(_FunctionTypes._return_P1_E0<? extends mxCell, ? super IDiagramElement> getOrCreateCell, Edge edge, mxCell rootCell, SyncContext syncContext) {
    ...
    if (portFromName != null) {
      newSource = ListSequence.fromList(getPortCells(newSource)).findFirst(new IWhereFilter<mxCell>() {
        public boolean accept(mxCell it) {
          return Objects.equals(it.getValue(), portFromName);
        }
      });
    }
    if (portToName != null) {
      newTarget = ListSequence.fromList(getPortCells(newTarget)).findFirst(new IWhereFilter<mxCell>() {
        public boolean accept(mxCell it) {
          return Objects.equals(it.getValue(), portToName);
        }
      });
    }
    ...
    if (portFrom != null) {
      ...
      boolean isAttachedFromInside = ListSequence.fromList(EndpointUtil.getBox(endpointFrom).getSubdiagramModels()).any(new IWhereFilter<DiagramModel>() {
        public boolean accept(DiagramModel it) {
          return it == oppositeModel || isAncestor(it, oppositeModel);
        }
      });
    ...
    if (portTo != null) {
      ...
      boolean isAttachedFromInside = ListSequence.fromList(EndpointUtil.getBox(endpointTo).getSubdiagramModels()).any(new IWhereFilter<DiagramModel>() {
        public boolean accept(DiagramModel it) {
          return it == oppositeModel || isAncestor(it, oppositeModel);
        }
      });
    ...
    List<mxPoint> points = ListSequence.fromList(points_).select(new ISelector<Point, mxPoint>() {
  ...
  protected IConnectionEndpoint_Internal getEndpoint(EdgeDCell edgeCell, boolean target, mxCell rootCell) {
    ...
    String targetPort;
    {
      Tuples._2<Box, String> _tmp_k3jzmb_e0wd = getEdgeSourceTarget(edgeCell, target, rootCell);
      targetNode = _tmp_k3jzmb_e0wd._0();
      targetPort = _tmp_k3jzmb_e0wd._1();
    }
  ...
  public Tuples._2<Box, String> getEdgeSourceTarget(mxCell cell, boolean target, mxCell rootCell) {
    ...
    if (sourceTarget instanceof PortDCell) {
      node = (Box) myElementMapper.getDiagramElement(check_k3jzmb_a0a0a0a3a201(check_k3jzmb_a0a0a0a0d0yd(sourceTarget)));
      port = objectToString(check_k3jzmb_a0a1a3a201(sourceTarget));
    } else {
      node = (Box) myElementMapper.getDiagramElement(check_k3jzmb_a0a0a0a0d0yd_0(sourceTarget));
      port = null;
    }
  ...
  private static Edge check_k3jzmb_b0a0d0b0g0e0ob(EdgeDCell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEdge();
    }
    return null;
  }
  private static EdgeDCell check_k3jzmb_a1a0a3a1a6a4a04(ISelfCreatingCell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEdgeToSplit();
    }
    return null;
  }
  private static Point check_k3jzmb_a0d0a2a0a95(RelativePosition checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getAbsolutePoint();
    }
    return null;
  }
  private static double check_k3jzmb_a0a4a0c0a0hc(Point checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getX();
    }
    return 0;
  }
  private static double check_k3jzmb_b0a4a0c0a0hc(Point checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getY();
    }
    return 0;
  }
  private static DiagramModel check_k3jzmb_a0a0e0md(IDiagramElement checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getModel();
    }
    return null;
  }
  private static IDiagramElement check_k3jzmb_a0a0a4a09(IDiagramDCell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getDiagramElement();
    }
    return null;
  }
  private static DiagramModel check_k3jzmb_a0b0e0md(BaseDiagramDCell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getDiagramModel();
    }
    return null;
  }
  private static String check_k3jzmb_a0a0a0a3a201(mxICell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getId();
    }
    return null;
  }
  private static mxICell check_k3jzmb_a0a0a0a0d0yd(mxICell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getParent();
    }
    return null;
  }
  private static Object check_k3jzmb_a0a1a3a201(mxICell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getValue();
    }
    return null;
  }
  private static String check_k3jzmb_a0a0a0a0d0yd_0(mxICell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getId();
    }
    return null;
  ...
  private static <T> T as_k3jzmb_a0a1a0a3a1a6a4a04(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_k3jzmb_a0a0a0a4a09(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_k3jzmb_a0a0b0e0md(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
}
