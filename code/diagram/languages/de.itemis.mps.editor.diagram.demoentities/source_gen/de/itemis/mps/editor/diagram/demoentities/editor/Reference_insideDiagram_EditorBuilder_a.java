  ...
  private EditorCell createDiagramConnector_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      SNodeEdgeAccessor accessor = new SNodeEdgeAccessor(node, null) {
        ...
        private IConnectionEndpointReference endpointTo = EndpointUtil.createEndpointReferenceForNodeSafe(((_FunctionTypes._return_P0_E0<SNode>) () -> SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.target$pIvZ)).invoke());
