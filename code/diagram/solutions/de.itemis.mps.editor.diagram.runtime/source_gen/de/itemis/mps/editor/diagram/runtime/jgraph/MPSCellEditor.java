...
public class MPSCellEditor extends JPanel {
  ...
  public void editCell(MPSCell cell) {
    myCell = ((EditorCell) EditorUtil.getCommonAncestor(ListSequence.fromList(findLeafsWithoutSubdiagrams(cell.getEditorCell(), ListSequence.fromList(new ArrayList<jetbrains.mps.openapi.editor.cells.EditorCell>()))).toListSequence()));
    if (myCell == null) {
