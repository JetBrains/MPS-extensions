...
public final class ChildStep__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Iterable<SNode> childStepChildren_id3SM_R9ytu$c(@NotNull SNode __thisNode__) {
    return ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.children$k0nx)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, CONCEPTS.ChildStep$O4);
      }
    }).ofType(SNode.class);
  }
  /*package*/ static Iterable<SNode> refStepChildren_id5ub8ctrIdkF(@NotNull SNode __thisNode__) {
    return ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.children$k0nx)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, CONCEPTS.RefStep$f7);
      }
    }).ofType(SNode.class);
  }
  /*package*/ static Iterable<SNode> childLinks_id3SM_R9yrUjA(@NotNull SNode __thisNode__) {
    ...
    Iterable<SNode> links = ListSequence.fromList(SLinkOperations.getChildren(conc, LINKS.linkDeclaration$YU1f)).union(Sequence.fromIterable(superConcetps).translate(new ITranslator2<SNode, SNode>() {
      public Iterable<SNode> translate(SNode it) {
        return SLinkOperations.getChildren(it, LINKS.linkDeclaration$YU1f);
      }
    }));
    return Sequence.fromIterable(links).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SEnumOperations.isMember(SPropertyOperations.getEnum(it, PROPS.metaClass$PeKc), 0xfc6f4e95b9L) && !(SPropertyOperations.getString(it, PROPS.role$Nsjf).equals("smodelAttribute"));
      }
    });
  }
  ...
  /*package*/ static Iterable<SNode> properties_id3SM_R9ytuzA(@NotNull SNode __thisNode__) {
    ...
    Iterable<SNode> propertyDeclarations = Sequence.fromIterable(directProperties).union(Sequence.fromIterable(AbstractConceptDeclaration__BehaviorDescriptor.getAllSuperConcepts_id2A8AB0rAWpG.invoke(conc, ((boolean) false))).translate(new ITranslator2<SNode, SNode>() {
      public Iterable<SNode> translate(SNode it) {
        return SLinkOperations.getChildren(it, LINKS.propertyDeclaration$YUgg);
      }
    }));
    return Sequence.fromIterable(propertyDeclarations).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !(SPropertyOperations.getString(it, PROPS.name$MnvL).equals("alias") || SPropertyOperations.getString(it, PROPS.name$MnvL).equals("resolveInfo") || SPropertyOperations.getString(it, PROPS.name$MnvL).equals("virtualPackage") || SPropertyOperations.getString(it, PROPS.name$MnvL).equals("shortDescription"));
      }
    });
  }
  /*package*/ static Iterable<SNode> propertyStepChildren_id3SM_R9ytu$O(@NotNull SNode __thisNode__) {
    return ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.children$k0nx)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(it, CONCEPTS.SimplePropertyStep$pu);
      }
    }).ofType(SNode.class);
  }
