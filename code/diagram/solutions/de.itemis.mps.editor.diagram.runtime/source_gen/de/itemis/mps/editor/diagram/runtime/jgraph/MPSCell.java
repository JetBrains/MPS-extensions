...
public class MPSCell implements Serializable {
  ...
  public boolean trySetSize(double width, double height) {
    ...
    ListSequence.fromList(subdiagrams).visitAll(new IVisitor<SubDiagramECell>() {
      public void visit(SubDiagramECell it) {
        it.clearFixedSize();
      }
    });
  ...
  public jetbrains.mps.openapi.editor.cells.EditorCell findLeaf(double x, double y) {
    ...
    {
      Tuples._2<Double, Double> _tmp_gfmb0p_a0wb = convertPosition(_x.value, _y.value);
      _x.value = _tmp_gfmb0p_a0wb._0();
      _y.value = _tmp_gfmb0p_a0wb._1();
    }
  ...
  public boolean setSelection(double x, double y) {
    ...
    {
      Tuples._2<Double, Double> _tmp_gfmb0p_c0ec = convertPosition(_x.value, _y.value);
      _x.value = _tmp_gfmb0p_c0ec._0();
      _y.value = _tmp_gfmb0p_c0ec._1();
    }
  ...
  private static boolean isUnderSelection(Selection selection, jetbrains.mps.openapi.editor.cells.EditorCell cell) {
    return ((Boolean) ReflectionUtil_copy.callMethod(jetbrains.mps.nodeEditor.EditorComponent.class, ((jetbrains.mps.nodeEditor.EditorComponent) cell.getEditorComponent()), "isUnderSelection", new Class[]{Selection.class, jetbrains.mps.openapi.editor.cells.EditorCell.class}, new Object[]{selection, cell}));
  }
