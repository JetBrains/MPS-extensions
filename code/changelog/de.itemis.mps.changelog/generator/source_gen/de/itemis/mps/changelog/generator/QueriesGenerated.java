...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetValue_1_1(final PropertyMacroContext _context) {
    return IterableUtils.join(ListSequence.fromList(IHoldLines__BehaviorDescriptor.getLines_id6GJhO0n1Xys.invoke(SLinkOperations.getTarget(_context.getNode(), LINKS.header$RMcR))).select(new ISelector<SNode, String>() {
      public String select(SNode it) {
        return (String) Line__BehaviorDescriptor.representAsText_id2iG$EWuTXv2.invoke(it);
      }
    }), "\n");
  }
  ...
  public static Object propertyMacro_GetValue_4_1(final PropertyMacroContext _context) {
    return IterableUtils.join(ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), LINKS.changes$k0JZ)).select(new ISelector<SNode, String>() {
      public String select(SNode it) {
  ...
  public static void mappingScript_CodeBlock_5(final MappingScriptContext _context) {
    ListSequence.fromList(SModelOperations.nodes(_context.getModel(), CONCEPTS.Word$Dn)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        ...
        SPropertyOperations.assign(it, PROPS.value$zQr_, SPropertyOperations.getString(it, PROPS.value$zQr_).replaceAll(" ", " "));
      }
    });
  }
