...
public class SM_PTree implements ITree {
  ...
  public ITree addNewChildren(long parentId, String role, int index, long[] newIds, IConceptReference[] concepts) {
    return addNewChildren(parentId, role, index, newIds, Sequence.fromIterable(Sequence.fromArray(concepts)).select(new ISelector<IConceptReference, IConcept>() {
      public IConcept select(IConceptReference it) {
        return it.resolve(new MPSArea());
      }
    }).toGenericArray(IConcept.class));
  }
