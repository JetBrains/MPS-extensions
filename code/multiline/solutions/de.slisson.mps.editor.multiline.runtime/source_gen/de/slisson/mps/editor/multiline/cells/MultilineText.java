...
public class MultilineText {
  private static final Logger LOG = Logger.wrap(LogManager.getLogger(MultilineText.class));
  ...
  public int getTotalWords() {
    return Sequence.fromIterable(Sequence.fromArray(myWords)).foldLeft(0, new ILeftCombinator<String[], Integer>() {
      public Integer combine(Integer s, String[] it) {
        return s + it.length;
      }
    });
  }
