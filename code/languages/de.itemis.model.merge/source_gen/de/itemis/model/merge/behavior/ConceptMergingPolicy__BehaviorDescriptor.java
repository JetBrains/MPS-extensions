...
public final class ConceptMergingPolicy__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Iterable<SNode> allHierarchyProperties_id5zr7Q_1V6SF(@NotNull SNode __thisNode__) {
    ...
    Sequence.fromIterable(ConceptMergingPolicy__BehaviorDescriptor.allSuperConcepts_id5zr7Q_1WN6i.invokeSpecial(__thisNode__)).translate((it) -> SLinkOperations.getChildren(it, LINKS.propertyDeclaration$YUgg));
    if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(__thisNode__, LINKS.conceptRef$p8vY), CONCEPTS.ConceptDeclaration$gH)) {
      ListSequence.fromList(declarations).addElement(ListSequence.fromList(AbstractConceptDeclaration__BehaviorDescriptor.getPropertyDeclarations_idhEwILLM.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.conceptRef$p8vY))).findFirst((it) -> (boolean) PropertyDeclaration__BehaviorDescriptor.is_id4MKjpUYnih4.invoke(it, PROPS.virtualPackage$EkXl)));
    }
    return declarations;
  }
