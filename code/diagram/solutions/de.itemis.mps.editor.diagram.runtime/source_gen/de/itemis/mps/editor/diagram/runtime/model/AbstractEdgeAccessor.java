...
public abstract class AbstractEdgeAccessor extends AbstractDiagramElementAccessor implements IEdgeAccessor {
  ...
  public RelativePosition readLabelPosition(final EdgeLabelType type) {
    ...
    SNode labelLayout = ListSequence.fromList(SLinkOperations.getChildren(layout, LINKS.labels$sKbi)).findFirst(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return Objects.equals(SPropertyOperations.getString(it, PROPS.type$QAIl), type.getId());
      }
    });
    if ((labelLayout == null)) {
      return null;
