...
public class LayoutInterceptor implements CellLayout, ICellLayoutWrapper {
  ...
  public static boolean install(EditorCell cell) {
    ...
    if (!(layout instanceof ICellLayoutWrapper)) {
      ...
      ReflectionUtil_copy.writeField(jetbrains.mps.nodeEditor.cells.EditorCell_Collection.class, collectionCell, "myCellLayout", wrapped);
  ...
  public static void uninstall(EditorCell cell) {
    ...
    CellLayout layout = collectionCell.getCellLayout();
    if (layout instanceof ICellLayoutWrapper) {
      ReflectionUtil_copy.writeField(jetbrains.mps.nodeEditor.cells.EditorCell_Collection.class, collectionCell, "myCellLayout", ((CellLayout) CellLayoutExtensions.unwrapAll(layout)));
    }
  }
  ...
  private static class StylesRequiringInstall {
    ...
    private static boolean check_58rwot_a1a0a3a0a61sb(CellLayout_Vertical checkedDotOperand) {
      if (null != checkedDotOperand) {
        return ((Boolean) ReflectionUtil_copy.callMethod(CellLayout_Vertical.class, checkedDotOperand, "isGridLayout", new Class[]{}, new Object[]{}));
      }
      return false;
    }
