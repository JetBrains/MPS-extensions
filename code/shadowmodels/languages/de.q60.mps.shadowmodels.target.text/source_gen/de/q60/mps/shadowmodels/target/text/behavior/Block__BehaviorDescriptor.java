...
public final class Block__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xa7322769ef644daaL, 0xa2f4fd4228fb713eL, 0xe68932160ec1167L, "de.q60.mps.shadowmodels.target.text.structure.Block");
  ...
  /*package*/ static void toText_id7NImM0593av(@NotNull SNode __thisNode__, final TextBuffer buffer) {
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.content$svJp)).visitAll((it) -> ITextElement__BehaviorDescriptor.toText_id7NImM0593av.invoke(it, buffer));
  }
