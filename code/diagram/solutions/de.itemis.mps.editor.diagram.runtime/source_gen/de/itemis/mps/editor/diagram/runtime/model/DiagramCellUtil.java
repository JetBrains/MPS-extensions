...
public class DiagramCellUtil {
  public static void disablePreferredSize(EditorCell c, Runnable runnable) {
    ...
    ListSequence.fromList(subdiagrams).visitAll(new IVisitor<IDiagramCell>() {
      public void visit(IDiagramCell it) {
        MapSequence.fromMap(preferredSizes).put(it, it.getFixedSize());
      }
    });
