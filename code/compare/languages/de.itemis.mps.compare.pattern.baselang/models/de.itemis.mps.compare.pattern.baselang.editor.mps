...
<model ref="r:85abeca6-54b2-49d1-b3a9-2a4d0795ea4f(de.itemis.mps.compare.pattern.baselang.editor)">
  ...
  <imports>
    ...
    <import index="ycll" ref="r:32dcf0c9-9145-4165-a8a2-dc1bcc800cfe(de.itemis.mps.compare.pattern.baselang.structure)" implicit="true" />
  ...
  <node concept="22mcaB" id="2cvVnUuAo$b">
    <ref role="aqKnT" to="ycll:$WtIWnCAuj" resolve="PatternHint" />
    <node concept="22hDWj" id="27yO7ubpHgW" role="22hAXT" />
  </node>
</model>
