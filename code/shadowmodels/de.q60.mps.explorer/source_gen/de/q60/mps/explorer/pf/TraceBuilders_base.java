...
public class TraceBuilders_base extends PFModule {
  ...
  public static final TraceBuilders_base INSTANCE = new _FunctionTypes._return_P0_E0<TraceBuilders_base>() {
    public TraceBuilders_base invoke() {
      try {
  ...
  private TraceBuilders_base() {
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.buildTree", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        ...
        if (traceElement.transparent) {
          ...
          for (Object child : Sequence.fromIterable(((Iterable<? extends Iterable<Object>>) ((Object) _PFcontext.callFunctions("de.q60.mps.explorer.pf.TraceBuilders_base.getChildren", new ParameterList(new Object[]{traceElement}))))).translate(new ITranslator2<Iterable<Object>, Object>() {
            public Iterable<Object> translate(Iterable<Object> it) {
              return it;
            }
          })) {
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.getChildren", new IFunctionImplementation() {
      private List<IParameterType> myParameterTypes = ListSequence.fromListAndArray(new ArrayList<IParameterType>(), new ParameterType_Classifier(ExplorerElement.class));
      private List<String> contextIds = ListSequence.fromListAndArray(new ArrayList<String>(), "de.q60.mps.explorer.pf.TraceBuilders_base.explorerContextGroup");
      private List<String> groupIds = ListSequence.fromList(new ArrayList<String>());
      @Override
