...
<model ref="r:9a110748-bca8-4a1d-99a8-4489ad96a522(de.itemis.model.merge.exec)">
  ...
  <imports>
    <import index="ph16" ref="r:a25356ac-29ef-4220-b6b1-3b101aba01e6(de.itemis.model.merge.sandbox)" />
    <import index="tzvd" ref="r:9da6e3a3-f524-41e6-abf2-026dd9739df1(de.itemis.model.merge.plugin)" />
  </imports>
  <registry>
  ...
  <node concept="poArf" id="5zr7Q_1JUL5">
    ...
    <ref role="pot50" to="tzvd:7TOowlgsb4L" resolve="DiamondMerge" />
