...
public final class OptionalCell__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static SNode getFirstNonConst_id7KznU_3XzU4(@NotNull SNode __thisNode__) {
    return ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(__thisNode__, LINKS.option$qG$3), CONCEPTS.EditorCellModel$gN, true, new SAbstractConcept[]{})).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !(SNodeOperations.isInstanceOf(it, CONCEPTS.CellModel_Indent$uj));
      }
    }).findFirst(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !(GeneratorUtils.isConstant(it)) && !(GeneratorUtils.isCollection(it));
      }
    });
  }
  ...
  /*package*/ static SNode getTransformationText_id7KznU_45kn7(@NotNull SNode __thisNode__) {
    ...
    SNode first = ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(__thisNode__, LINKS.option$qG$3), CONCEPTS.EditorCellModel$gN, true, new SAbstractConcept[]{})).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !(GeneratorUtils.isCollection(it));
      }
    }).first();
