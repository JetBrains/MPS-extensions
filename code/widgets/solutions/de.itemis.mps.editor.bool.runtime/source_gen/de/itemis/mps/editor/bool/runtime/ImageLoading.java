...
public class ImageLoading {
  ...
  public static Image loadImage(String fileName, SNode sourceNode) {
    ...
    if (fileName.startsWith(MacrosFactory.MODULE)) {
      ...
      LanguageRegistry.getInstance(SNodeOperations.getModel(sourceNode).getRepository()).withModuleRuntime(Stream.of(module.getModuleReference()), (mr) -> resourceURL.value = mr.getModuleClassLoader().getResource(filePathInModule));
