...
/*package*/ class TEST_OptionalReadOnlyModelAccessorCell_Single_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public TEST_OptionalReadOnlyModelAccessorCell_Single_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_wdta04_a0");
    editorCell.addEditorCell(createConstant_0());
    if (nodeCondition_wdta04_a1a0()) {
      editorCell.addEditorCell(createAlternation_0());
    }
    editorCell.addEditorCell(createConstant_1());
    return editorCell;
  }
  private boolean nodeCondition_wdta04_a1a0() {
    LogContext.with(TEST_OptionalReadOnlyModelAccessorCell_Single_EditorBuilder_a.class, null, null, null).debug("EditorContext" + getEditorContext());
    LogContext.with(TEST_OptionalReadOnlyModelAccessorCell_Single_EditorBuilder_a.class, null, null, null).debug("Node:" + SNodeOperations.present(myNode));
    return true;
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "optional ready-only model accessor");
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_wdta04_a1a0_0();
  ...
  private boolean nodeCondition_wdta04_a1a0_0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.child$WoFe)).isNotEmpty();
  }
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.BACKSPACE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          ...
          caretPosition.save();
          SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.child$WoFe));
  ...
  private EditorCell createCustomFactory_2(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      final SNode childNode = SLinkOperations.getTarget(myNode, LINKS.child$WoFe);
      new Object() {
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_wdta04_a0a1a0");
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
      public String getText() {
        return "accessor_" + getEditorContext().getSelectedNode().getConcept().getConceptAlias() + "_" + SConceptOperations.conceptAlias(SNodeOperations.getConcept(myNode));
      }
    }, myNode);
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_wdta04_a0a0b0a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new childSingleRoleHandler_wdta04_b0a0b0a(myNode, LINKS.child$WoFe, getEditorContext());
    return provider.createCell();
  }
  private static class childSingleRoleHandler_wdta04_b0a0b0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public childSingleRoleHandler_wdta04_b0a0b0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.child$WoFe, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.child$WoFe, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.child$WoFe);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.child$WoFe));
      try {
    ...
    public List<TransformationMenuItem> createItems(final TransformationMenuContext ctx) {
      ...
      final Iterable<String> matchingTexts = new StringOrSequenceQuery() {
        public Object queryStringOrSequence() {
          return Sequence.fromIterable(Sequence.<String>singleton(new Object() {
            public String query(EditorContext editorContext, SNode node) {
              return "accessor_" + editorContext.getSelectedNode().getConcept().getConceptAlias() + "_" + SConceptOperations.conceptAlias(SNodeOperations.getConcept(node));
            }
          }.query(editorContext, sourceNode))).where((it) -> (it != null && it.length() > 0));
        }
      }.query();
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            final SNode sourceNode = ctx.getNode();
            EditorContext editorContext = ctx.getEditorContext();
            SNode newNode = SNodeFactoryOperations.setNewChild(SNodeOperations.cast(sourceNode, CONCEPTS.TEST_OptionalReadOnlyModelAccessorCell_Single$z), LINKS.child$WoFe, null);
          }
          @Override
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_wdta04_c0a");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private static final class LINKS {
    /*package*/ static final SContainmentLink child$WoFe = MetaAdapterFactory.getContainmentLink(0xa257f68c93a347b0L, 0x838b6905dd9c20f6L, 0x7ce82f7110fddc24L, 0x7ce82f7110fddc25L, "child");
  }
