...
public class Repository extends PFModule {
  ...
  public static final Repository INSTANCE = new _FunctionTypes._return_P0_E0<Repository>() {
    public Repository invoke() {
      try {
  ...
  private Repository() {
                              ...
                              public void invoke(final IBuilderContext context) {
                                ...
                                if (true) {
                                  context.forChildRole("models").run(new _FunctionTypes._void_P1_E0<IBuilderContext>() {
                                    public void invoke(final IBuilderContext context) {
                                      int i_a1a0a0b = 0;
                                      for (SNode e_a1a0a0b : Sequence.fromIterable(SLinkOperations.collectMany(SLinkOperations.getChildren(SM_ParameterConversion.toMPS(((INode) context.getContextValue())), LINKS.modules$jBPn), LINKS.models$h3QT)).where(new IWhereFilter<SNode>() {
                                        public boolean accept(SNode it) {
                                          return Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(it, LINKS.rootNodes$jxXY), CONCEPTS.Entity$dF)).isNotEmpty();
                                        }
                                      })) {
                              ...
                              public void invoke(final IBuilderContext context) {
                                ...
                                if (true) {
                                  context.forChildRole("models").run(new _FunctionTypes._void_P1_E0<IBuilderContext>() {
                                    public void invoke(final IBuilderContext context) {
                                      int i_a1a1a0b = 0;
                                      for (SNode e_a1a1a0b : Sequence.fromIterable(SLinkOperations.collectMany(SLinkOperations.getChildren(SM_ParameterConversion.toMPS(((INode) context.getContextValue())), LINKS.modules$jBPn), LINKS.models$h3QT)).where(new IWhereFilter<SNode>() {
                                        public boolean accept(SNode it) {
                                          return Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(it, LINKS.rootNodes$jxXY), CONCEPTS.Entity$dF)).isNotEmpty();
                                        }
                                      })) {
                              ...
                              public void invoke(final IBuilderContext context) {
                                ...
                                if (true) {
                                  context.forChildRole("models").run(new _FunctionTypes._void_P1_E0<IBuilderContext>() {
                                    public void invoke(final IBuilderContext context) {
                                      int i_a1a2a0b = 0;
                                      for (SNode e_a1a2a0b : Sequence.fromIterable(SLinkOperations.collectMany(SLinkOperations.getChildren(SM_ParameterConversion.toMPS(((INode) context.getContextValue())), LINKS.modules$jBPn), LINKS.models$h3QT)).where(new IWhereFilter<SNode>() {
                                        public boolean accept(SNode it) {
                                          return Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(it, LINKS.rootNodes$jxXY), CONCEPTS.Entity$dF)).isNotEmpty();
                                        }
                                      })) {
                              ...
                              public void invoke(final IBuilderContext context) {
                                ...
                                if (true) {
                                  context.forChildRole("models").run(new _FunctionTypes._void_P1_E0<IBuilderContext>() {
                                    public void invoke(final IBuilderContext context) {
                                      int i_a1a3a0b = 0;
                                      for (SNode e_a1a3a0b : Sequence.fromIterable(SLinkOperations.collectMany(SLinkOperations.getChildren(SM_ParameterConversion.toMPS(((INode) context.getContextValue())), LINKS.modules$jBPn), LINKS.models$h3QT)).where(new IWhereFilter<SNode>() {
                                        public boolean accept(SNode it) {
                                          return Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(it, LINKS.rootNodes$jxXY), CONCEPTS.Entity$dF)).isNotEmpty();
                                        }
                                      })) {
                                              ...
                                              public void invoke(final IBuilderContext context) {
                                                ...
                                                for (SNode e_a1a2a1a0d : Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(SM_ParameterConversion.toMPS(((INode) context.getContextValue())), LINKS.rootNodes$jxXY), CONCEPTS.Entity$dF))) {
                                                  context.forContextValue(SM_ParameterConversion.fromMPS(e_a1a2a1a0d)).withAdditionalIdPrefix("12" + "#" + i_a1a2a1a0d).run(new _FunctionTypes._void_P1_E0<IBuilderContext>() {
                                                    public void invoke(final IBuilderContext context) {
                                                      context.createNode(new TransformationCall("de.q60.mps.shadowmodels.examples.entities.transformations.JavaToText.javaClassToFile", new ParameterList(ListSequence.fromListAndArray(new ArrayList<Object>(), SM_ParameterConversion.fromMPS(SNodeOperations.cast((new _FunctionTypes._return_P0_E0<SNode>() {
                                                        public SNode invoke() {
    ...
    myImplementations.put("de.q60.mps.shadowmodels.examples.entities.transformations.Repository.entitiesToJavaToText/mc", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        return Sequence.fromIterable(((Iterable<? extends Iterable<MappingConfiguration>>) ((Object) _PFcontext.callFunctions("de.q60.mps.shadowmodels.examples.entities.transformations.EntitiesToJava_reduce.entitiesToJava/mc", new ParameterList(new Object[]{}))))).translate(new ITranslator2<Iterable<MappingConfiguration>, MappingConfiguration>() {
    ...
    myImplementations.put("de.q60.mps.shadowmodels.examples.entities.transformations.Repository.entitiesToJavaToText/mc", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        return Sequence.fromIterable(((Iterable<? extends Iterable<MappingConfiguration>>) ((Object) _PFcontext.callFunctions("de.q60.mps.shadowmodels.examples.entities.transformations.JavaToText_reduce.javaToText/mc", new ParameterList(new Object[]{}))))).translate(new ITranslator2<Iterable<MappingConfiguration>, MappingConfiguration>() {
          public Iterable<MappingConfiguration> translate(Iterable<MappingConfiguration> it) {
            return it;
          }
        });
