      ...
      final boolean isApplicable = new Object() {
        public boolean query() {
          ...
          applicable &= new Object() {
            public boolean query() {
              LogContext.with(LocalVariableDeclaration_EditorBuilder_a.class, null, null).debug("Subconcept:" + subconcept);
              LogContext.with(LocalVariableDeclaration_EditorBuilder_a.class, null, null).debug("Node:" + SNodeOperations.present(node));
              LogContext.with(LocalVariableDeclaration_EditorBuilder_a.class, null, null).debug("EditorContext:" + editorContext);
              return true;
            }
          }.query();
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public String getShortDescriptionText(String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            LogContext.with(LocalVariableDeclaration_EditorBuilder_a.class, null, null).debug("OriginalText:" + originalText);
            LogContext.with(LocalVariableDeclaration_EditorBuilder_a.class, null, null).debug("EditorContext:" + editorContext);
