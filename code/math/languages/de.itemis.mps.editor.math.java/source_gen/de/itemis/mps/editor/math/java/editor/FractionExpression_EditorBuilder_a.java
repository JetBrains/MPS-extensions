...
/*package*/ class FractionExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new numeratorSingleRoleHandler_vxvyx5_a0a(myNode, LINKS.numerator$PGR1, getEditorContext());
  ...
  private static class numeratorSingleRoleHandler_vxvyx5_a0a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.numerator$PGR1, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.numerator$PGR1, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.numerator$PGR1);
      }
    }
    @Override
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.numerator$PGR1));
      try {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new denominatorSingleRoleHandler_vxvyx5_a1a(myNode, LINKS.denominator$PH$4, getEditorContext());
    return provider.createCell();
  }
  private static class denominatorSingleRoleHandler_vxvyx5_a1a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.denominator$PH$4, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.denominator$PH$4, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.denominator$PH$4);
      }
    }
    @Override
    public EditorCell createCell() {
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.denominator$PH$4));
      try {
        EditorCell editorCell = super.createEmptyCell();
