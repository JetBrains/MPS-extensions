...
/*package*/ class CellModel_BooleanText_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public CellModel_BooleanText_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_s2qn87_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_s2qn87_a0");
  ...
  private EditorCell createRefCell_0() {
    ...
    style.set(StyleAttributes.TEXT_BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_s2qn87_a0c0()));
    style.set(StyleAttributes.BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_s2qn87_a1c0()));
    style.set(StyleAttributes.TEXT_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_s2qn87_a2c0()));
    style.set(StyleAttributes.FONT_STYLE, _StyleParameter_QueryFunction_s2qn87_a3c0());
    style.set(StyleAttributes.UNDERLINED, _StyleParameter_QueryFunction_s2qn87_a4c0());
    style.set(StyleAttributes.STRIKE_OUT, _StyleParameter_QueryFunction_s2qn87_a5c0());
    editorCell.getStyle().putAll(style);
