...
public final class BooleanFunction__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x766348f76a674b85L, 0x9323384840132299L, 0x772f36511bff3d3fL, "de.itemis.mps.editor.math.structure.BooleanFunction");
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    return ListSequence.fromListAndArray(new ArrayList<SConcept>(), CONCEPTS.ConceptFunctionParameter_node$zM);
  }
  ...
  /*package*/ BooleanFunction__BehaviorDescriptor() {
  }
