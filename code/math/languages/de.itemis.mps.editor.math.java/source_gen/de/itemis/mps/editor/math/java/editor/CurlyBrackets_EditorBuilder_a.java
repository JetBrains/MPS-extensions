...
/*package*/ class CurlyBrackets_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new expressionSingleRoleHandler_gnpzpm_a0a(myNode, LINKS.expression$TlhM, getEditorContext());
    return provider.createCell();
  }
  private static class expressionSingleRoleHandler_gnpzpm_a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public expressionSingleRoleHandler_gnpzpm_a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
