    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      SNodeEdgeAccessor accessor = new SNodeEdgeAccessor(node) {
        ...
        private IConnectionEndpointReference endpointFrom = EndpointUtil.createEndpointReferenceForNodeSafe(new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            return SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.subtype$HGwx);
          }
        }.invoke());
        private IConnectionEndpointReference endpointTo = EndpointUtil.createEndpointReferenceForNodeSafe(new _FunctionTypes._return_P0_E0<SNode>() {
          public SNode invoke() {
            return SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.supertype$HG2v);
          }
        }.invoke());
