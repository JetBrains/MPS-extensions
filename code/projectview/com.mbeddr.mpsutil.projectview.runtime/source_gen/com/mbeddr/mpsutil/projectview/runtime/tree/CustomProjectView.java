...
public class CustomProjectView extends BaseLogicalViewProjectPane implements ProjectViewPaneOverride {
  ...
  private static final Logger LOG = LogManager.getLogger(CustomProjectView.class);
  ...
  public Icon getIcon() {
    ...
    getMPSProject().getRepository().getModelAccess().runReadAction(new _Adapters._return_P0_E0_to_Runnable_adapter(new _FunctionTypes._return_P0_E0<Icon>() {
      public Icon invoke() {
        return icon.value = check_rm1e9y_a0a0a1a62(getMyViewDescriptor(), CustomProjectView.this);
      }
    }));
  ...
  public String getTitle() {
    String label = check_rm1e9y_a0a0gb(getMyViewDescriptor(), this);
  ...
  public Object getData(final String dataId) {
    ...
    final List<Object> selectedObjects = ListSequence.fromList(getSelectedTreeNodes(CustomTreeNode.class)).select(new ISelector<CustomTreeNode, Object>() {
      public Object select(CustomTreeNode it) {
    ...
    if (MPSDataKeys.NODE.is(dataId)) {
      return as_rm1e9y_a0a0i0mb(selectedObject, SNode.class);
    }
    if (MPSDataKeys.NODES.is(dataId)) {
      return ListSequence.fromList(selectedObjects).ofType(SNode.class).toListSequence();
    }
    if (MPSDataKeys.MODEL.is(dataId)) {
      return as_rm1e9y_a0a0k0mb(selectedObject, SModel.class);
    }
    if (MPSDataKeys.MODELS.is(dataId)) {
      return ListSequence.fromList(selectedObjects).ofType(SModel.class).toListSequence();
    }
    if (MPSDataKeys.CONTEXT_MODEL.is(dataId)) {
      return getContextObject(SModel.class);
    }
    if (MPSDataKeys.MODULE.is(dataId)) {
      return as_rm1e9y_a0a0n0mb(selectedObject, SModule.class);
    }
    if (MPSDataKeys.MODULES.is(dataId)) {
      return ListSequence.fromList(selectedObjects).ofType(SModule.class).toListSequence();
    }
    ...
    if (MPSDataKeys.TREE_NODES.is(dataId)) {
      return ListSequence.fromList(getSelectedTreeNodes(TreeNode.class)).toListSequence();
    }
  ...
  protected <T> T getContextObject(final Class<T> type) {
    for (TreeNode currentNode = ListSequence.fromList(getSelectedTreeNodes(TreeNode.class)).first(); currentNode != null; currentNode = currentNode.getParent()) {
      final Object obj = check_rm1e9y_a0a0a0yb(check_rm1e9y_a0a0a0a05(as_rm1e9y_a0a0a0a0a05(currentNode, CustomTreeNode.class)));
  ...
  private ActionPlace getPlace() {
    ...
    Object selectedObject = check_rm1e9y_a0b0cc(check_rm1e9y_a0a1a45(treeNode));
  ...
  public void dispose() {
    if (!(this.isDisposed)) {
      check_rm1e9y_a0a0a65(((CustomProjectTree) myTree));
      super.dispose();
      check_rm1e9y_a2a0a65(myWeight);
  ...
  protected void removeListeners() {
    ...
    if (myRepositoryListener != null) {
      check_rm1e9y_a0a6a85(myConnection);
      myConnection = null;
  ...
  public JComponent createComponent() {
    ...
    String toolbarActionGroupId = check_rm1e9y_a0h0uc(getMyViewDescriptor(), this);
    if (toolbarActionGroupId != null) {
      ...
      if (toolbarActionGroup != null) {
        ...
        LOG.warn("Couldn't find toolbar action group with id \"" + toolbarActionGroupId + "\"");
      }
    }
  ...
  private static Icon check_rm1e9y_a0a0a1a62(IViewDescriptor checkedDotOperand, CustomProjectView checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getIcon();
    }
    return null;
  }
  private static String check_rm1e9y_a0a0gb(IViewDescriptor checkedDotOperand, CustomProjectView checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getLabel();
    }
    return null;
  }
  private static Object check_rm1e9y_a0a0a0yb(ViewElement<Object> checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getObject();
    }
    return null;
  }
  private static ViewElement<Object> check_rm1e9y_a0a0a0a05(CustomTreeNode checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getElement();
    }
    return null;
  }
  private static Object check_rm1e9y_a0b0cc(ViewElement<Object> checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getObject();
    }
    return null;
  }
  private static ViewElement<Object> check_rm1e9y_a0a1a45(CustomTreeNode checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getElement();
    }
    return null;
  }
  private static void check_rm1e9y_a0a0a65(CustomProjectTree checkedDotOperand) {
    if (null != checkedDotOperand) {
      checkedDotOperand.dispose();
    }

  }
  private static void check_rm1e9y_a2a0a65(WeightValues.AquiredValue checkedDotOperand) {
    if (null != checkedDotOperand) {
      checkedDotOperand.release();
    }

  }
  private static void check_rm1e9y_a0a6a85(MessageBusConnection checkedDotOperand) {
    if (null != checkedDotOperand) {
      checkedDotOperand.disconnect();
    }

  }
  private static String check_rm1e9y_a0h0uc(IViewDescriptor checkedDotOperand, CustomProjectView checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getToolbarActionGroupId();
    }
    return null;
  }
  private static <T> T as_rm1e9y_a0a0i0mb(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_rm1e9y_a0a0k0mb(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_rm1e9y_a0a0n0mb(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_rm1e9y_a0a0a0a0a05(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
}
