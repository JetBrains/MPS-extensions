...
public abstract class GlobalModelListener {
  ...
  public void stop() {
    SetSequence.fromSet(myModels).visitAll(new IVisitor<SModel>() {
      public void visit(SModel it) {
        removeListener(it);
      }
    });
    SetSequence.fromSet(myModules).visitAll(new IVisitor<SModule>() {
      public void visit(SModule it) {
        it.removeModuleListener(moduleListener);
      }
    });
    SetSequence.fromSet(myRepositories).visitAll(new IVisitor<SRepository>() {
      public void visit(SRepository it) {
        it.removeRepositoryListener(repositoryListener);
      }
    });
