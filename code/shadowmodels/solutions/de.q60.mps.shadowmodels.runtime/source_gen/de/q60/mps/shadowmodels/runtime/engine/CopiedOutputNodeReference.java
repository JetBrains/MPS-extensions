...
public class CopiedOutputNodeReference extends AbstractOutputNodeReference implements IOutputNodeReference {
  ...
  public Iterable<Tuples._2<String, IUniqueContainmentTarget>> getUniqueContainmentTargetForChildren(final ITransformationEngine engine) {
    ...
    return Sequence.fromIterable(childLinks).select(new ISelector<IChildLink, String>() {
      public String select(IChildLink it) {
        return it.getName();
      }
    }).translate(new ITranslator2<String, Tuples._2<String, IUniqueContainmentTarget>>() {
      public Iterable<Tuples._2<String, IUniqueContainmentTarget>> translate(final String role) {
        return Sequence.fromIterable(parent.getChildren(role)).select(new ISelector<IOutputNodeReference, Tuples._2<String, IUniqueContainmentTarget>>() {
          public Tuples._2<String, IUniqueContainmentTarget> select(IOutputNodeReference child) {
  ...
  public class OutputNode implements IOutputNode {
    ...
    protected Iterable<IOutputNodeReference> copyChildren(Iterable<IOutputNodeReference> children) {
      return Sequence.fromIterable(children).select(new ISelector<IOutputNodeReference, ContainmentTargetRootNodes>() {
        public ContainmentTargetRootNodes select(IOutputNodeReference it) {
