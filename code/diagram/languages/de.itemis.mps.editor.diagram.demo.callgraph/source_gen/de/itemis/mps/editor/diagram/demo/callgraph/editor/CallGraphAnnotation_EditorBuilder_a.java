          ...
          ContextVariables.withValue("thisNode", node, () -> {
            ...
            IDiagramAccessor accessor = new AbstractDiagramAccessor(node) {
              public List<? extends IDiagramElementAccessor> getElements(IAccessorFactory accessorFactory) {
                    ...
                    public void run() {
                      ...
                      AbstractBoxAccessor accessor = new AbstractBoxAccessor(EndpointUtil.createAccessorKeyForSNode(((SNode) _variablesContext.getValue("parameterObject")))) {
                        ...
                        public Iterable<SNode> getNavigationTargets() {
                          ...
                          result = Sequence.fromIterable(result).concat(Sequence.fromIterable(Sequence.<SNode>singleton(SLinkOperations.getTarget(SNodeOperations.as(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("parameterObject")), LINKS.returnType$5xoi), CONCEPTS.ClassifierType$bL), LINKS.classifier$cxMr))));
                          return result;
                        }
                      };
                ...
                for (final SNode parameterObject : new Object() {
                  public Iterable<SNode> query() {
                    return Sequence.fromIterable(Classifier__BehaviorDescriptor.methods_id4_LVZ3pBKCn.invoke(SNodeOperations.cast(SNodeOperations.getParent(node), CONCEPTS.ClassConcept$bK))).translate((it) -> SNodeOperations.ofConcept(SLinkOperations.collect(SNodeOperations.ofConcept(SLinkOperations.getChildren(SLinkOperations.getTarget(it, LINKS.body$5xQk), LINKS.statement$53DE), CONCEPTS.ExpressionStatement$O8), LINKS.expression$5L7M), CONCEPTS.BaseMethodCall$kV));
                  }
                }.query()) {
                  ContextVariables.withParentAndValue(_variablesContext, "parameterObject", parameterObject, new Runnable() {
                    public void run() {
