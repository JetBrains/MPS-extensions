...
public class EditorUtil {
  ...
  public static void forceMoveTo(EditorCell root, int x, int y) {
    ...
    Iterable<Tuples._3<EditorCell, Integer, Integer>> targets = ListSequence.fromList(allCells).select(new ISelector<EditorCell, Tuples._3<EditorCell, Integer, Integer>>() {
      public Tuples._3<EditorCell, Integer, Integer> select(EditorCell it) {
        return MultiTuple.<EditorCell,Integer,Integer>from(it, it.getX() + deltaX, it.getY() + deltaY);
      }
    }).toListSequence();
