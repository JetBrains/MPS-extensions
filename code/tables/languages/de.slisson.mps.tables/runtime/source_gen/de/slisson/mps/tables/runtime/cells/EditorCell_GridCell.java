...
public class EditorCell_GridCell extends NoInsertOverride {
  private static Logger LOG = Logger.getLogger(EditorCell_GridCell.class);
  ...
  protected void fixCellContext(EditorCell cell) {
    if (check_hp9uj0_a0a0kb(check_hp9uj0_a0a0a63(cell.getCellContext())) != cell.getSNode()) {
  ...
  public static EditorCell unwrapAll(EditorCell cell) {
    for (EditorCell child : Sequence.fromIterable(as_hp9uj0_a0a0a77(cell, EditorCell_Collection.class))) {
      unwrapAll(child);
    }
    EditorCell unwrapped = check_hp9uj0_a0b0zc(as_hp9uj0_a0a0b0zc(cell, EditorCell_GridCell.class));
  ...
  public static void unwrapAll_Grid(Grid grid) {
    ...
    for (int x = 0; x < grid.getSizeX(); x++) {
      for (int y = 0; y < grid.getSizeY(); y++) {
        EditorCellGridLeaf leaf = as_hp9uj0_a0a0a0a1a58(grid.getElement(x, y), EditorCellGridLeaf.class);
        if (leaf == null) {
          continue;
        }
        EditorCell cell = as_hp9uj0_a0a2a0a1a58(grid.getElement(x, y), EditorCell.class);
  ...
  private class DeleteAction extends CellAction_DeleteNode {
    ...
    public boolean canExecute(EditorContext context) {
      return super.canExecute(context) && check_hp9uj0_a0a0a1ne(getParent(), this) != myWrappedEditorCell.getSNode();
    }
  }
  ...
  private static SNode check_hp9uj0_a0a0kb(SNodeLocation checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getContextNode();
    }
    return null;
  }
  private static SNodeLocation check_hp9uj0_a0a0a63(EditorCellContext checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getNodeLocation();
    }
    return null;
  }
  private static EditorCell check_hp9uj0_a0b0zc(EditorCell_GridCell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.unwrap();
    }
    return null;
  }
  private static SNode check_hp9uj0_a0a0a1ne(jetbrains.mps.nodeEditor.cells.EditorCell_Collection checkedDotOperand, DeleteAction checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getSNode();
    }
    return null;
  }
  private static <T> T as_hp9uj0_a0a0a77(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_hp9uj0_a0a0b0zc(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_hp9uj0_a0a0a0a1a58(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_hp9uj0_a0a2a0a1a58(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
}
