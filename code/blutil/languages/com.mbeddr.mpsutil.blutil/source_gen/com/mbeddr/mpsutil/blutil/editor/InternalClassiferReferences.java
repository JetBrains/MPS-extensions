...
public class InternalClassiferReferences implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    InternalClassiferReferencesSpecific customizer = new InternalClassiferReferencesSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class InternalClassiferReferencesSpecific implements EditorMenuItemCustomizer {

    public boolean matches(EditorMenuItemCustomizationContext context) {
      return new EditorMenuItemCreatingConceptContextMatcher(CONCEPTS.ClassifierType$bL).matchesContext(context) && getCompletionItemInformation(context) != null;
    }
