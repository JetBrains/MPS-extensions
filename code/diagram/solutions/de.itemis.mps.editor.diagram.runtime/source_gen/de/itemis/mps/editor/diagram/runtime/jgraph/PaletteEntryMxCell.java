...
public class PaletteEntryMxCell extends mxCell implements ISelfCreatingCell {
  ...
  public SNode createModelNode(DiagramModel diagramModel) {
    ...
    IPaletteEntry contextAction = Sequence.fromIterable(diagramModel.getPaletteEntryProvider().getEntries()).findFirst(new IWhereFilter<IPaletteEntry>() {
      public boolean accept(IPaletteEntry it) {
        return originalAction.isValidReplacement(it);
      }
    });
