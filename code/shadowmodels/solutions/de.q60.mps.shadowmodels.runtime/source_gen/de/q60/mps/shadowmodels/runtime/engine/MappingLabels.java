...
public class MappingLabels {
  ...
  public Iterable<Tuples._2<MappingLabelCall, IOutputNodesReference>> getEntries() {
    return MapSequence.fromMap(labels).translate(new ITranslator2<IMapping<String, MappingLabel>, Tuples._2<MappingLabelCall, IOutputNodesReference>>() {
      public Iterable<Tuples._2<MappingLabelCall, IOutputNodesReference>> translate(final IMapping<String, MappingLabel> it) {
        return MapSequence.fromMap(it.value().entries).select(new ISelector<IMapping<List<Object>, IOutputNodesReference>, Tuples._2<MappingLabelCall, IOutputNodesReference>>() {
          public Tuples._2<MappingLabelCall, IOutputNodesReference> select(IMapping<List<Object>, IOutputNodesReference> it2) {
            return MultiTuple.<MappingLabelCall,IOutputNodesReference>from(new MappingLabelCall(it.key(), it2.key()), it2.value());
          }
        });
      }
    });
