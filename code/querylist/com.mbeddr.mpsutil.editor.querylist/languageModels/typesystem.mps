      ...
      <node concept="3clFbJ" id="C$q8A2yMfL" role="3cqZAp">
          ...
          <node concept="a7r0C" id="6TSlAOGL4fb" role="3cqZAp">
            <node concept="3cpWs3" id="6TSlAOGL4fd" role="a7wSD">
              <node concept="2OqwBi" id="6TSlAOGL4fe" role="3uHU7w">
                ...
                <node concept="3zqWPK" id="WEZADybpU1" role="2OqNvi">
        ...
        <node concept="3fqX7Q" id="6TSlAOGNeRF" role="3clFbw">
          <node concept="2OqwBi" id="6TSlAOGNeRH" role="3fr31v">
            ...
            <node concept="3zqWPK" id="WEZADybpU3" role="2OqNvi">
              <ref role="37wK5l" to="tpcn:73yVtVlWOga" resolve="isSubconceptOf" />
              <node concept="2OqwBi" id="WEZADybpU5" role="37wK5m">
                <node concept="1YBJjd" id="WEZADybpU6" role="2Oq$k0">
                  <ref role="1YBMHb" node="C$q8A2yAjT" resolve="node" />
                </node>
                <node concept="3TrEf2" id="WEZADybpU7" role="2OqNvi">
        ...
        <node concept="3clFbF" id="C$q8A2CyMm" role="3cqZAp">
          <node concept="3cpWs3" id="C$q8A2C$Gt" role="3clFbG">
            <node concept="2OqwBi" id="C$q8A2C_6E" role="3uHU7w">
              ...
              <node concept="3zqWPK" id="WEZADybpU8" role="2OqNvi">
                <ref role="37wK5l" to="tpcu:hEwIO9y" resolve="getFqName" />
              </node>
            </node>
