...
public abstract class BaseDiagramDCell extends BaseDCell implements ISelfPaintingCell, ISupportButtonHiding {
  ...
  public List<StyleAttribute> getStyleButtonAttributes() {
    return Sequence.fromIterable(Sequence.fromArray(new StyleAttribute[]{StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__layout-diagram-button"), StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__sync-with-model-button")})).toListSequence();
  }

  public void updateButtonConfig(final Style style) {
    ListSequence.fromList(getStyleButtonAttributes()).visitAll(new IVisitor<StyleAttribute>() {
