...
public final class PushXStyle__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x1919c723b60b4592L, 0x93189ce96d91da44L, 0x25de75efdcc1a913L, "de.itemis.mps.editor.celllayout.structure.PushXStyle");
  ...
  /*package*/ static SNode getStyleAttributeDeclaration_id2nutuZsM_FC(@NotNull SAbstractConcept __thisConcept__) {
    return SLinkOperations.getTarget(_quotation_createNode_e003of_a0a0a(), LINKS.attributeDeclaration$Xjv0);
  }
  /*package*/ static StyleAttribute<Boolean> getStyleAttribute_id3a0zHG4tjdX(@NotNull SNode __thisNode__) {
    return StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.celllayout.styles", "_push-x");
  }

  /*package*/ PushXStyle__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_e003of_a0a0a() {
    ...
    nb.setReference(MetaAdapterFactory.getReferenceLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x53ac4acb2cb6e9d7L, 0x53ac4acb2cb6ecb2L, "attributeDeclaration"), "r:0b928dd6-dd7e-45a8-b309-a2e315b7877a(de.itemis.mps.editor.celllayout.styles.editor)/8464519078425945973");
    return quotedNode_1;
  }
