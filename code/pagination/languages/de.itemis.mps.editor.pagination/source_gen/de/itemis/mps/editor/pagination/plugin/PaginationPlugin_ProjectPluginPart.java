...
public class PaginationPlugin_ProjectPluginPart extends ProjectPluginPart {
  ...
  public void init(MPSProject project) {
    ...
    check_sc6i86_a1a0(check_sc6i86_a0b0a(ProjectHelper.toIdeaProject(project)), extension);
  ...
  public void dispose(MPSProject project) {
    EditorExtension extension = PaginationPlugin_ProjectPluginPart.this.extension;
    check_sc6i86_a1a0_0(check_sc6i86_a0b0a_0(ProjectHelper.toIdeaProject(project)), extension);
  ...
  private static EditorExtensionRegistry check_sc6i86_a0b0a(Project checkedDotOperand) {
    if (null != checkedDotOperand) {
  ...
  private static EditorExtensionRegistry check_sc6i86_a0b0a_0(Project checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getComponent(EditorExtensionRegistry.class);
    }
    return null;
