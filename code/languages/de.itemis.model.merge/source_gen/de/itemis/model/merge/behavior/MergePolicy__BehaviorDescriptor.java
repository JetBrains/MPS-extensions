...
public final class MergePolicy__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x539e893908ef497cL, 0xa5fd25dd10137a55L, 0x1a8b8d3e42de4bf5L, "de.itemis.model.merge.structure.MergePolicy");
  ...
  /*package*/ static Iterable<SNode> allHierarchyProperties_id5zr7Q_1V6SF(@NotNull SNode __thisNode__) {
    return Sequence.fromIterable(MergePolicy__BehaviorDescriptor.allSuperConcepts_id5zr7Q_1WN6i.invokeSpecial(__thisNode__)).translate(new ITranslator2<SNode, SNode>() {
  ...
  /*package*/ static Iterable<SNode> allHierarchyChildren_id5zr7Q_1WLCS(@NotNull final SNode __thisNode__) {
    return Sequence.fromIterable(MergePolicy__BehaviorDescriptor.allHierarchyLinkDeclarations_id5v01ES7q237.invokeSpecial(__thisNode__)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !((boolean) MergePolicy__BehaviorDescriptor.isReference_id1Av7ChmzSO3.invokeSpecial(__thisNode__, it));
      }
    });
  }
  /*package*/ static Iterable<SNode> allHierarchyReferences_id3PLTv5jznVy(@NotNull final SNode __thisNode__) {
    return Sequence.fromIterable(MergePolicy__BehaviorDescriptor.allSuperConcepts_id5zr7Q_1WN6i.invoke(__thisNode__)).translate(new ITranslator2<SNode, SNode>() {
      public Iterable<SNode> translate(SNode it) {
  ...
  /*package*/ static Iterable<SNode> allHierarchySingltonChildren_id5zr7Q_1WWCs(@NotNull final SNode __thisNode__) {
    return Sequence.fromIterable(MergePolicy__BehaviorDescriptor.allHierarchySingleton_id1Av7ChmzRIr.invokeSpecial(__thisNode__)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !((boolean) MergePolicy__BehaviorDescriptor.isReference_id1Av7ChmzSO3.invokeSpecial(__thisNode__, it));
      }
    });
  ...
  /*package*/ static Iterable<SNode> allHierarchyOptionalChildren_id5zr7Q_1XJwl(@NotNull final SNode __thisNode__) {
    return Sequence.fromIterable(MergePolicy__BehaviorDescriptor.allHierarchyOptional_id1Av7ChmzXZT.invokeSpecial(__thisNode__)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !((boolean) MergePolicy__BehaviorDescriptor.isReference_id1Av7ChmzSO3.invokeSpecial(__thisNode__, it));
      }
    });
  ...
  /*package*/ static Iterable<SNode> allHierarchyMultiChildren_id5zr7Q_1XHDE(@NotNull final SNode __thisNode__) {
    return Sequence.fromIterable(MergePolicy__BehaviorDescriptor.allHierarchyChildren_id5zr7Q_1WLCS.invoke(__thisNode__)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return Objects.equals(SPropertyOperations.getEnum(it, PROPS.sourceCardinality$cxYK), SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xfc6f3944c2L, "jetbrains.mps.lang.structure.structure.Cardinality"), 0xfc6f3944c5L, "_0__n")) || Objects.equals(SPropertyOperations.getEnum(it, PROPS.sourceCardinality$cxYK), SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xfc6f3944c2L, "jetbrains.mps.lang.structure.structure.Cardinality"), 0xfc6f3944c6L, "_1__n"));
      }
    }).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !((boolean) MergePolicy__BehaviorDescriptor.isReference_id1Av7ChmzSO3.invokeSpecial(__thisNode__, it));
  ...
  /*package*/ static Iterable<SNode> allSuperConcepts_id5zr7Q_1WN6i(@NotNull SNode __thisNode__) {
    return Sequence.fromIterable(AbstractConceptDeclaration__BehaviorDescriptor.getAllSuperConcepts_id2A8AB0rAWpG.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.conceptRef$p8vY), ((boolean) true))).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return !((boolean) AbstractConceptDeclaration__BehaviorDescriptor.is_id4MKjpUYmGW0.invoke(it, CONCEPTS.BaseConcept$gP));
      }
    });
  }
  /*package*/ static Iterable<SNode> allHierarchySingleton_id1Av7ChmzRIr(@NotNull SNode __thisNode__) {
    return Sequence.fromIterable(MergePolicy__BehaviorDescriptor.allHierarchyLinkDeclarations_id5v01ES7q237.invoke(__thisNode__)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return Objects.equals(SPropertyOperations.getEnum(it, PROPS.sourceCardinality$cxYK), SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xfc6f3944c2L, "jetbrains.mps.lang.structure.structure.Cardinality"), 0xfc6f3944c4L, "_1"));
      }
    });
  }
  ...
  /*package*/ static Iterable<SNode> allHierarchyOptional_id1Av7ChmzXZT(@NotNull SNode __thisNode__) {
    return Sequence.fromIterable(MergePolicy__BehaviorDescriptor.allHierarchyLinkDeclarations_id5v01ES7q237.invoke(__thisNode__)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return Objects.equals(SPropertyOperations.getEnum(it, PROPS.sourceCardinality$cxYK), SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xc72da2b97cce4447L, 0x8389f407dc1158b7L, 0xfc6f3944c2L, "jetbrains.mps.lang.structure.structure.Cardinality"), 0xfc6f3944c3L, "_0__1"));
      }
    });
  }
  ...
  /*package*/ MergePolicy__BehaviorDescriptor() {
  }
