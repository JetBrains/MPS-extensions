...
/*package*/ class Division_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createMathBase_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("MathBase_pmbden_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new upperSingleRoleHandler_pmbden_a0a(myNode, LINKS.upper$AVha, getEditorContext());
    return provider.createCell();
  }
  private static class upperSingleRoleHandler_pmbden_a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public upperSingleRoleHandler_pmbden_a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.upper$AVha, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.upper$AVha, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.upper$AVha);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.upper$AVha));
      try {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new lowerSingleRoleHandler_pmbden_a1a(myNode, LINKS.lower$B0Ty, getEditorContext());
    return provider.createCell();
  }
  private static class lowerSingleRoleHandler_pmbden_a1a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public lowerSingleRoleHandler_pmbden_a1a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.lower$B0Ty, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.lower$B0Ty, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.lower$B0Ty);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.lower$B0Ty));
      try {
        EditorCell editorCell = super.createEmptyCell();
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink upper$AVha = MetaAdapterFactory.getContainmentLink(0x76a53b21d4a7409fL, 0x93a2e70951b4b3f9L, 0x7028ee847715c5b7L, 0x7028ee8477173d8aL, "upper");
    /*package*/ static final SContainmentLink lower$B0Ty = MetaAdapterFactory.getContainmentLink(0x76a53b21d4a7409fL, 0x93a2e70951b4b3f9L, 0x7028ee847715c5b7L, 0x7028ee8477173d8dL, "lower");
  }
}
