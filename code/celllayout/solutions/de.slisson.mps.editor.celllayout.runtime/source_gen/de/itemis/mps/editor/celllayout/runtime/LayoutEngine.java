...
public class LayoutEngine {
  ...
  public Size getPreferredSize(final EditorCell rootCell) {
    ...
    LayoutWatchdog.enter(LayoutWatchdog.DEFAULT_TIMEOUT, () -> {
  ...
  public void preprocessLayoutables(ILayoutable root) {
    ...
    for (ILayoutableContainer gridLayout : ListSequence.fromList(changedGridLayouts)) {
      ListSequence.fromList(gridLayout.getChildren()).visitAll(new IVisitor<ILayoutable>() {
        public void visit(ILayoutable it) {
          LayoutableExtensions.visitAll(it, (ILayoutable layoutable) -> initPadding(layoutable));
        }
      });
    }
  }
