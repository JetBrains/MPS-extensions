...
public class PF_EditorComponent extends PFModule {
  ...
  public static final PF_EditorComponent INSTANCE = new _FunctionTypes._return_P0_E0<PF_EditorComponent>() {
    public PF_EditorComponent invoke() {
      try {
  ...
  private PF_EditorComponent() {
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.buildTrace", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        ...
        te.addChild("type checking session: ", ((TypecheckingSession.Handle) ReflectionUtil_copy.readField(EditorComponent.class, ((EditorComponent) _PFparameters.get(0)), "myTypecheckingSessionHandle")).session());
        ...
        te.addChild("gutter messages: ", ((List<SimpleEditorMessage>) ReflectionUtil_copy.readField(MessagesGutter.class, ((EditorComponent) _PFparameters.get(0)).getMessagesGutter(), "myMessages")));
