...
/*package*/ class CellModel_ComponentWithParameters_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public CellModel_ComponentWithParameters_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_5o0j23_a");
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_5o0j23_b0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.editorComponent$OSno);
    ...
    provider.setEmptyCellId("empty_" + "editorComponent");
    ...
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfo(editorCell, referenceLink, CONCEPTS.EditorComponentDeclarationWithParameters$jH));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink editorComponent$OSno = MetaAdapterFactory.getReferenceLink(0xb8bb702e43ed4090L, 0xa902d180d3e5f292L, 0x5d70a7b3f455ba85L, 0xfb35c96897L, "editorComponent");
  }
