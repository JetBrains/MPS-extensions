...
/*package*/ class NestedTreeDiagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public NestedTreeDiagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_q22qon_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_q22qon_b0");
      ...
      DiagramCreationContext.createDiagram(() -> {
        DiagramContext.withContext(node, () -> editorCell.value, () -> {
          ContextVariables.withValue("thisNode", node, () -> {
            ...
            DiagramModel model = DiagramModel.getModel(editorContext, node, "5731047739261375916");
              ...
              public List<? extends IDiagramElementAccessor> getElements(IAccessorFactory accessorFactory) {
                ...
                for (final SNode parameterObject : new Object() {
                  public Iterable<SNode> query() {
                    return SLinkOperations.getChildren(((SNode) _variablesContext.getValue("thisNode")), LINKS.subDiagrams$asOS);
                  }
                }.query()) {
                  ContextVariables.withParentAndValue(_variablesContext, "parameterObject", parameterObject, new Runnable() {
                    public void run() {
                      final ContextVariables _variablesContext = ContextVariables.getCurrent();
                      final EditorCell editorCell = new Inline_Builder_q22qon_a2c0(editorContext, parameterObject).createCell();
            ...
            editorCell.value.setCellId("Diagram_q22qon_c0");
  ...
  /*package*/ static class Inline_Builder_q22qon_a2c0 extends AbstractEditorBuilder {
    ...
    /*package*/ Inline_Builder_q22qon_a2c0(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
    ...
    private EditorCell createNextEditor_0() {
      {
        EditorCell editorCell = getCellFactory().createEditorCell(myNode, false, NestedTreeDiagram_Editor.class);
        return editorCell;
      }
    }
  }
