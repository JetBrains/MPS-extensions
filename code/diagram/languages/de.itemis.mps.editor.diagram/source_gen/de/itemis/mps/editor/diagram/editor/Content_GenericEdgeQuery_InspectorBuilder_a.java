...
/*package*/ class Content_GenericEdgeQuery_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Content_GenericEdgeQuery_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_a7ksyh_0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_a7ksyh_0");
