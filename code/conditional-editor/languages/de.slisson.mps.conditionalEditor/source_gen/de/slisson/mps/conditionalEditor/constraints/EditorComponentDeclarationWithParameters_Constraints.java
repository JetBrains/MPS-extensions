...
public class EditorComponentDeclarationWithParameters_Constraints extends BaseConstraintsDescriptor {
  /*package*/ EditorComponentDeclarationWithParameters_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.EditorComponentDeclarationWithParameters$jH, initContext);
