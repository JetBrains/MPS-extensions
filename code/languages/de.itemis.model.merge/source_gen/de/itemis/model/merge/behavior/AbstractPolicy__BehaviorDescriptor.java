...
public final class AbstractPolicy__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static boolean childHasMultipleSubConcepts_idjF$CuWmXO_(@NotNull SNode __thisNode__) {
    SNode modelMerge = SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.ModelMerge$MA, false, false);
    assert modelMerge != null : "Root ModelMerge missing";

    List<SNode> allConcepts = Sequence.fromIterable((ModelMerge__BehaviorDescriptor.languageConceptsSnodes_idZzVzivLDVk.invoke(modelMerge))).select(new ISelector<SNode, SNode>() {
