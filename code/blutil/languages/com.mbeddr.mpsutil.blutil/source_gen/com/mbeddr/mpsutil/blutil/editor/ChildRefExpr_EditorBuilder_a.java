...
/*package*/ class ChildRefExpr_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ChildRefExpr_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_f1n5g0_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.child$ClBD;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.child$ClBD);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.child$ClBD);
    }
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new ChildRefExpr_child_cellMenu_f1n5g0_a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_0() {
      ...
      try {
        final SProperty property = PROPS.optionalName$ltSP;
  ...
  public static class ChildRefExpr_child_cellMenu_f1n5g0_a0a0 extends PrimaryReferentMenuCellMenuPart {
    public ChildRefExpr_child_cellMenu_f1n5g0_a0a0() {
    }
    @NotNull
    @Override
    protected IReferentPresentationProvider getMatchingTextProvider() {
      return PresentationProviders.PRESENTATION_f1n5g0_a0a0a;
    }
    @NotNull
    @Override
