...
public class MyGraphComponent extends mxGraphComponent implements ISupportButtonHiding {
  ...
  public static final double ARROW_KEY_MOVE_AMOUNT = 10.0;
  public static final double ARROW_KEY_MOVE_AMOUNT_SLOW = 1.0;
  public static final double PAN_AMOUNT = 20.0;
  public static final double PAN_AMOUNT_SLOW = 2.0;
  public static final double MINIMUM_SCALE = 0.83;
  ...
  public void zoomOut() {
    MyGraphView view = getGraph().getView();
    if (view.getScale() <= MINIMUM_SCALE) {
      return;
    }
    super.zoomOut();
    getGraph().updateViewOrigin();
  ...
  public void setButtonLayout(final Style style, AlignEnum align, List<StyleAttribute> styleAttribute) {
    this.align = align;
    ListSequence.fromList(styleAttribute).visitAll(new IVisitor<StyleAttribute>() {
      public void visit(StyleAttribute it) {
        updateButtonVisibility(style, it);
      }
    });
  }
  ...
  public Dimension getPreferredSize() {
    ...
    Rectangle preview = ((Rectangle) ReflectionUtil_copy.readField(mxGraphHandler.class, getGraphHandler(), "previewBounds"));
    if (preview != null) {
  ...
  public class MyGraphControl extends mxGraphComponent.mxGraphControl {
    ...
    public boolean alwaysShowPortLabels() {
      ...
      boolean alwaysShowPortLabel = Sequence.fromIterable(Sequence.fromArray(editorHintsForNode)).any(new IWhereFilter<String>() {
        public boolean accept(String it) {
          return it.endsWith(ALWAYS_SHOW_PORT_LABELS);
        }
      });
