...
public class PlaintextPaster {
  public static boolean hasClipboardContents() {
    return CopyPasteManagerEx.getInstanceEx().areDataFlavorsAvailable(DataFlavor.stringFlavor);
  }
    ...
    if (contents.isDataFlavorSupported(DataFlavor.stringFlavor)) {
      try {
        ...
        ApplicationManager.getApplication().invokeLater(() -> {
          Notification notification = new Notification("Error pasting from clipboard", ex.getMessage(), NotificationType.ERROR);
  ...
  private static Integer getIndentationLevel(String s) {
    ...
    if ((text != null && text.length() > 0)) {
      for (String line : text.split("\\r?\\n")) {
        ...
        if (isEmptyString(line.trim())) {
          ...
          Integer lvl = getIndentationLevel(l);
