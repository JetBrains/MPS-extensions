...
public final class Parameter_instance__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x309e000449764416L, 0xb947ec02ae4ecef2L, 0x50bfac9a432a5b55L, "com.mbeddr.mpsutil.modellisteners.structure.Parameter_instance");
  ...
  /*package*/ static SNode getType_id27DJnJtIQ9C(@NotNull SNode __thisNode__) {
    return _quotation_createNode_zi913n_a0a0(SLinkOperations.getTarget(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.ConceptModelListeners$qT, false, false), LINKS.concept$WSQr));
  }

  /*package*/ Parameter_instance__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_zi913n_a0a0(Object parameter_1) {
