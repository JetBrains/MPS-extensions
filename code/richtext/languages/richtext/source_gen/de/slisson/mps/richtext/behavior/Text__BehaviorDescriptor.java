...
public final class Text__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> normalizeStructure_id4Lll81Ty9os = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("normalizeStructure").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5500395430674470428L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2(SMethodBuilder.createJavaParameter(EditorContext.class, ""));
  ...
  public static final SMethod<Void> ensureNormalized_id3mI$71cQ6Aw = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("ensureNormalized").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3868187941957822880L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2();
  public static final SMethod<Void> ensureNormalized_id1xf6IA5Se_N = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("ensureNormalized").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1751648370346223987L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2(SMethodBuilder.createJavaParameter(EditorContext.class, ""));
