...
public class DiagramContext {
  ...
  public static List<SNode> getAllDiagramNodes() {
    return ListSequence.fromList(ourContextStack).select(new ISelector<IContext, SNode>() {
      public SNode select(IContext it) {
        return it.getSNode();
      }
  ...
  public static List<BaseDiagramECell> getAllECells() {
    return ListSequence.fromList(ourContextStack).select(new ISelector<IContext, BaseDiagramECell>() {
      public BaseDiagramECell select(IContext it) {
        return it.getECell();
      }
    }).where(new IWhereFilter<BaseDiagramECell>() {
      public boolean accept(BaseDiagramECell it) {
        return it != null;
      }
    }).translate(new ITranslator2<BaseDiagramECell, BaseDiagramECell>() {
      public Iterable<BaseDiagramECell> translate(BaseDiagramECell it) {
        return Sequence.fromIterable(getAncestorECells(it)).concat(Sequence.fromIterable(Sequence.<BaseDiagramECell>singleton(it)));
      }
    }).distinct().toListSequence();
  }

  public static List<BaseDiagramDCell> getAllDCells() {
    return ListSequence.fromList(ourContextStack).select(new ISelector<IContext, BaseDiagramDCell>() {
      public BaseDiagramDCell select(IContext it) {
        return it.getDCell();
      }
    }).where(new IWhereFilter<BaseDiagramDCell>() {
      public boolean accept(BaseDiagramDCell it) {
        return it != null;
      }
    }).distinct().toListSequence();
  }
  ...
  public static List<DiagramModel> getAllDiagramModels() {
    return ListSequence.fromList(ourContextStack).select(new ISelector<IContext, DiagramModel>() {
      public DiagramModel select(IContext it) {
        return it.getDiagramModel();
      }
    }).where(new IWhereFilter<DiagramModel>() {
      public boolean accept(DiagramModel it) {
        return it != null;
      }
    }).distinct().toListSequence();
  }
  ...
  public static MyGraph getGraph() {
    return ListSequence.fromList(ourContextStack).select(new ISelector<IContext, MyGraph>() {
      public MyGraph select(IContext it) {
        return it.getGraph();
      }
    }).findFirst(new IWhereFilter<MyGraph>() {
      public boolean accept(MyGraph it) {
        return it != null;
      }
    });
  }
