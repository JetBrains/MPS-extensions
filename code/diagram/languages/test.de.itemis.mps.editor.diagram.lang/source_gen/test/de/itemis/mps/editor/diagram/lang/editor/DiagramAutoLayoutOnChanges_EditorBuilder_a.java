...
/*package*/ class DiagramAutoLayoutOnChanges_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DiagramAutoLayoutOnChanges_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_7hcyvu_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_7hcyvu_a0");
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createProperty_0());
    return editorCell;
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "auto layout on changes");
    editorCell.setCellId("Constant_7hcyvu_a0a");
      ...
      DiagramCreationContext.createDiagram(() -> {
        DiagramContext.withContext(node, () -> editorCell.value, () -> {
          ContextVariables.withValue("thisNode", node, () -> {
            ...
            DiagramModel model = DiagramModel.getModel(editorContext, node, "1556636692825323486");
            ...
            IDiagramAccessor accessor = new AbstractDiagramAccessor(node) {
              ...
              private boolean nodeCondition_7hcyvu_a1a() {
                return true;
              }
              ...
              public boolean runAutoLayoutOnChange() {
                boolean autoLayoutFlag = false;
                autoLayoutFlag = nodeCondition_7hcyvu_a1a();
                return autoLayoutFlag;
              }
            ...
            editorCell.value.setCellId("Diagram_7hcyvu_b0");
