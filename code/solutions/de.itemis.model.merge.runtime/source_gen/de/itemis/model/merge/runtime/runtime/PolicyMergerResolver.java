...
public class PolicyMergerResolver {
  ...
  private static void constructMergePolicesForNode(SAbstractConcept startNode, TraversalState matc, MergerResolverBuilder resultBuilder) throws MergingPolicyConflict, MergingPolicyConflict {
    ...
    try {
      ...
      MapWrapper<SNode, ContentHolder<PropertyMerger>> mergeWithPrevious = PolicyMergerResolver.<SNode,PropertyMerger>mergeWithPrevious(propMap.get(startNode), matc.propertySnapshot(), startNode);
    ...
    try {
      ...
      MapWrapper<SNode, ContentHolder<ConceptChildMerger>> mergeWithPrevious = PolicyMergerResolver.<SNode,ConceptChildMerger>mergeWithPrevious(conceptMap.get(startNode), matc.childSnapshot(), startNode);
