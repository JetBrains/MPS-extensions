...
public class fixMIssingSubPolicy_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    Set<SEnumerationLiteral> presentMembers = SetSequence.fromSetWithValues(new HashSet<SEnumerationLiteral>(), ListSequence.fromList(SLinkOperations.getChildren(((SNode) fixMIssingSubPolicy_QuickFix.this.getField("mcp")[0]), LINKS.subPolicy$$EhP)).select(new ISelector<SNode, SEnumerationLiteral>() {
