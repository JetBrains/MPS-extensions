...
public class ShadowModelsAPI {
  ...
  public static SNode transform(final String transformationId, final Object... parameters) {
    return TransformationEngine.CONTEXT_ENGINE.computeWith(engine, () -> {
      Iterable<Object> convertedParameters = Sequence.fromIterable(Sequence.fromArray(parameters)).select(new ISelector<Object, Object>() {
        public Object select(Object it) {
          return convertParameter(it);
        }
      });
  ...
  private static Object convertParameter(Object param) {
    if (param instanceof SNode) {
      ...
      return Sequence.fromIterable(iterable).select(new ISelector<Object, Object>() {
        public Object select(Object it) {
          return convertParameter(it);
        }
      }).toListSequence();
