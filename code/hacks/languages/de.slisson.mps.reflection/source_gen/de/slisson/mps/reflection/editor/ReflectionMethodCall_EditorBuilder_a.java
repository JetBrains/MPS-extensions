...
/*package*/ class ReflectionMethodCall_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ReflectionMethodCall_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_vmeynl_a");
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.instanceMethodDeclaration$5z18);
    ...
    editorCell.getStyle().putAll(style);
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.ReflectionMethodCall$HG, "de.slisson.mps.reflection.editor.ReflectionMethodCall_ApplySideTransforms"));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink instanceMethodDeclaration$5z18 = MetaAdapterFactory.getReferenceLink(0x654422bfe75f44dcL, 0x936d188890a746ceL, 0x7598281400e7dcceL, 0x118155506ceL, "instanceMethodDeclaration");
  }
