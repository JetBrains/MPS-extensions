...
public class OriginalIntentionMenu {
  ...
  public OriginalIntentionMenu(@NotNull EditorComponent editor) {
    ...
    IntentionsSupport intentionsSupport = ((IntentionsSupport) ReflectionUtil.readField(EditorComponent.class, editor, "myIntentionsSupport"));
    if (intentionsSupport != null) {
      ReflectionUtil.writeField(IntentionsSupport.class, intentionsSupport, "myLightBulb", new LightBulbMenu() {
        @Override
      ...
      ReflectionUtil.writeField(IntentionsSupport.class, intentionsSupport, "myShowIntentionsAction", new AbstractAction() {
        @Override
      ...
      myEditor.registerKeyboardAction(((AbstractAction) ReflectionUtil.readField(IntentionsSupport.class, intentionsSupport, "myShowIntentionsAction")), KeyStroke.getKeyStroke("alt ENTER"), JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT);
    }
  }
