...
<model ref="r:e6cf883f-f2b4-4ec1-88f0-6048dce3754c(de.slisson.mps.editor.multiline.test.generator.templates@generator)">
  ...
  <node concept="bUwia" id="5nOdiEvyJ7$">
    <property role="TrG5h" value="main" />
    <property role="3$yP7D" value="true" />
    <node concept="3aamgX" id="5nOdiEvjnTf" role="3acgRq">
      <ref role="30HIoZ" to="2ehl:5nOdiEviXal" resolve="MultilineCellReference" />
      <node concept="j$656" id="5nOdiEvjnTz" role="1lVwrX">
        <ref role="v9R2y" node="5nOdiEvjnTx" resolve="reduce_MultilineCellReference" />
      </node>
    </node>
  </node>
  <node concept="13MO4I" id="5nOdiEvjnTx">
    <property role="TrG5h" value="reduce_MultilineCellReference" />
    <ref role="3gUMe" to="2ehl:5nOdiEviXal" resolve="MultilineCellReference" />
    <node concept="2ShNRf" id="5nOdiEvjo0W" role="13RCb5">
      <node concept="1pGfFk" id="5nOdiEvjBDX" role="2ShVmc">
        <property role="373rjd" value="true" />
        <ref role="37wK5l" to="nv7s:5nOdiEvjjZL" resolve="CellAnnotation" />
                  ...
                  <node concept="2OqwBi" id="5nOdiEvjE1p" role="3clFbG">
                    <node concept="2OqwBi" id="5nOdiEvjDzx" role="2Oq$k0">
                      ...
                      <node concept="3TrEf2" id="5nOdiEvjDLS" role="2OqNvi">
                        <ref role="3Tt5mk" to="2ehl:5nOdiEviXnm" resolve="annotation" />
                      </node>
                    </node>
                    <node concept="3TrcHB" id="5nOdiEvjEkY" role="2OqNvi">
                      <ref role="3TsBF5" to="2ehl:hSLIFSk" resolve="caretPosition" />
                    </node>
                  </node>
                </node>
              </node>
                ...
                <node concept="3clFbF" id="5nOdiEvjEBy" role="3cqZAp">
                  <node concept="2OqwBi" id="5nOdiEvjEFO" role="3clFbG">
                    ...
                    <node concept="3TrcHB" id="5nOdiEvjEJ8" role="2OqNvi">
                      <ref role="3TsBF5" to="2ehl:5rZKa_fTvKN" resolve="selectionStart" />
                    </node>
                  </node>
                </node>
              </node>
                ...
                <node concept="3clFbF" id="5nOdiEvjEPm" role="3cqZAp">
                  <node concept="2OqwBi" id="5nOdiEvjESO" role="3clFbG">
                    ...
                    <node concept="3TrcHB" id="5nOdiEvjEVI" role="2OqNvi">
                      <ref role="3TsBF5" to="2ehl:5rZKa_fTvKP" resolve="selectionEnd" />
                    </node>
                  </node>
                </node>
              </node>
                ...
                <node concept="3clFbF" id="5nOdiEvjF7u" role="3cqZAp">
                  <node concept="2OqwBi" id="5nOdiEvjFV8" role="3clFbG">
                    ...
                    <node concept="3TrcHB" id="5nOdiEvjGdI" role="2OqNvi">
                      <ref role="3TsBF5" to="2ehl:1HNcKYL91S1" resolve="isInInspector" />
                    </node>
                  </node>
                </node>
              </node>
