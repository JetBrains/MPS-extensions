...
public class MappingConfigurationList extends LanguageRuntime implements TemplateModule, TemplateModel, SLanguage {
  ...
  public MappingConfigurationList(List<TemplateMappingConfiguration> mappingConfigurations, LanguageRegistry languageRegistry) {
    ...
    ((Map<SLanguageId, LanguageRuntime>) ReflectionUtil_copy.readField(LanguageRegistry.class, languageRegistry, "myLanguagesById")).put(id, this);
  }
  ...
  public void unregister() {
    ((Map<SLanguageId, LanguageRuntime>) ReflectionUtil_copy.readField(LanguageRegistry.class, languageRegistry, "myLanguagesById")).remove(id);
  }
