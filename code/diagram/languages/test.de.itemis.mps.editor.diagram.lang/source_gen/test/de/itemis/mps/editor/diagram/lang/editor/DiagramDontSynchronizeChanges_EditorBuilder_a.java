...
/*package*/ class DiagramDontSynchronizeChanges_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DiagramDontSynchronizeChanges_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_tv6z7e_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_tv6z7e_a0");
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createProperty_0());
    return editorCell;
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "don't synchronize changes diagram");
    editorCell.setCellId("Constant_tv6z7e_a0a");
      ...
      DiagramCreationContext.createDiagram(() -> {
        DiagramContext.withContext(node, () -> editorCell.value, () -> {
          ContextVariables.withValue("thisNode", node, () -> {
            ...
            DiagramModel model = DiagramModel.getModel(editorContext, node, "1556636692819440320");
            ...
            IDiagramAccessor accessor = new AbstractDiagramAccessor(node) {
              ...
              private boolean nodeCondition_tv6z7e_a1a() {
                return true;
              }
            ...
            editorCell.value.setCellId("Diagram_tv6z7e_b0");
