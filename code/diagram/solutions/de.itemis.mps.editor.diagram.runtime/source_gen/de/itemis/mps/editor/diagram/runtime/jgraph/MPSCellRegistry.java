...
public class MPSCellRegistry {
  ...
  public MPSCell getInstance(EditorCell cell, IMPSCellContainer container) {
    ...
    MPSCell instance = Sequence.fromIterable(instances).findFirst(new IWhereFilter<MPSCell>() {
      public boolean accept(MPSCell it) {
        return it.getGraph() == myGraph;
      }
    });
  ...
  public MPSCell findInstance(EditorCell cell) {
    ...
    return Sequence.fromIterable(instances).findFirst(new IWhereFilter<MPSCell>() {
      public boolean accept(MPSCell it) {
        return it.getGraph() == myGraph;
      }
    });
