...
public class PF_EditorCells extends PFModule {
  ...
  public static final PF_EditorCells INSTANCE = new _FunctionTypes._return_P0_E0<PF_EditorCells>() {
    public PF_EditorCells invoke() {
      try {
  ...
  private PF_EditorCells() {
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.buildTrace", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        ...
        for (CellActionType actionType : Sequence.fromIterable(availableActions).sort(new ISelector<CellActionType, String>() {
          public String select(CellActionType it) {
            return it.toString();
          }
        }, true)) {
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.toString", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        return ((String) ReflectionUtil_copy.readField(KeyMap.ActionKey.class, ((KeyMap.ActionKey) _PFparameters.get(0)), "myModifiers")) + " + " + ((String) ReflectionUtil_copy.readField(KeyMap.ActionKey.class, ((KeyMap.ActionKey) _PFparameters.get(0)), "myKeyCode")) + ((((Boolean) ReflectionUtil_copy.readField(KeyMap.ActionKey.class, ((KeyMap.ActionKey) _PFparameters.get(0)), "myKeyTyped")) ? " typed" : " pressed"));
      }
      @Override
      public Iterable<IParameterType> getParameterTypes() {
        return myParameterTypes;
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.buildTrace", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        ...
        te.expandByDefault = true;
        for (SubstituteInfoPartExt part : ((SubstituteInfoPartExt[]) ReflectionUtil_copy.readField(CompositeSubstituteInfo.class, ((CompositeSubstituteInfo) _PFparameters.get(0)), "myExtParts"))) {
          te.addChild(part);
        }
        return te;
      }
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.buildTrace", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        ...
        Sequence.fromIterable(both).select(new ISelector<SubstituteAction, Tuples._2<String, SubstituteAction>>() {
          public Tuples._2<String, SubstituteAction> select(SubstituteAction it) {
            return MultiTuple.<String,SubstituteAction>from("", it);
          }
        }).concat(Sequence.fromIterable(strictOnly).select(new ISelector<SubstituteAction, Tuples._2<String, SubstituteAction>>() {
          public Tuples._2<String, SubstituteAction> select(SubstituteAction it) {
            return MultiTuple.<String,SubstituteAction>from("[strict] ", it);
          }
        })).concat(Sequence.fromIterable(nonStrictOnly).select(new ISelector<SubstituteAction, Tuples._2<String, SubstituteAction>>() {
          public Tuples._2<String, SubstituteAction> select(SubstituteAction it) {
            return MultiTuple.<String,SubstituteAction>from("[non-strict] ", it);
          }
        })).sort(new ISelector<Tuples._2<String, SubstituteAction>, String>() {
          public String select(Tuples._2<String, SubstituteAction> it) {
            return it._0();
          }
        }, true).alsoSort(new ISelector<Tuples._2<String, SubstituteAction>, String>() {
          public String select(Tuples._2<String, SubstituteAction> it) {
            return it._1().getMatchingText("");
          }
        }, true).visitAll(new IVisitor<Tuples._2<String, SubstituteAction>>() {
          public void visit(Tuples._2<String, SubstituteAction> it) {
            teActions.addChild(it._0(), it._1());
          }
        });
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.toString", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        ...
        return "collection: " + IterableUtils.join(Sequence.fromIterable(children).select(new ISelector<EditorCell, String>() {
          public String select(EditorCell it) {
            return ((String) _PFcontext.callFunction("de.q60.mps.explorer.impl.pf.PF_EditorCells.getStringInCollection", new ParameterList(new Object[]{it})));
          }
    ...
    myImplementations.put("de.q60.mps.explorer.impl.pf.PF_EditorCells.getStringInCollection", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        Iterable<EditorCell> children = ((EditorCell_Collection) _PFparameters.get(0));
        return IterableUtils.join(Sequence.fromIterable(children).select(new ISelector<EditorCell, String>() {
          public String select(EditorCell it) {
            return ((String) _PFcontext.callFunction("de.q60.mps.explorer.impl.pf.PF_EditorCells.getStringInCollection", new ParameterList(new Object[]{it})));
          }
        }).where(new NotNullWhereFilter<String>()), " ");
    ...
    myImplementations.put("de.q60.mps.explorer.impl.pf.PF_EditorCells.getProperty", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        return ((SProperty) ReflectionUtil_copy.readField(SPropertyAccessor.class, ((SPropertyAccessor) _PFparameters.get(0)), "myProperty"));
      }
      @Override
      public Iterable<IParameterType> getParameterTypes() {
        return myParameterTypes;
