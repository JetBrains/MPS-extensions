...
public final class UnicodeByNameRegex__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x63e0e5665131447eL, 0x90e312ea330e1a00L, 0x7cf5c55a28c842ceL, "com.mbeddr.mpsutil.blutil.structure.UnicodeByNameRegex");
  ...
  /*package*/ static String getString_idhMuDF1A(@NotNull SNode __thisNode__, List<SNode> vars) {
    return "\\N{" + SPropertyOperations.getString(__thisNode__, PROPS.name$yW29) + "}";
  }

  /*package*/ UnicodeByNameRegex__BehaviorDescriptor() {
  }
