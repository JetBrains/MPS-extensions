...
public class Iterator_Test {
  ...
  public void compare(InputCursor[] actualRanges, String[]... expectedRanges) {
    ...
    System.out.println("expected: " + IterableUtils.join(Sequence.fromIterable(Sequence.fromArray(expectedRanges)).select(new ISelector<String[], String>() {
      public String select(String[] it) {
        return Arrays.toString(it);
      }
    }), " # "));
    System.out.println("actual: " + IterableUtils.join(Sequence.fromIterable(Sequence.fromArray(actualRanges)).select(new ISelector<InputCursor, String>() {
      public String select(InputCursor it) {
        return ListSequence.fromList(it.getAll()).select(new ISelector<IToken, String>() {
          public String select(IToken it) {
