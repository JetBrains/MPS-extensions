...
public final class WrapperCell_Condition_wrappedNode__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9d69e71978c84286L, 0x90dbfb19c107d049L, 0x1b8a15bf95962f50L, "com.mbeddr.mpsutil.grammarcells.structure.WrapperCell_Condition_wrappedNode");
  ...
  /*package*/ static SNode getType_id27DJnJtIQ9C(@NotNull SNode __thisNode__) {
    return _quotation_createNode_gsa20c_a0a0(SNodeOperations.asNode(ICellWrapper__BehaviorDescriptor.getWrappedConcept_id3O7ZvCZLQaC.invoke(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.WrapperCell$wv, false, false))));
  }

  /*package*/ WrapperCell_Condition_wrappedNode__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_gsa20c_a0a0(Object parameter_1) {
