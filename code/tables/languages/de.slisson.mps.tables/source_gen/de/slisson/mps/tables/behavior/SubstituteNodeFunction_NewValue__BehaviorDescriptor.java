...
public final class SubstituteNodeFunction_NewValue__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x7e450f4e1ac341efL, 0xa8514598161bdb94L, 0x6e47d2dcb6373b2dL, "de.slisson.mps.tables.structure.SubstituteNodeFunction_NewValue");
  ...
  /*package*/ static SNode getType_id27DJnJtIQ9C(@NotNull SNode __thisNode__) {
    return _quotation_createNode_fwtnlm_a0a0(SubstituteNodeFunction__BehaviorDescriptor.getConceptForMenu_id7AHcygo6uTm.invoke(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.SubstituteNodeFunction$AT, false, false)));
  }

  /*package*/ SubstituteNodeFunction_NewValue__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_fwtnlm_a0a0(Object parameter_1) {
