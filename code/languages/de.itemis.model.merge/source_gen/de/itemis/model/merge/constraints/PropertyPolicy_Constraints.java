...
public class PropertyPolicy_Constraints extends BaseConstraintsDescriptor {
  /*package*/ PropertyPolicy_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.PropertyPolicy$TC, initContext);
    record(new RD1(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.property$IQvu, container, true, false);
    }
    @Nullable
    @Override
