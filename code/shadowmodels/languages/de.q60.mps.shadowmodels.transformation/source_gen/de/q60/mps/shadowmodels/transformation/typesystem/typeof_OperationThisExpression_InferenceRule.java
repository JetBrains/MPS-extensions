...
public class typeof_OperationThisExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  public typeof_OperationThisExpression_InferenceRule() {
  }
  public void applyRule(final SNode n, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:fd3ba2d5-05a9-4b3b-93ad-a566c0e12538(de.q60.mps.shadowmodels.transformation.typesystem)", "2824806335946944931", 0, null);
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:fd3ba2d5-05a9-4b3b-93ad-a566c0e12538(de.q60.mps.shadowmodels.transformation.typesystem)", "2824806335946944307", true), (SNode) createSNodeType_jsmk7m_a1a0c0a0b(SLinkOperations.getTarget(SNodeOperations.as(SNodeOperations.getParent(SNodeOperations.getNodeAncestor(n, CONCEPTS.OperationImplementation$F3, false, false)), CONCEPTS.NodeBuilder$By), LINKS.concept$huZZ)), _info_12389875345);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.OperationThisExpression$md;
  }
  ...
  private static SNode createSNodeType_jsmk7m_a1a0c0a0b(SNode p0) {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept OperationThisExpression$md = MetaAdapterFactory.getConcept(0x94b64715a2634c36L, 0xa1388da14705ffa7L, 0x2733ba6565639fccL, "de.q60.mps.shadowmodels.transformation.structure.OperationThisExpression");
