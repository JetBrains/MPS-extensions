...
public class TableEditorActions {
  private static Logger LOG = Logger.getLogger(TableEditorActions.class);
  ...
  public static boolean isParentATransparentCollection(EditorCell child) {
    ...
    List<SNode> parentNodes = ListSequence.fromList(parentCells).select(new ISelector<EditorCell, SNode>() {
