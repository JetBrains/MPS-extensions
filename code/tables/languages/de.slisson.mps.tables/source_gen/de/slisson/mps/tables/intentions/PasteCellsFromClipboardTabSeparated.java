...
public class PasteCellsFromClipboardTabSeparated extends AbstractSelectionIntentionFactory {
  public PasteCellsFromClipboardTabSeparated() {
  }
    ...
    if (selection instanceof TableRangeSelection) {
      ISelectionIntentionExecutable intention = new AbstractSelectionIntentionExecutable<TableRangeSelection>() {
        ...
        public void execute(TableRangeSelection selection) {
          TableData<SNode> data = ClipboardTableUtils.fromClipboard(selection.getTable().getSNode(), TableDataSeparator.TAB, selection.getEditorComponent().getEditorContext());
        ...
        public String getDescription(TableRangeSelection selection) {
          return String.format("Paste Cells from Clipboard (%s)", TableDataSeparator.TAB.getDescription());
        }
        @Override
