...
public class ViewRegistry {
  ...
  public Iterable<IViewDescriptor> getDescriptors(ViewId id) {
    ...
    return Sequence.fromIterable(MapSequence.fromMap(myDescriptors).values()).where(new IWhereFilter<IViewDescriptor>() {
      public boolean accept(IViewDescriptor it) {
        return doesExtend(it, descriptor) || isBaseView(descriptor, it);
      }
    });
  }
  ...
  public Iterable<IViewDescriptor> getVisibleDescriptors() {
    return Sequence.fromIterable(getDescriptors()).where(new IWhereFilter<IViewDescriptor>() {
      public boolean accept(IViewDescriptor it) {
  ...
  public Iterable<IViewElementDescriptor> getAllElements(ViewId viewId) {
    return Sequence.fromIterable(getDescriptors(viewId)).translate(new ITranslator2<IViewDescriptor, IViewElementDescriptor>() {
      public Iterable<IViewElementDescriptor> translate(IViewDescriptor it) {
  ...
  public Iterable<IViewElementDescriptor> getQueryableElements(ViewId viewId) {
    return Sequence.fromIterable(getAllElements(viewId)).where(new IWhereFilter<IViewElementDescriptor>() {
      public boolean accept(IViewElementDescriptor it) {
  ...
  public Iterable<IViewElementDescriptor> getElementAndOverridingElements(final ElementId id, final ViewId viewId) {
    ...
    Iterable<IViewElementDescriptor> result = Sequence.fromIterable(getAllElements(viewId)).where(new IWhereFilter<IViewElementDescriptor>() {
      public boolean accept(IViewElementDescriptor it) {
        return Objects.equals(it.getExtendsId(), id) && it.isOverride();
      }
    }).translate(new ITranslator2<IViewElementDescriptor, IViewElementDescriptor>() {
      public Iterable<IViewElementDescriptor> translate(IViewElementDescriptor it) {
  ...
  public Iterable<IViewElementDescriptor> getInheritanceHierachy(ElementId id, final ViewId viewId) {
    List<IViewElementDescriptor> a = Sequence.fromIterable(getElementAndBaseElements(id)).toListSequence();
    List<IViewElementDescriptor> b = ListSequence.fromList(a).translate(new ITranslator2<IViewElementDescriptor, IViewElementDescriptor>() {
      public Iterable<IViewElementDescriptor> translate(IViewElementDescriptor it) {
        return getElementAndOverridingElements(it.getId(), viewId);
      }
    }).toListSequence();
    Iterable<IViewElementDescriptor> c = ListSequence.fromList(b).sort(new ISelector<IViewElementDescriptor, Integer>() {
      public Integer select(IViewElementDescriptor it) {
  ...
  protected void initPossibleDescendantTypes() {
    ...
    for (ViewId viewId : SetSequence.fromSet(MapSequence.fromMap(myDescriptors).keySet())) {
      ...
      for (IViewElementDescriptor parentDescriptor : Sequence.fromIterable(MapSequence.fromMap(myDescriptors).values()).translate(new ITranslator2<IViewDescriptor, IViewElementDescriptor>() {
        public Iterable<IViewElementDescriptor> translate(IViewDescriptor it) {
          return it.getElements();
        }
  ...
  public Iterable<IViewElementDescriptor> getPossibleParents(ElementId childId, ViewId contextView) {
    return Sequence.fromIterable(getElementAndSubElements(childId, contextView)).select(new ISelector<IViewElementDescriptor, IViewElementDescriptor>() {
      public IViewElementDescriptor select(IViewElementDescriptor it) {
        return getElement(it.getParentId());
      }
    }).where(new IWhereFilter<IViewElementDescriptor>() {
      public boolean accept(IViewElementDescriptor it) {
        return it != null;
      }
    }).distinct();
  ...
  public Iterable<IViewElementDescriptor> getChildDescriptors(@Nullable final ElementId parentId, ViewId viewId) {
    ...
    final Set<ElementId> hierachy = SetSequence.fromSetWithValues(new HashSet<ElementId>(), Sequence.fromIterable(getInheritanceHierachy(parentId, viewId)).select(new ISelector<IViewElementDescriptor, ElementId>() {
      public ElementId select(IViewElementDescriptor it) {
        return it.getId();
      }
    }));
    return Sequence.fromIterable(concreteDescriptors).where(new IWhereFilter<IViewElementDescriptor>() {
      public boolean accept(IViewElementDescriptor it) {
