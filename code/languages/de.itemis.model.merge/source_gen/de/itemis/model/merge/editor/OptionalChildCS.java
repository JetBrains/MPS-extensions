...
public class OptionalChildCS implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    OptionalChildCSSpecific customizer = new OptionalChildCSSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class OptionalChildCSSpecific implements EditorMenuItemCustomizer {
    public boolean matches(EditorMenuItemCustomizationContext context) {
      return new EditorMenuItemModifyingConceptContextMatcher(CONCEPTS.OptionalPolicy$hY) {
