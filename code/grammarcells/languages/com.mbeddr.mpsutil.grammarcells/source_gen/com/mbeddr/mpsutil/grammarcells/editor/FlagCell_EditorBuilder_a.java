...
/*package*/ class FlagCell_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FlagCell_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_5q29db_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    Style style = new StyleImpl();
    new rootCellModelStyleStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    style.set(StyleAttributes.BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_5q29db_a0a()));
  ...
  private Color _StyleParameter_QueryFunction_5q29db_a0a() {
  ...
  private EditorCell createRefCell_0() {
    ...
    style.set(StyleAttributes.TEXT_BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_5q29db_a0b0()));
    style.set(StyleAttributes.BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_5q29db_a1b0()));
    style.set(StyleAttributes.TEXT_COLOR, StyleRegistry.getInstance().getSimpleColor(_StyleParameter_QueryFunction_5q29db_a2b0()));
    style.set(StyleAttributes.FONT_STYLE, _StyleParameter_QueryFunction_5q29db_a3b0());
    style.set(StyleAttributes.UNDERLINED, _StyleParameter_QueryFunction_5q29db_a4b0());
    style.set(StyleAttributes.STRIKE_OUT, _StyleParameter_QueryFunction_5q29db_a5b0());
    editorCell.getStyle().putAll(style);
