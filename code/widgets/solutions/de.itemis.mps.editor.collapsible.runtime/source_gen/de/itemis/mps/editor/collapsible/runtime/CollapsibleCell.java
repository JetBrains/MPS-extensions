...
public class CollapsibleCell extends EditorCell_Collection {
  ...
  protected void setupLayout() {
    ...
    for (EditorCell child : Sequence.fromIterable(((Iterable<EditorCell>) this)).toListSequence()) {
      removeCell(child);
    }
  ...
  private EditorCell createCollection(final boolean vertical, EditorCell... cells) {
    Iterable<EditorCell> seq = Sequence.fromIterable(Sequence.fromArray(cells)).where(new IWhereFilter<EditorCell>() {
    ...
    Sequence.fromIterable(seq).visitAll(new IVisitor<EditorCell>() {
      public void visit(EditorCell it) {
        collection.value.addEditorCell(it);
      }
    });
