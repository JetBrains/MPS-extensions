    ...
    while (!(ListSequence.fromList(allStmts).isEmpty())) {
      ...
      if (SNodeOperations.isInstanceOf(stmt, CONCEPTS.YieldStatement$yx)) {
        ...
        if (SNodeOperations.isInstanceOf(stmt, CONCEPTS.ThrowStatement$Zy)) {
          ...
          for (SNode caught : ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(stmt, CONCEPTS.TryFinallyStatement$oi), LINKS.catchClause$l$PD)).where(new IWhereFilter<SNode>() {
            public boolean accept(SNode it) {
              return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SLinkOperations.getTarget(it, LINKS.throwable$$5MH), LINKS.type$a1UY), CONCEPTS.ClassifierType$bL);
            }
          }).select(new ISelector<SNode, SNode>() {
            public SNode select(SNode it) {
              return SNodeOperations.as(SLinkOperations.getTarget(SLinkOperations.getTarget(it, LINKS.throwable$$5MH), LINKS.type$a1UY), CONCEPTS.ClassifierType$bL);
            }
          })) {
          ...
          for (SNode caught : ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(stmt, CONCEPTS.TryCatchStatement$XR), LINKS.catchClause$dMnP)).where(new IWhereFilter<SNode>() {
            public boolean accept(SNode it) {
              return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SLinkOperations.getTarget(it, LINKS.throwable$$5MH), LINKS.type$a1UY), CONCEPTS.ClassifierType$bL);
            }
          }).select(new ISelector<SNode, SNode>() {
          ...
          for (SNode thr : ListSequence.fromList(SNodeOperations.getNodeDescendants(stmt, CONCEPTS.IMethodCall$M9, false, new SAbstractConcept[]{CONCEPTS.IStatementListContainer$xz})).translate(new ITranslator2<SNode, SNode>() {
            public Iterable<SNode> translate(SNode it) {
              return (List<SNode>) IMethodLike__BehaviorDescriptor.getThrowableTypes_id5op8ooRkkc7.invoke(SLinkOperations.getTarget(it, LINKS.baseMethodDeclaration$pyYw));
            }
          })) {
