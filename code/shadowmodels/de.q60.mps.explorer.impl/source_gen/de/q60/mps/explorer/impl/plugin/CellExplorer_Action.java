...
public class CellExplorer_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    TransformationTraceComponent comp = ProjectPluginManager.getInstance(event.getData(CommonDataKeys.PROJECT)).getTool(GenericExplorerTool_Tool.class).addTab("Editor Cells");
