...
public class SubstituteUtil {
  ...
  public static SubstituteInfo forChild(EditorContext editorContext, SNode parent, @Nullable SNode child, final SNode linkDeclaration) {
    ...
    SContainmentLink slink = Sequence.fromIterable(links).findFirst(new IWhereFilter<SContainmentLink>() {
      public boolean accept(SContainmentLink it) {
        return Objects.equals(it.getName(), SPropertyOperations.getString(linkDeclaration, PROPS.name$MnvL));
      }
    });
