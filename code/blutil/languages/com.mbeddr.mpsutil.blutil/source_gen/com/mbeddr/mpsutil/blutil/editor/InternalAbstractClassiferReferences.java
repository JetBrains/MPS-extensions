...
public class InternalAbstractClassiferReferences implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    InternalAbstractClassiferReferencesSpecific customizer = new InternalAbstractClassiferReferencesSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class InternalAbstractClassiferReferencesSpecific implements EditorMenuItemCustomizer {

    public boolean matches(EditorMenuItemCustomizationContext context) {
      return new EditorMenuItemCreatingConceptContextMatcher(CONCEPTS.AbstractClassifierReference$Wh).matchesContext(context) && getCompletionItemInformation(context) != null;
    }
