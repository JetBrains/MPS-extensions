...
public class NodeToSModelAdapter implements SModel {
  ...
  public SRepository getRepository() {
    return (repository != null ? repository : MPSCoreComponents.getInstance().getPlatform().findComponent(MPSModuleRepository.class));
  }
  @Override
  public Iterable<SNode> getRootNodes() {
    Iterable<INode> rootNodes = node.getChildren(LINKS.rootNodes$jxXY.getName());
    return Sequence.fromIterable(rootNodes).select((it) -> {
