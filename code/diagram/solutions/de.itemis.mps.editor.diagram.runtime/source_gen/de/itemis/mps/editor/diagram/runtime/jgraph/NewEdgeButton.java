...
public class NewEdgeButton extends ContextButton {
  ...
  public void mouseDragged(MouseEvent event) {
    ...
    if (!(connectionHandler.isConnecting())) {
      ...
      ReflectionUtil_copy.writeField(mxConnectionHandler.class, connectionHandler, "active", true);
      ReflectionUtil_copy.writeField(mxConnectionHandler.class, connectionHandler, "source", myCellState);
