...
public class ProjectViewUtil {
  ...
  public static Iterable<SModel> getUtilModels(Language language) {
    return Sequence.fromIterable(((Iterable<SModel>) language.getModels())).where(new IWhereFilter<SModel>() {
      public boolean accept(SModel it) {
        return isEmptyString(SModelStereotype.getStereotype(it));
      }
    }).where(new IWhereFilter<SModel>() {
      public boolean accept(SModel it) {
        return Language.getModelAspect(it) == null;
      }
    });
  }
