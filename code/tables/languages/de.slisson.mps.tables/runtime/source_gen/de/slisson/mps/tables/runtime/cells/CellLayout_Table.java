...
public class CellLayout_Table extends AbstractCellLayout implements CellLayout {
  private static final Logger LOG = Logger.getLogger(CellLayout_Table.class);
  ...
  private void setGridCellGaps(Grid grid) {
    ...
    for (IGridElement element : grid) {
      EditorCell cell = check_xn71x9_a0a0e0n(as_xn71x9_a0a0a0e0n(element, EditorCellGridLeaf.class));
      if (cell == null) {
        continue;
      }
      if (check_xn71x9_a0c0e0n(as_xn71x9_a0a0c0e0n(element, EditorCell_GridCell.class)) instanceof RowEndCell) {
        continue;
      }
      cell.setLeftGap(gap);
  ...
  public int getAscent(EditorCell_Collection editorCells) {
    ...
    for (int gridY = 0; gridY < grid.getSizeY(); gridY++) {
      ...
      for (int gridX = 0; gridX < grid.getSizeX(); gridX++) {
        EditorCell cell = check_xn71x9_a0a0b0e0t(as_xn71x9_a0a0a0b0e0t(grid.getElement(gridX, gridY), EditorCellGridLeaf.class));
        if (cell == null) {
          continue;
        }
  ...
  private static EditorCell check_xn71x9_a0a0e0n(EditorCellGridLeaf checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorCell();
    }
    return null;
  }
  private static EditorCell check_xn71x9_a0c0e0n(EditorCell_GridCell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.firstCell();
    }
    return null;
  }
  private static EditorCell check_xn71x9_a0a0b0e0t(EditorCellGridLeaf checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getEditorCell();
    }
    return null;
  }
  private static <T> T as_xn71x9_a0a0a0e0n(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_xn71x9_a0a0c0e0n(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_xn71x9_a0a0a0b0e0t(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
}
