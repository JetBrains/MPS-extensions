...
public class Generator extends TemplateModuleInterpreted2 {
  ...
  public SModuleReference getModuleReference() {
    return PersistenceFacade.getInstance().createModuleReference("c4874fb0-6867-4cee-bc7e-cfcb604ef57a(de.itemis.mps.editor.enumeration#2135528801629812575)");
  }

  @Override
  protected void fillTemplateModels(TemplateModuleInterpreted2.TemplateModels models) {
    models.templates("r:0d172648-be96-4f10-9f8d-fca36198db26", QueriesGenerated.class);
  }
  ...
  public Collection<TemplateMappingPriorityRule> getPriorities() {
    return TemplateUtil.asCollection(TemplateUtil.createStrictlyTogetherRule(TemplateUtil.createRefExternal("c4874fb0-6867-4cee-bc7e-cfcb604ef57a(de.itemis.mps.editor.enumeration#2135528801629812575)", TemplateUtil.createRefNormal("r:0d172648-be96-4f10-9f8d-fca36198db26(main@generator)", "2135528801629812576", "main")), TemplateUtil.createRefExternal("0647eca7-da98-422a-8a8b-6ebc0bd014ea(jetbrains.mps.lang.editor#1129914002149)", TemplateUtil.createRefNormal("r:00000000-0000-4000-0000-011c8959029f(jetbrains.mps.lang.editor.generator.baseLanguage.template.main@generator)", "1096629760203", "MAPPING_main"))));
  }
}
