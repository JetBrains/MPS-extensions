...
<model ref="r:d4a954d0-fb17-418d-bfe1-8fc917bd27a1(de.slisson.mps.structurecheck.structure)">
  ...
  <node concept="1TIwiD" id="l6SLw3lTXk">
    ...
    <node concept="1TJgyi" id="4Z9cV$lDHFw" role="1TKVEl">
      <property role="TrG5h" value="rule" />
      <property role="IQ2nx" value="380240910834182503" />
      <ref role="AX2Wp" node="4Z9cV$lDHEC" resolve="SequenceCheckerType" />
      <node concept="3l_iC" id="4Z9cV$lDHFx" role="lGtFl">
  ...
  <node concept="25R3W" id="4Z9cV$lDHEC">
    <property role="TrG5h" value="SequenceCheckerType" />
    <property role="3F6X1D" value="380240910834182410" />
    <ref role="1H5jkz" node="4Z9cV$lDHEE" resolve="exactly" />
    <node concept="2JgGob" id="4Z9cV$lDHED" role="lGtFl">
