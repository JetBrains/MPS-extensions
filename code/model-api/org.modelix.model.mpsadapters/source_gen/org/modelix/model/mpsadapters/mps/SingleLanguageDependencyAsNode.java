...
public class SingleLanguageDependencyAsNode implements INode {
  private SModuleReference moduleReference;
  private int languageVersion;
  private SModule moduleImporter;
  private SModel modelImporter;

  public SingleLanguageDependencyAsNode(SModuleReference moduleReference, int languageVersion, SModule importer) {
    this.moduleReference = moduleReference;
    this.languageVersion = languageVersion;
    this.moduleImporter = importer;
  }

  public SingleLanguageDependencyAsNode(SModuleReference moduleReference, int languageVersion, SModel importer) {
    this.moduleReference = moduleReference;
    this.languageVersion = languageVersion;
  ...
  public IConcept getConcept() {
    return SConceptAdapter.wrap(CONCEPTS.SingleLanguageDependency$_9);
  }
  ...
  public String getPropertyValue(@NotNull String propertyName) {
    if (Objects.equals(PROPS.version$ApUL.getName(), propertyName)) {
      return Integer.toString(this.languageVersion);
  ...
  public static class NodeReference implements INodeReference {
    ...
    public INode resolveNode(@Nullable IArea area) {
      ...
      if (this.userModuleReference != null) {
        ...
        return new SModuleAsNode(user).findSingleLanguageDependency(this.usedModuleId);
      } else if (this.userModel != null) {
        SModel model = userModel.resolve(repo);
        return new SModelAsNode(model).findSingleLanguageDependency(this.usedModuleId);
      } else {
        throw new IllegalStateException();
      }
    }
