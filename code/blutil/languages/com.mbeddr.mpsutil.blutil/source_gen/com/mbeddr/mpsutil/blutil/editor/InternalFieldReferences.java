...
public class InternalFieldReferences implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    InternalFieldReferencesSpecific customizer = new InternalFieldReferencesSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class InternalFieldReferencesSpecific implements EditorMenuItemCustomizer {

    public boolean matches(EditorMenuItemCustomizationContext context) {
      return new EditorMenuItemCreatingConceptContextMatcher(CONCEPTS.FieldReferenceOperation$fU).matchesContext(context) && getCompletionItemInformation(context) != null;
    }
