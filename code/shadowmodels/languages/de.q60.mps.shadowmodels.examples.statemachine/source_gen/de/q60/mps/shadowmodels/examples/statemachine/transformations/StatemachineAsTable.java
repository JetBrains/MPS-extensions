...
public class StatemachineAsTable extends PFModule {
  ...
  public static final StatemachineAsTable INSTANCE = new _FunctionTypes._return_P0_E0<StatemachineAsTable>() {
    public StatemachineAsTable invoke() {
      try {
            ...
            new RootBuilderContext(call, result).run((final IBuilderContext context) -> {
              ...
              context.forChildRole("0").run(new _FunctionTypes._void_P1_E0<IBuilderContext>() {
                public void invoke(final IBuilderContext context) {
                  context.createNode(new TransformationCall("de.q60.mps.shadowmodels.examples.statemachine.transformations.StatemachineAsTable.table", new ParameterList(ListSequence.fromListAndArray(new ArrayList<Object>(), SM_ParameterConversion.fromMPS(SNodeOperations.cast(new _FunctionTypes._return_P0_E0<SNode>() {
                    public SNode invoke() {
        ...
        return new SM_GeneratedTransformationRule(new SNodePointer("r:417cb7e3-4a56-4fae-9bed-5ffd476cd098(de.q60.mps.shadowmodels.examples.statemachine.transformations)", "3384942920130481318")) {
          ...
          public void apply(ContainmentTargetRootNodes<TransformationCall> call, final TransformationResult result) {
            new RootBuilderContext(call, result).run((final IBuilderContext context) -> {
              ...
              context.forChildRole("0").run(new _FunctionTypes._void_P1_E0<IBuilderContext>() {
                public void invoke(final IBuilderContext context) {
                  boolean condition_36hbpv_a0l = ListSequence.fromList(SLinkOperations.getChildren(SM_ParameterConversion.toMPS(((INode) context.getInput(1))), LINKS.transitions$gYb3)).where(new IWhereFilter<SNode>() {
                    public boolean accept(SNode it) {
                      return Objects.equals(SLinkOperations.getTarget(it, LINKS.event$WZ7A), SM_ParameterConversion.toMPS(((INode) context.getInput(2))));
                    }
                  }).isNotEmpty();
                      ...
                      public void invoke(final IBuilderContext context) {
                        ...
                        if (true) {
                          context.forChildRole("childCells").run(new _FunctionTypes._void_P1_E0<IBuilderContext>() {
                            public void invoke(final IBuilderContext context) {
                              int i_a2a0a11 = 0;
                              for (SNode e_a2a0a11 : ListSequence.fromList(SLinkOperations.getChildren(SM_ParameterConversion.toMPS(((INode) context.getInput(1))), LINKS.transitions$gYb3)).where(new IWhereFilter<SNode>() {
                                public boolean accept(SNode it) {
                                  return Objects.equals(SLinkOperations.getTarget(it, LINKS.event$WZ7A), SM_ParameterConversion.toMPS(((INode) context.getInput(2))));
                                }
                              })) {
