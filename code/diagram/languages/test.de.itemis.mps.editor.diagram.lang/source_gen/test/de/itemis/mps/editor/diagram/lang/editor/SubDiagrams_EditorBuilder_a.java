...
/*package*/ class SubDiagrams_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SubDiagrams_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_otwjee_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_otwjee_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_otwjee_a0a");
          ...
          ContextVariables.withValue("thisNode", node, () -> {
            ...
            IDiagramAccessor accessor = new AbstractDiagramAccessor(node) {
              public List<? extends IDiagramElementAccessor> getElements(IAccessorFactory accessorFactory) {
                ...
                for (SNode e : ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.subDiagrams$nPB4))) {
                  elements.addAll(accessorFactory.fromSNode(e));
                }
                return elements;
              }
              ...
              private boolean nodeCondition_otwjee_a1a() {
                return false;
              }

              @Override
              public boolean saveDiagramLayout() {
                return nodeCondition_otwjee_a1a();
              }
            ...
            editorCell.value.setCellId("Diagram_otwjee_b0");
            Style style = new StyleImpl();
            style.set(StyleAttributes.getInstance().<Direction>getAttribute("de.itemis.mps.editor.diagram", "diagram-layout-direction"), _StyleParameter_QueryFunction_otwjee_a0b0());
