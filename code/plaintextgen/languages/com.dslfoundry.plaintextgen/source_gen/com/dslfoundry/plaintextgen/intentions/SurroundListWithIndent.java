...
public class SurroundListWithIndent extends AbstractSelectionIntentionFactory {
  public SurroundListWithIndent() {
  }
    ...
    if (selection instanceof NodeRangeSelection) {
      ISelectionIntentionExecutable intention = new AbstractSelectionIntentionExecutable<NodeRangeSelection>() {
        ...
        public void execute(NodeRangeSelection selection) {
          ...
          final SNode parent = SNodeOperations.replaceWithNewChild(ile, CONCEPTS.SpaceIndentedText$2u);
          ListSequence.fromList(nodes).visitAll(new IVisitor<SNode>() {
            public void visit(SNode it) {
              ListSequence.fromList(SLinkOperations.getChildren(parent, LINKS.lines$u7C)).addElement(it);
            }
          });
        }
        @Override
