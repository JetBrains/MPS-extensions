...
public final class IdentityCalculatorLogic__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xcdaf53d5878643a0L, 0xbdbaae0da5acb9e8L, 0x57b3399e077491cL, "de.itemis.mps.modelmerger.structure.IdentityCalculatorLogic");
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addElement(CONCEPTS.InputNode$4G);
    return result;
  }
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_mgffxl_a0a2();
  }

  /*package*/ IdentityCalculatorLogic__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_mgffxl_a0a2() {
