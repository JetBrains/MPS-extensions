...
public class ImageExportUtil {
  ...
  public static void exportAsPNG(RootDiagramECell diagramCell, SRepository repository) {
  ...
  public static void exportAsSVG(RootDiagramECell diagramCell, SRepository repository) {
    Project ideaProject = ProjectHelper.toIdeaProject(ProjectHelper.getProject(repository));
  ...
  public static void paintCell(final Graphics2D g, EditorCell cell) {
    ...
    Sequence.fromIterable(descendants).ofType(EditorCell_WithComponent.class).visitAll(new IVisitor<EditorCell_WithComponent>() {
      public void visit(EditorCell_WithComponent it) {
