...
public class PresentationProviders {
  public static final IReferentPresentationProvider PRESENTATION_f1n5g0_a0a0a = new IReferentPresentationProvider() {
    @NotNull
    @Override
    public String getPresentation(@NotNull SNode sourceNode, @NotNull SNode targetNode) {
      return SPropertyOperations.getString(targetNode, PROPS.optionalName$ltSP) + ": " + SPropertyOperations.getString(SLinkOperations.getTarget(SNodeOperations.cast(TypecheckingFacade.getFromContext().getTypeOf(targetNode), CONCEPTS.SNodeType$hR), LINKS.concept$OMgE), PROPS.name$MnvL);
    }
  };
