...
public class TraceBuilders_ShadowModels extends PFModule {
  ...
  public static final TraceBuilders_ShadowModels INSTANCE = new _FunctionTypes._return_P0_E0<TraceBuilders_ShadowModels>() {
    public TraceBuilders_ShadowModels invoke() {
      try {
  ...
  private TraceBuilders_ShadowModels() {
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.buildTrace", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        ...
        IStageReference ownInputStage = Sequence.fromIterable(SM_TransformationTrace.tryGetInputNodes(((SNode) _PFparameters.get(0)))).select(new ISelector<SNode, IStageReference>() {
          public IStageReference select(SNode it) {
            return SM_TransformationTrace.getSubgraphStage(it);
          }
        }).first();
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.buildTrace", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        ...
        List<MappingLabels> allMappingLabels = Sequence.fromIterable(((SubgraphStage) _PFparameters.get(0)).getMappingLabels()).toListSequence();
          ...
          for (MappingLabels mappingLabels : ListSequence.fromList(allMappingLabels)) {
            for (final Tuples._2<MappingLabelCall, IOutputNodesReference> entry : Sequence.fromIterable(mappingLabels.getEntries())) {
              ...
              labelTE.addLazyChild("Input ", () -> {
                List<ExplorerElement> list = ListSequence.fromList(entry._0().getInput()).select(new ISelector<Object, ExplorerElement>() {
                  public ExplorerElement select(Object it) {
                    return new Object() {
                      public ExplorerElement groupCall(final IPFContext _PFcontext) {
        ...
        contentListTE.addLazyChild(null, () -> {
          return Sequence.fromIterable(((SubgraphStage) _PFparameters.get(0)).getAllContent()).select(new ISelector<IUniqueContainmentTarget, Tuples._2<IUniqueContainmentTarget, String>>() {
            public Tuples._2<IUniqueContainmentTarget, String> select(IUniqueContainmentTarget it) {
          ...
          }).sort(new ISelector<Tuples._2<IUniqueContainmentTarget, String>, String>() {
            public String select(Tuples._2<IUniqueContainmentTarget, String> it) {
              return it._1();
            }
          }, true).select(new ISelector<Tuples._2<IUniqueContainmentTarget, String>, IUniqueContainmentTarget>() {
            public IUniqueContainmentTarget select(Tuples._2<IUniqueContainmentTarget, String> it) {
              return it._0();
            }
          }).select(new ISelector<IUniqueContainmentTarget, ExplorerElement>() {
            public ExplorerElement select(IUniqueContainmentTarget it) {
              return new Object() {
                public ExplorerElement groupCall(final IPFContext _PFcontext) {
                  return ((ExplorerElement) _PFcontext.callFunction("de.q60.mps.explorer.pf.TraceBuilders_base.buildTrace", new ParameterList(new Object[]{it})));
                }
    ...
    myImplementations.put("de.q60.mps.explorer.pf.TraceBuilders_base.toString", new IFunctionImplementation() {
      ...
      public Object execute(final IPFContext _PFcontext, final ParameterList _PFparameters) {
        return IterableUtils.join(Sequence.fromIterable(((ParameterList) _PFparameters.get(0)).asSequence()).select(new ISelector<Object, String>() {
          public String select(Object it) {
            return ((String) _PFcontext.callFunction("de.q60.mps.explorer.pf.TraceBuilders_base.toString", new ParameterList(new Object[]{it})));
          }
        }), ", ");
