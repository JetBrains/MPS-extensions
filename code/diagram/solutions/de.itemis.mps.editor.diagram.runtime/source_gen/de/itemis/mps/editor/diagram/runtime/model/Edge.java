...
public class Edge extends DiagramElement {
  ...
  public void setAccessor(IDiagramElementAccessor accessor) {
    if (accessor != null && !(accessor instanceof IEdgeAccessor)) {
      throw new IllegalArgumentException("Not a " + IEdgeAccessor.class.getSimpleName() + ": " + accessor.getClass().getName());
    }
