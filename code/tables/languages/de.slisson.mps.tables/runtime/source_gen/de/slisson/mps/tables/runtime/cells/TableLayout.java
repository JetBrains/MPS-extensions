...
public class TableLayout extends AbstractGridLayout implements ILayouter {
  ...
  public int getAscent(ILayoutableContainer container, Size sizeConstraint) {
    ...
    List<Integer> ascents = Sequence.fromIterable(grid.getValidElements()).where(new IWhereFilter<GridElement>() {
      public boolean accept(GridElement it) {
        return it.getPosY() == 0;
      }
    }).select(new ISelector<GridElement, Integer>() {
      public Integer select(GridElement it) {
        return check_e65flo_a0a0a0a0a0e0d(check_e65flo_a0a0a0a0a0a4a3(check_e65flo_a0a0a0a0a0a0e0d(as_e65flo_a0a0a0a0a0a0a0a0a4a3(it.getLayoutable(), ILayoutableContainer.class))), it);
      }
    }).where(new IWhereFilter<Integer>() {
      public boolean accept(Integer it) {
        return it > 0;
      }
    }).sort(new ISelector<Integer, Integer>() {
  ...
  protected Iterable<ILayoutable> getChildrenToMove(ILayoutableContainer container) {
    return Sequence.fromIterable(loadGrid(container).getValidElements()).select(new ISelector<GridElement, ILayoutable>() {
      public ILayoutable select(GridElement it) {
        return it.getLayoutable();
      }
    }).distinct();
  }
  ...
  private static <T> T as_e65flo_a0a0a0a0a0a0a0a0a4a3(Object o, Class<T> type) {
