...
public final class GetCenterYFunction__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x766348f76a674b85L, 0x9323384840132299L, 0x7028ee847731e27dL, "de.itemis.mps.editor.math.structure.GetCenterYFunction");
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    return ListSequence.fromListAndArray(new ArrayList<SConcept>(), CONCEPTS.Parameter_ChildCells$Fz, CONCEPTS.Parameter_ThisLayoutableCell$1_);
  }
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_t8erk5_a0a1();
  }

  /*package*/ GetCenterYFunction__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_t8erk5_a0a1() {
