...
public class RichtextUtil {
  ...
  public static List<SAbstractConcept> getAllImportedWordConcepts(SModel model) {
    ...
    ListSequence.fromList(result).addSequence(ListSequence.fromList(getAllImportedLanguages(model)).translate(new ITranslator2<Language, SAbstractConcept>() {
      public Iterable<SAbstractConcept> translate(Language lang) {
        return ListSequence.fromList(SModelOperations.nodes(getStructureModel(lang), CONCEPTS.ConceptDeclaration$gH)).select(new ISelector<SNode, SAbstractConcept>() {
          ...
          public boolean accept(SAbstractConcept concept) {
            return SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(concept), CONCEPTS.IWord$8d);
          }
        });
      }
    }).select(new ISelector<SAbstractConcept, SAbstractConcept>() {
