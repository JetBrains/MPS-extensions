...
public class WordCellSubstituteInfo implements SubstituteInfo {
  ...
  protected List<SubstituteAction> wrap(Iterable<SubstituteAction> unwrapped) {
    return Sequence.fromIterable(unwrapped).select(new ISelector<SubstituteAction, SubstituteAction>() {
      public SubstituteAction select(SubstituteAction it) {
  ...
  public class Action implements SubstituteAction {
    ...
    public SNode substitute(@Nullable EditorContext context, String pattern) {
      ...
      if (!(SNodeOperations.isInstanceOf(newNode, CONCEPTS.IWord$8d))) {
        newNode = ListSequence.fromList(SLinkOperations.getChildren(textNode, LINKS.words$C8QZ)).findLast(new IWhereFilter<SNode>() {
