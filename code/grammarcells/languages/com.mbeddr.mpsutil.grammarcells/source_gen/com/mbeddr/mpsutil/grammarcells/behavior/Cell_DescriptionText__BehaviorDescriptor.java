...
public final class Cell_DescriptionText__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9d69e71978c84286L, 0x90dbfb19c107d049L, 0x7d7b5f4f63aecbc5L, "com.mbeddr.mpsutil.grammarcells.structure.Cell_DescriptionText");
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    if ((SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.ICanHaveDescriptionText$Y6, false, false) != null)) {
      ListSequence.fromList(params).addSequence(ListSequence.fromList(ICanHaveDescriptionText__BehaviorDescriptor.getDescriptionFunctionParameters_id2l$VAMESpmP.invoke(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.ICanHaveDescriptionText$Y6, false, false))));
    }
    return params;
  }
  /*package*/ static SNode getExpectedReturnType_idhEwIGRD(@NotNull SNode __thisNode__) {
    return _quotation_createNode_3s71wy_a0a1();
  }

  /*package*/ Cell_DescriptionText__BehaviorDescriptor() {
  }
  ...
  private static SNode _quotation_createNode_3s71wy_a0a1() {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SInterfaceConcept ICanHaveDescriptionText$Y6 = MetaAdapterFactory.getInterfaceConcept(0x9d69e71978c84286L, 0x90dbfb19c107d049L, 0xbc641994688c670L, "com.mbeddr.mpsutil.grammarcells.structure.ICanHaveDescriptionText");
  }
}
