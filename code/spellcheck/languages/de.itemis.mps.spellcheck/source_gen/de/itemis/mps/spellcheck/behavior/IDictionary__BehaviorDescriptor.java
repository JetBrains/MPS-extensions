...
public final class IDictionary__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<String> getWords_id29wDeGIfjFX(@NotNull SNode __thisNode__) {
    return ListSequence.fromList(IDictionary__BehaviorDescriptor.getEntries_id29wDeGIfHAw.invoke(__thisNode__)).translate(new ITranslator2<SNode, String>() {
    ...
    }).where(new NotNullWhereFilter<String>()).toListSequence();
  }
