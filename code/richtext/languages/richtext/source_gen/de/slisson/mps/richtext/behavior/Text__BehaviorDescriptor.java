...
public final class Text__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> normalizeStructure_id4Lll81Ty9os = new SMethodBuilder<>(Void.TYPE).name("normalizeStructure").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5500395430674470428L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2(SMethodBuilder.createJavaParameter(EditorContext.class, "editorContext"));
  public static final SMethod<Boolean> isNormalized_idIKrxbBHaGP = new SMethodBuilder<>(Boolean.TYPE).name("isNormalized").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(842294157794126645L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2();
  public static final SMethod<Void> ensureNormalized_id3mI$71cQ6Aw = new SMethodBuilder<>(Void.TYPE).name("ensureNormalized").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3868187941957822880L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2();
  public static final SMethod<Void> ensureNormalized_id1xf6IA5Se_N = new SMethodBuilder<>(Void.TYPE).name("ensureNormalized").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1751648370346223987L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2(SMethodBuilder.createJavaParameter(EditorContext.class, "editorContext"));
  public static final SMethod<Iterable<String>> getTextLines_id7T88Na6$wwy = new SMethodBuilder<>((Class<Iterable<String>>) ((Class) Object.class)).name("getTextLines").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9099561747015141410L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2();
  public static final SMethod<String> asTextString_id3Q5enzfMT4l = new SMethodBuilder<>(String.class).name("asTextString").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4433012599261204757L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2();
  public static final SMethod<SNode> getSelectedWord_id5Zn2KFQUdoe = new SMethodBuilder<>(SNode.class).name("getSelectedWord").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6906000695315977742L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2(SMethodBuilder.createJavaParameter(EditorContext.class, "editorContext"));
  public static final SMethod<Boolean> isEmpty_id2ZHlC004czC = new SMethodBuilder<>(Boolean.TYPE).name("isEmpty").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3453511597019941096L).languageId(0xa676c7604efe3504L, 0x92d2ea165a424fdfL).build2();
