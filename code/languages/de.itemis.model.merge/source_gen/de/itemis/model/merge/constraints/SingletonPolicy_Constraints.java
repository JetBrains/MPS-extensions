...
import de.itemis.model.merge.behavior.SingletonPolicy__BehaviorDescriptor;
...
public class SingletonPolicy_Constraints extends BaseConstraintsDescriptor {
  /*package*/ SingletonPolicy_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.SingletonPolicy$5$, initContext);
  ...
  private static boolean staticCanBeAParent(SNode node, SNode childNode, final SAbstractConcept childConcept, SContainmentLink link) {
    ...
    ListSequence.fromList(allowedConcepts).addSequence(ListSequence.fromList(Arrays.asList(CONCEPTS.Left$9M, CONCEPTS.Right$Y2, SingletonPolicy__BehaviorDescriptor.manualAction_id1Tugx$F11q.invoke(node))));
  ...
  private static final SNodePointer canBeParentBreakingPoint = new SNodePointer("r:eda8a4e8-0d4c-4435-bda0-13fbb20b741b(de.itemis.model.merge.constraints)", "8422540920009319348");
