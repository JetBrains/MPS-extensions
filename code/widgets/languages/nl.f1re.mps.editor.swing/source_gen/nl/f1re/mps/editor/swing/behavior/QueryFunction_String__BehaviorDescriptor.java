...
public final class QueryFunction_String__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x62971cbefd2f4135L, 0xb001ee6cb7a74436L, 0x782d1fba783a32f0L, "nl.f1re.mps.editor.swing.structure.QueryFunction_String");
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_component$mr);
    return result;
  }
