...
public final class Content_BLQuery__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfa13cc63c4764d46L, 0x9c96d53670abe7bcL, 0x5690ccc3e95bedf2L, "de.itemis.mps.editor.diagram.structure.Content_BLQuery");
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getExpectedReturnType_idhEwIGRD, getParameterConcepts_id2xELmDxyi2v, showName_id1653mnvAgry);
  ...
  /*package*/ Content_BLQuery__BehaviorDescriptor() {
  }
