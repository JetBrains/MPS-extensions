...
public class TextComparison {
  ...
  public void doTextGen(@NotNull SModel model, @Nullable Comparator<SNode> comparator, @Nullable Predicate<SNode> filterCondition) {
    ListSequence.fromList(breakdownToUnits(model, comparator, filterCondition)).visitAll((it) -> {
      it.generate();
      MapSequence.fromMap(mapping).put(new File(it.getFilePath(), it.getFileName()), new String(it.getBytes(), it.getEncoding()));
    });
  }

  public void showDiff(@NotNull final Project ideaProject, @NotNull SModel model, @NotNull String path, @Nullable Comparator<SNode> comparator, @Nullable Predicate<SNode> filterCondition) throws IOException {
    doTextGen(model, comparator, filterCondition);
  ...
  public TextComparisonResult textualDiff(@NotNull String path, @NotNull SModel model, @Nullable Comparator<SNode> comparator, @Nullable Predicate<SNode> filterCondition) throws Exception {
    return textualDiff(path, model, comparator, filterCondition, new PatchGenerator.PatchGeneratorOptions());
  }

  public TextComparisonResult textualDiff(@NotNull String path, @NotNull SModel model, @Nullable Comparator<SNode> comparator, @Nullable Predicate<SNode> filterCondition, PatchGenerator.PatchGeneratorOptions patchGeneratorOptions) throws Exception {
    doTextGen(model, comparator, filterCondition);
  ...
  protected List<TextUnit> breakdownToUnits(@NotNull SModel model, @Nullable final Comparator<SNode> comparator, @Nullable final Predicate<SNode> filterCondition) {
  ...
  protected SimpleDiffRequest createDiffRequestFromDifferentContents(@NotNull Project ideaProject, @NotNull File filePath, @Nullable String expectedContent) {
