...
public class DiagramUtil {
  ...
  public static SNode getReferenceTarget(SubstituteAction action) {
    if (action instanceof CompletionActionItemAsSubstituteAction) {
      ...
      if (a2 != null) {
        SubstituteMenuItemAsActionItem a3 = as_xnnmp6_a0a0a1a0a2(((CompletionActionItem) ReflectionUtil_copy.readField(CompletionActionItemAsSubstituteAction.class, a2, "myActionItem")), SubstituteMenuItemAsActionItem.class);
        if (a3 != null) {
          ReferenceScopeSubstituteMenuItem a4 = as_xnnmp6_a0a0a1a1a0a2(((SubstituteMenuItem) ReflectionUtil_copy.readField(SubstituteMenuItemAsActionItem.class, a3, "mySubstituteItem")), ReferenceScopeSubstituteMenuItem.class);
          if (a4 != null) {
            return ((SNode) ReflectionUtil_copy.readField(ReferenceScopeSubstituteMenuItem.class, a4, "myReferent"));
          }
        }
      }
    }
