...
public class check_MappingConfiguration_inoutLanguages_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode n, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    Set<String> inLanguages = SetSequence.fromSetWithValues(new HashSet<String>(), ListSequence.fromList(SLinkOperations.getChildren(n, LINKS.inputLanguages$CAWo)).select(new ISelector<SNode, String>() {
      public String select(SNode it) {
        return SPropertyOperations.getString(it, PROPS.moduleId$h8Zx);
      }
    }));
    Set<String> outLanguages = SetSequence.fromSetWithValues(new HashSet<String>(), ListSequence.fromList(SLinkOperations.getChildren(n, LINKS.outputLanguages$CBDr)).select(new ISelector<SNode, String>() {
      public String select(SNode it) {
        return SPropertyOperations.getString(it, PROPS.moduleId$h8Zx);
      }
    }));
