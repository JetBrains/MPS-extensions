...
public class ParameterList {
  ...
  public String toString() {
    return IterableUtils.join(Sequence.fromIterable(Sequence.fromArray(myParameterValues)).select(new ISelector<Object, String>() {
      public String select(Object it) {
        return (it == null ? "null" : it.toString() + " [" + it.getClass().getSimpleName() + "]");
      }
    }), ", ");
  }
