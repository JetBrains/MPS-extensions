...
public class RichtextCellReference_Constraints extends BaseConstraintsDescriptor {
  /*package*/ RichtextCellReference_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.RichtextCellReference$Ye, initContext);
    record(new RD1(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.annotation$OjTF, container, true, false);
    }
    @Nullable
    @Override
