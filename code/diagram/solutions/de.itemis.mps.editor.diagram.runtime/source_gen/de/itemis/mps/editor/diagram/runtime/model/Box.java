...
public class Box extends BoxBase implements IConnectionEndpoint_Internal {
  ...
  public void setAccessor(IDiagramElementAccessor accessor) {
    if (accessor != null && !(accessor instanceof IBoxAccessor)) {
      throw new IllegalArgumentException("Not a " + IBoxAccessor.class.getSimpleName() + ": " + accessor.getClass().getName());
    }
  ...
  public List<DiagramModel> getSubdiagramModels() {
    return ListSequence.fromList(getSubdiagramCells()).select(new ISelector<IDiagramCell, DiagramModel>() {
      public DiagramModel select(IDiagramCell it) {
