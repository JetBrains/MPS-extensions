...
public class MyEdgeHandler extends mxEdgeHandler implements ISupportButtonHiding {
  ...
  protected void updateButtons() {
    ...
    RootDCell rootCell = ((RootDiagramECell) ReflectionUtil_copy.readField(MyGraphComponent.class, component, "myDiagramCell")).getDCell(component.getGraph());
    ...
    if (buttonsCreator != null) {
      ...
      if (state.getCell() instanceof EdgeDCell) {
        ...
        if (getButtonVisibility(StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.diagram.styles", "__open-node-buttons"))) {
          for (SNode target : ListSequence.fromList(check_48sii8_a0a4a1a0f0bb(edgeCell.getEdge()))) {
  ...
  private static List<SNode> check_48sii8_a0a4a1a0f0bb(Edge checkedDotOperand) {
