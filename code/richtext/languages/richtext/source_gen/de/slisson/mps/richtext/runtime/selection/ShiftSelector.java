...
public class ShiftSelector implements MouseListener, SelectionListener, EditorComponent.EditorDisposeListener {
  ...
  public void mousePressed(MouseEvent event) {
    ...
    if (event.isShiftDown() && event.getButton() == MouseEvent.BUTTON1) {
      ...
      LOG.info(check_bvifcg_a0a0a3a1a71(from) + " -> " + check_bvifcg_a0a0d0b0r(to));
  ...
  private static Class<?> check_bvifcg_a0a0d0b0r(EditorCell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getClass();
    }
    return null;
  }
  private static Class<?> check_bvifcg_a0a0a3a1a71(EditorCell checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.getClass();
    }
    return null;
